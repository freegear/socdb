/**
 *
 *  omxIPCS_YCbCr444ToRGB565LS_MCU_S16_U16_P3C3R.c
 * 
 ...
 * 
 *
 * Description  : Colour Conversion Routine - Converts YUV444 to RGB565 in floating point.
...
{   
    ...
    OMX_INT convWidth   = JPEG_MCU_PIX_WIDTH_444;
    ...
    armRetArgErrIf((  (dstStep > (-2 * JPEG_MCU_PIX_WIDTH_444)) && ((dstStep < 2 * JPEG_MCU_PIX_WIDTH_444))), OMX_StsBadArgErr);
