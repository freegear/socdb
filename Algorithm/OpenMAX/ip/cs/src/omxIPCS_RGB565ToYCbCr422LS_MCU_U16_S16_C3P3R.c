/**
 *
 *  omxIPCS_RGB565ToYCbCr422LS_MCU_U16_S16_C3P3R.c
 * 
 ...
 * 
 *
 * Description  : Colour Conversion Routine - Converts RGB565 to YUV422 in floating point.
       ...
       )
{
    ...
    armRetArgErrIf(((srcStep > (-2 * JPEG_MCU_PIX_WIDTH_422)) && (srcStep < (2 * JPEG_MCU_PIX_WIDTH_422))), OMX_StsBadArgErr);
    ...
    */
    ...
    for(i = 0; i < convHeight; i++, pSrc += (srcStep >> 1))
    {
