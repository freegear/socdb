/**
 *
 *  omxIPCS_RGB888ToYCbCr444LS_MCU_U8_S16_C3P3R.c
 * 
 ...
 * 
 *
 * Description  : Colour Conversion Routine - Converts RGB888 to YUV444 in floating point.
...
{   
    ...
    armRetArgErrIf(((srcStep > (-3 * JPEG_MCU_PIX_WIDTH_444)) && (srcStep < (3 * JPEG_MCU_PIX_WIDTH_444))), OMX_StsBadArgErr);
