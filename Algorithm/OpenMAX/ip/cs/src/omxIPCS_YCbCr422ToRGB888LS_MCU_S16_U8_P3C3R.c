/**
 *
 *  omxIPCS_YCbCr422ToRGB888LS_MCU_S16_U8_P3C3R.c
 * 
 ...
 * 
 *
 * Description  : Colour Conversion Routine - Converts YUV422 to RGB888 in floating point.
...
{   
    ...
    armRetArgErrIf(((dstStep > (-3 * JPEG_MCU_PIX_WIDTH_422)) && ((dstStep < 3 * JPEG_MCU_PIX_WIDTH_422))), OMX_StsBadArgErr);
    ...
    */
    ...
    for(i = 0; i < convHeight; i++, pDst += dstStep)
    {
