/**
 *
 *  omxIPCS_YCbCr444ToRGB888LS_MCU_S16_U8_P3C3R.c
 * 
 ...
 * 
 *
 * Description  : Colour Conversion Routine - Converts YUV444 to RGB888 in floating point.
...
{   
    ...
    OMX_INT convWidth   = 3 * JPEG_MCU_PIX_WIDTH_444;
    OMX_INT convHeight  = JPEG_MCU_PIX_HEIGHT_444;
    OMX_S16 Ydata, Udata, Vdata;
    OMX_INT i, j;
    ...
    armRetArgErrIf(((dstStep > (-3 * JPEG_MCU_PIX_WIDTH_444)) && ((dstStep < 3 * JPEG_MCU_PIX_WIDTH_444))), OMX_StsBadArgErr);
