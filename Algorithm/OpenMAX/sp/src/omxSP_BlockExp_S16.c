 ...
 *
 * Description:
 * This file contains module block exponent computation
 *
 */
 ...
 * in the 16-bit input vector pSrc and returns the minimum sign bit
                            ...
                            )
{
    ...
    for (MinSignBits=15; (MaxVar>>(15-MinSignBits))!=0 ; MinSignBits--);
