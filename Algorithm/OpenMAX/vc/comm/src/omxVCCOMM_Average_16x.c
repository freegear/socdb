...
)
{
    ...
    armRetArgErrIf((iHeight != 8) && (iHeight != 16), OMX_StsBadArgErr)
    armRetArgErrIf(armNot16ByteAligned(pDstPred), OMX_StsBadArgErr)
    armRetArgErrIf((iPredStep0 == 0) || (iPredStep0 & 15), OMX_StsBadArgErr)
    armRetArgErrIf((iPredStep1 == 0) || (iPredStep1 & 15), OMX_StsBadArgErr)
    armRetArgErrIf((iDstStep == 0) || (iDstStep & 15), OMX_StsBadArgErr)
