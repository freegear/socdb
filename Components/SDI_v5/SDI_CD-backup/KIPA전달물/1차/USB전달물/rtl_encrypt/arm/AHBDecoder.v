...
// Outputs
output        HSEL_USB;        // peripheral select - USB
output        HSEL_DMA;        // peripheral select - DMA
output        HSEL_IRC;        // peripheral select - Interrupt Controller
...
// Outputs
wire          HSEL_USB;        // peripheral select - USB
wire          HSEL_DMA;        // peripheral select - DMA
wire          HSEL_IRC;        // peripheral select - Interrupt Controller
...
// -----------------------------------------------------------------------------
wire       iHSEL_USB;
// Internal copy of HSEL_USB

wire       iHSEL_DMA;
// Internal copy of HSEL_DMA

wire       iHSEL_IRC;
// Internal copy of HSEL_IRC
...
assign iHSEL_USB   = ((iHSELLOGICMODULE == 1'b1) &   // 0xC100_0000 ~ 0xC1FF_FFFF
                           (HADDR[27:24] == 4'b0001) ) ? 1'b1 : 1'b0;

assign iHSEL_DMA    = ((iHSELLOGICMODULE == 1'b1) &  // 0xC200_0000 ~ 0xC2FF_FFFF
                           (HADDR[27:24] == 4'b0010) ) ? 1'b1 : 1'b0;

assign iHSEL_IRC    = ((iHSELLOGICMODULE == 1'b1) &  // 0xC300_0000 ~ 0xC3FF_FFFF
                           (HADDR[27:24] == 4'b0011) ) ? 1'b1 : 1'b0;

assign iHSELDefault   = ((iHSELLOGICMODULE == 1'b1) &
                        ~iHSEL_USB & ~iHSEL_DMA & ~iHSEL_IRC) ? 1'b1 : 1'b0;
...
assign HSEL_USB         = iHSEL_USB;
assign HSEL_DMA         = iHSEL_DMA;
assign HSEL_IRC         = iHSEL_IRC;
