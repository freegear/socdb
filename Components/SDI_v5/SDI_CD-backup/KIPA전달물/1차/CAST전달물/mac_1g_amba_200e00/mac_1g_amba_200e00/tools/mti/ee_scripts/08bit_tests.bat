@echo off
rem *******************************************************************
rem Copyright (c) 1999-2003  Evatronix SA
rem *******************************************************************
...
rem Version              : 1.15
rem Last modification    : 2003-11-28
rem -------------------------------------------------------------------
...
set vsim_dir=c:\modeltech\win32
...
set scr_file=tools/mti/ee_scripts/08bit_tests.tcl
set log_file=tools/mti/ee_reports/08bit_tests.log
