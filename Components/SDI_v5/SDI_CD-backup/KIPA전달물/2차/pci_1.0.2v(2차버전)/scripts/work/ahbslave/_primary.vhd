...
entity ahbslave is
    ...
    port(
        ...
        lerr            : in     vl_logic;
        lretry          : in     vl_logic;
        lrddata         : in     vl_logic_vector(31 downto 0);
        ...
        lwe             : out    vl_logic;
        lrd             : out    vl_logic;
        lnewacc         : out    vl_logic;
        lben            : out    vl_logic_vector(3 downto 0);
        laddr           : out    vl_logic_vector;
        lwrdata         : out    vl_logic_vector(31 downto 0);
        lsize           : out    vl_logic_vector(2 downto 0);
        lburst          : out    vl_logic_vector(2 downto 0)
    );
end ahbslave;
