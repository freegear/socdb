...
`ifdef functional
s_decfq2 #1 (Q,CPN,ENN,CDN,D,1'b1);
`else
reg notifier;
`ifdef neg_tchk
s_decfq2 #1 (Q,d_CPN,d_ENN,d_CDN,d_D,notifier);
`else
s_decfq2 #1 (Q,CPN,ENN,CDN,D,notifier);
`endif
`endif
...
`ifdef neg_tchk
$setuphold (negedge CPN &&& (CDN==1'b1),posedge ENN &&& (CDN==1'b1),tsu_enn_h_cpn,th_cpn_enn_h,notifier,,,d_CPN,d_ENN);
$setuphold (negedge CPN &&& (CDN==1'b1),negedge ENN &&& (CDN==1'b1),tsu_enn_l_cpn,th_cpn_enn_l,notifier,,,d_CPN,d_ENN);
...
primitive s_decfq2(Q,CPN,ENN,CDN,D,notifier);
