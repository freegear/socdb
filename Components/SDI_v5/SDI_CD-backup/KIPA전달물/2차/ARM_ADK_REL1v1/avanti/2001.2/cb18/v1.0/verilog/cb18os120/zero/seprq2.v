...
`ifdef functional
s_seprq2 #1 (Q,CP,SC,ENN,SDN,D,SD,1'b0);
`else
reg notifier;
`ifdef neg_tchk
s_seprq2 #1 (Q,d_CP,d_SC,d_ENN,d_SDN,d_D,d_SD,notifier);
`else
s_seprq2 #1 (Q,CP,SC,ENN,SDN,D,SD,notifier);
`endif
`endif
...
primitive s_seprq2(Q,CP,SC,ENN,SDN,D,SD,notifier);
