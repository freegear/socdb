...
reg notifier;
`ifdef neg_tchk
U_FD_N_R_S_NO_QN #0.01 (QN,d_D,not_CP,not_CDN,not_SDN,notifier);
U_FD_P_RB_SB_NO #0.01 (Q,d_D,d_CP,d_CDN,d_SDN,notifier);
`else
U_FD_N_R_S_NO_QN #0.01 (QN,D,not_CP,not_CDN,not_SDN,notifier);
U_FD_P_RB_SB_NO #0.01 (Q,D,CP,CDN,SDN,notifier);
`endif
`endif
