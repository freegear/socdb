...
`ifdef functional
s_denrq2 #1 (Q,CP,ENN,D,1'b1);
`else
reg notifier;
`ifdef neg_tchk
s_denrq2 #1 (Q,d_CP,d_ENN,d_D,notifier);
`else
s_denrq2 #1 (Q,CP,ENN,D,notifier);
`endif
`endif
...
// Parameter declarations
 specparam tsu_enn_h_cp=0.36,tsu_enn_l_cp=0.45,tsu_d_h_cp=0.28,tsu_d_l_cp=0.37,
 th_cp_enn_h=0.00,th_cp_enn_l=0.00,th_cp_d_h=0.00,th_cp_d_l=0.00,tpw_cp_h=0.24,
 tpw_cp_l=0.43,cp_lh_q_lh=0,cp_lh_q_hl=0;
...
primitive s_denrq2(Q,CP,ENN,D,notifier);
