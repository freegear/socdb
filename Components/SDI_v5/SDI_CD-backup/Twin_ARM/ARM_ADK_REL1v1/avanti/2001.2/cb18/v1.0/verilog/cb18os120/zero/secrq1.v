...
`ifdef functional
s_secrq1 #1 (Q,CP,ENN,SC,CDN,D,SD,1'b0);
`else
reg notifier;
`ifdef neg_tchk
s_secrq1 #1 (Q,d_CP,d_ENN,d_SC,d_CDN,d_D,d_SD,notifier);
`else
s_secrq1 #1 (Q,CP,ENN,SC,CDN,D,SD,notifier);
`endif
`endif
...
primitive s_secrq1(Q,CP,ENN,SC,CDN,D,SD,notifier);
