...
`ifdef functional
s_depfq2 #1 (Q,CPN,ENN,SDN,D,1'b0);
`else
reg notifier;
`ifdef neg_tchk
s_depfq2 #1 (Q,d_CPN,d_ENN,d_SDN,d_D,notifier);
`else
s_depfq2 #1 (Q,CPN,ENN,SDN,D,notifier);
`endif
`endif
...
primitive s_depfq2(Q,CPN,ENN,SDN,D,notifier);
