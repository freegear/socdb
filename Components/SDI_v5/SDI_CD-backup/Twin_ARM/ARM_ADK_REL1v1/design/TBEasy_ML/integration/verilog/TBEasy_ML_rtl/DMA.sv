# SimVision Command Script (Tue May 24 20:08:13 KST 2005)
...
#
if {[window find -match exact -name "Design Browser 2"] == {}} {
    window new DesignBrowser -name "Design Browser 2" -geometry 700x500+312+285
} else {
    window geometry "Design Browser 2" 700x500+312+285
}
window target "Design Browser 2" on
...
waveform set \
    ...
    -units ns \
    -valuewidth 72
cursor set -using "TimeA" -time 83,536,257ps
waveform baseline set -time 96557.421ns
...
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uOutport2.uUART.UARTRXDMASREQ}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.DMACSREQ[15:0]}}]
...
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HBUSREQDMACM}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HLOCKDMACM}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HPROTM[3:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HRDATA[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HREADYOUT}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HRESP[1:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HCLK}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HSIZEM[2:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uInport0.HTRANS[1:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uInport0.HREADYmtrx}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HTRANSM[1:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HREADYINM}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uOutport2.uAPBif.HTRANS[1:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uOutport2.uAPBif.HREADYOUT}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
...
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HADDRM[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uInport0.HWRITE}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uOutport2.HRDATA[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HRDATAM[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uOutport2.uUART.PRDATA[15:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uOutport0.HADDR[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uOutport0.HWRITE}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uOutport0.HWDATA[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uOutport0.HRDATA[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}

waveform xview limits 0 115322.361ns
