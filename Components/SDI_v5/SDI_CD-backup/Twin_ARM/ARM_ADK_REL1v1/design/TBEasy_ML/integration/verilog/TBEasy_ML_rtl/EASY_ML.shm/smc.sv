# SimVision Command Script (Wed Jun 08 11:25:10 KST 2005)

#
# databases
#
if {[database find -match exact -name "EASY_ML"] == {}} {
    database open /user/bhchoi/tmp/ARM_ADK_REL1v1/design/TBEasy_ML/integration/verilog/TBEasy_ML_rtl/EASY_ML.shm/EASY_ML.trn -name "EASY_ML"
}
...
if {[window find -match exact -name "Design Browser 1"] == {}} {
    window new DesignBrowser -name "Design Browser 1" -geometry 950x500+251+40
} else {
    window geometry "Design Browser 1" 950x500+251+40
}
window target "Design Browser 1" on
browser using "Design Browser 1"
browser set \
    -scope {EASY_ML::TBEasy_ML.uEASY_ML.uOutport0} \
    -showinouts 0 \
    -showinputs 0 \
    -showoutputs 0
browser yview see {EASY_ML::TBEasy_ML.uEASY_ML.uOutport0}
...
waveform set \
    ...
    -units ns \
    -valuewidth 54
cursor set -using "TimeA" -time 987492.271ns
waveform baseline set -time 1008629.356ns

set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uOutport0.HADDR[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uOutport0.HSELS13}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.XCLKIN}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.XA[30:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.XD[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.XDout[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uInport0.uIntMem.HADDR[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uInport0.HSELIntMem}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uInport0.uIntMem.HWRITE}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uInport0.uIntMem.HWDATA[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uInport0.uIntMem.HREADY}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uInport0.uIntMem.HSELIntMem}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uInport0.uIntMem.HRDATA[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HWRITEM}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.DMACCLR[15:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uDmac.DMACINTERR}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uDmac.DMACINTR}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uDmac.DMACINTTC}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.DMACTC[15:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uInport0.uIntMem.HCLK}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HADDRM[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HWDATAM[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HBURSTM[2:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HRDATA[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HRESP[1:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HSIZEM[2:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.HTRANSM[1:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.Ch0AddrM[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.Ch0HRDATA[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uDmac.Ch0HWDATA[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uInport0.HRDATAdmac[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uDmac.Ch0ReqM}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uInport0.uARM922T.HWDATAS[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uInport0.uARM922T.HRDATAM[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{EASY_ML::TBEasy_ML.uEASY_ML.uInport0.uARM922T.uARM922T.DIN[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uOutport2.uUART.UARTTXD}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uOutport0.EBIREQ3}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {EASY_ML::TBEasy_ML.uEASY_ML.uOutport0.EBIREQ3r}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}

waveform xview limits 0 268546.001ns
