# SimVision Command Script (Wed Mar 23 13:43:41 KST 2005)
...
if {[window find -match exact -name "Design Browser 1"] == {}} {
    window new DesignBrowser -name "Design Browser 1" -geometry 700x500+198+128
} else {
    window geometry "Design Browser 1" 700x500+198+128
}
window target "Design Browser 1" on
browser using "Design Browser 1"
browser set \
    -scope {sim_EASY_ML::TBEasy_ML.uMemory} \
    -showinternals 0
browser yview see {sim_EASY_ML::TBEasy_ML.uMemory}
...
waveform set \
    ...
    -units ns \
    -valuewidth 73
cursor set -using "TimeA" -time 1543.076ns
waveform baseline set -time 1049.255ns
...
waveform xview limits 1651.928ns 1785.148ns
