...
unsigned int genScript(char *fileName, char *DirFileName)
{
    ...
    fprintLink(head_ptr, script , DirFileName);
...
// SlaveMaster == 0 -> WriteChannel Slave
// SlaveMaster == 1 -> WriteChannel Master
// SlaveMaster == 10-> ReadChannel Slave
// SlaveMaster == 11-> ReadChannel Master
        ...
        for(j=0; endMasterBuff >j ; j++)
        {
            if(changeStr(BuffMaster[j],buff, "??", (char *)ReqNum)==0)
            {
                ...
                else if(strcmp(BuffMaster[j],"//ENABLE_ID\n") == 0)
                {
                    if(IDEnable != ENABLE)
                    {
                        j++; inDataLink(head_ptr, "//Disalbe_id_port\n");
                    }
                }
                else if(strcmp(BuffMaster[j],"//ENABLE_LOCK\n") == 0)
                {
                    ...
                    {
                        j++; inDataLink(head_ptr, "//Disalbe_lock_port\n");
                    }
                }
                ...
                else if(strcmp(BuffMaster[j],"//ENABLE_CACHE\n") == 0)
                {
                    ...
                    {
                       j++; inDataLink(head_ptr, "//Disalbe_cache_port\n");
                    }
                }
...
{//RS_slice_generation start______________________________________________
            ...
            if(strcmp(buffOut[k], "//ENABLE_LOCK_Write\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_LockPortWriteChannel(master)\n");
            ...
            else if(strcmp(buffOut[k], "//ENABLE_CACHE_Write\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_CachePortWriteChannel(master)\n");
                    inDataLink(head_ptr, Tbuff);
            ...
            else if(strcmp(buffOut[k], "//ENABLE_PROT_Write\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_ProtectPortWriteChannel(master)\n");
                    inDataLink(head_ptr, Tbuff);
            ...
            else if(strcmp(buffOut[k], "//ENABLE_WSTRB_Write\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_WSTRBPortWriteChannel(master)\n");
                    inDataLink(head_ptr, Tbuff);
...
//_________READ Channel modified
            ...
            else if(strcmp(buffOut[k], "//ENABLE_LOCK_Read\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_LockPortReadChannel(master)\n");
                    inDataLink(head_ptr, Tbuff);
            ...
            else if(strcmp(buffOut[k], "//ENABLE_CACHE_Read\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_CachePortReadChannel(master)\n");
                    inDataLink(head_ptr, Tbuff);
            ...
            else if(strcmp(buffOut[k], "//ENABLE_PROT_Read\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_ProtectPortReadChannel(master)\n");
                    inDataLink(head_ptr, Tbuff);
...
//_________Write Channel modified
            ...
            if(strcmp(buffOut[k], "//ENABLE_LOCK_Write\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_LockPortWriteChannel(slave)\n");
                    inDataLink(head_ptr, Tbuff);
            ...
            else if(strcmp(buffOut[k], "//ENABLE_CACHE_Write\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_CachePortWriteChannel(slave)\n");
                    inDataLink(head_ptr, Tbuff);
            ...
            else if(strcmp(buffOut[k], "//ENABLE_PROT_Write\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_ProtectPortWriteChannel(slave)\n");
                    inDataLink(head_ptr, Tbuff);
            ...
            else if(strcmp(buffOut[k], "//ENABLE_WSTRB_Write\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_WSTRBPortWriteChannel(slave)\n");
                    inDataLink(head_ptr, Tbuff);
...
//_________READ Channel modified
            ...
            else if(strcmp(buffOut[k], "//ENABLE_LOCK_Read\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_LockPortReadChannel(slave)\n");
                    inDataLink(head_ptr, Tbuff);
            ...
            else if(strcmp(buffOut[k], "//ENABLE_CACHE_Read\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_CachePortReadChannel(slave)\n");
                    inDataLink(head_ptr, Tbuff);
            ...
            else if(strcmp(buffOut[k], "//ENABLE_PROT_Read\n")==0)
            {
                ...
                {
                    sprintf(Tbuff,"//Disalbe_ProtectPortReadChannel(slave)\n");
                    inDataLink(head_ptr, Tbuff);
                   ...
                   int * Connect)
{
    ...
    while(endi>i)
    {
        ...
        {
             char Temp[4];
             //sprintf(Temp, "%d", (int)DefBit(ValMAIN.SlaveNumber + 1));
