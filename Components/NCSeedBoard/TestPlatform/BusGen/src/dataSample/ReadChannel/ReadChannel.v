...
parameter SELMASTER_WID= 3;
    ...
    input    [SELMASTER_WID-1:0]LockPort2rdmi0;
    input    [SELMASTER_WID-1:0]LockPort2rdmi1;
    input    [SELMASTER_WID-1:0]LockPort2rdmi2;
    input    [SELMASTER_WID-1:0]LockPort2rdmi3;
    input    [SELMASTER_WID-1:0]LockPort2rdmi4;
    input    [SELMASTER_WID-1:0]LockPort2rdmi5;
    ...
    output   [SELMASTER_WID-1:0]CtlDataRead2Lock0;     
    output   [SELMASTER_WID-1:0]CtlDataRead2Lock1;     
    output   [SELMASTER_WID-1:0]CtlDataRead2Lock2;     
    output   [SELMASTER_WID-1:0]CtlDataRead2Lock3;     
    output   [SELMASTER_WID-1:0]CtlDataRead2Lock4;     
    output   [SELMASTER_WID-1:0]CtlDataRead2Lock5;     
