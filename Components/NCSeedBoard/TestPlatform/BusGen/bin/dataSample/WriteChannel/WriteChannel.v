...
//Lock access
    ...
    input    [SELMASTER_WID-1:0]LockPort2wrmi0;
    input    [SELMASTER_WID-1:0]LockPort2wrmi1;
    input    [SELMASTER_WID-1:0]LockPort2wrmi2;
    input    [SELMASTER_WID-1:0]LockPort2wrmi3;
    input    [SELMASTER_WID-1:0]LockPort2wrmi4;
    input    [SELMASTER_WID-1:0]LockPort2wrmi5;
    ...
    output   [SELMASTER_WID-1:0]CtlDataWrite2Lock0;
    output   [SELMASTER_WID-1:0]CtlDataWrite2Lock1;
    output   [SELMASTER_WID-1:0]CtlDataWrite2Lock2;
    output   [SELMASTER_WID-1:0]CtlDataWrite2Lock3;
    output   [SELMASTER_WID-1:0]CtlDataWrite2Lock4;
    output   [SELMASTER_WID-1:0]CtlDataWrite2Lock5;
