...
if($model_type == "DSM" ) then 
   ...
   echo "          |--> DSM/"
   echo "          |     |"
   echo "          |     |--> synopsys_vcs_verilog_SunOS/"
   echo "          |             |"
...
if ($model_type == "DSM" ) then
   ...
   if ($model_base != "SWIFT" &&  $model_base != "OMI" ) then
       ...
       echo "   $unpack_dir/simulation_models/DSM/synopsys_vcs_verilog_SunOS/ARM7TDMI_unlicensed_3A-00"
   ...
   setenv ARM7TDMI_HOME $unpack_dir/simulation_models/DSM/synopsys_vcs_verilog_SunOS/ARM7TDMI_unlicensed_3A-00
   ...
   if ( $install_dir != $unpack_dir/simulation_models/ ) then
       ...
       echo "modify the "
       echo "   $unpack_dir/simulation_models/DSM/synopsys_vcs_verilog_SunOS/ARM7TDMI_unlicensed_3A-00/setup.(c)sh "
