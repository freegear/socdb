...
extern void uHALir_InitSerial(unsigned int port, unsigned int baudRate, unsigned int baudRate_F);

#define uHALr_ResetPort()	uHALir_InitSerial(OS_COMPORT, DEFAULT_OS_BAUD, DEFAULT_OS_BAUD_F)
