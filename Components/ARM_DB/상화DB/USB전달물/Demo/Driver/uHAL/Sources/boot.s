...
SdramSetConfig
	MOV		r2, #0xf9			; r2 = 0xf9
	MOV		r3, #8				; r3 = 8
	ORR		r2, r3, r2, LSL #17	; r2 = 0x01f20008
 ...
 IF :DEF: STANDALONE
    MOV		r1, #0x24
    MOV		r1, r1, LSL #24		; 0x24000110
    MOV		r2, #0x47			; 0x24000114
    ORR		PC, r1, r2, LSL #2	; 0x24000118, PC=0x2400011c
	...
	;MOVS	r1, r4
	;LDREQ	r1, =ROMBase		; ROMBase = 0x24000000
	LDR		r1, =ROMBase		; ROMBase = 0x24000000
	SUB		r8, r1, r0
