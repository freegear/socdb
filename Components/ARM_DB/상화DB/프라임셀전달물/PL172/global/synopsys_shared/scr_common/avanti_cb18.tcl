...
#--
#-- File Name              : avanti_cb18.tcl.rca
#-- File Revision          : 1.3
#--
#-- Release Information    : PrimeCell(TM)-GLOBAL-REL1v7
#--
#------------------------------------------------------------------------------
#-- Purpose : Avanti! Passport cb18 synthesis cell library settings.
#--
#------------------------------------------------------------------------------
#-- Information :
#--   If clock gating is required then a specific clock gating cell should
#-- be specified. However for test synthesis latches are used for clock gating. 
#--
#------------------------------------------------------------------------------
...
set MAX_TECH_LIB_NAME cb18os120_generic_max
set MIN_TECH_LIB_NAME cb18os120_generic_min
set TYP_TECH_LIB_NAME cb18os120_generic_typ

#-- Set library filename variable --
set MAX_LIB_FILENAME cb18os120_generic_max.db
set MIN_LIB_FILENAME cb18os120_generic_min.db
set TYP_LIB_FILENAME cb18os120_generic_typ.db

#-- Set names for library best and worst case condition names --
set BC_NAME cb18os120_generic_min
set WC_NAME cb18os120_generic_max

#-- Set library symbols filename variable --
set LIB_SYMBOL_FILE cb18os120.sdb

#-- Set wire-load model libraries change according to the size of --
#-- the design. Wire-load models exist in the main libraries      --     

set MAX_WL_LIB cb18os120_generic_max.db
set MIN_WL_LIB cb18os120_generic_min.db
set TYP_WL_LIB cb18os120_generic_typ.db
