 ...
 *                     \/            \/     \/    \/            \/
 * $Id: system.h,v 1.37 2005/09/12 10:34:27 linus Exp $
 *
...
static inline int set_irq_level(int level)
{
    ...
    //asm volatile ("stc sr, %0" : "=r" (i)); // To avoid compile error by DJKIM 2006/11/30
    //asm volatile ("ldc %0, sr" : : "r" (level)); // To avoid compile error by DJKIM 2006/11/30
    return i;
}
