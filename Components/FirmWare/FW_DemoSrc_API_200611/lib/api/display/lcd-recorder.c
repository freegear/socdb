 ...
 *                     \/            \/     \/    \/            \/
 * $Id: lcd-recorder.c,v 1.69 2005/08/08 19:23:27 linus Exp $
 *
...
static int scroll_delay = 100/2; /* ticks delay before start */
...
void lcd_write_command(int cmd) {
	// Edit your code by DJKIM 2006/12/01
}
