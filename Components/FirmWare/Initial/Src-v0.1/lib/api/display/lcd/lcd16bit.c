...
#include "rbunicode.h"
#include "bidi.h"
//#include "Suno_debug.h"

/*//////////////////////////////////////////////////////////////////////////////
        DEFINITION
//////////////////////////////////////////////////////////////////////////////*/
#define SCROLLABLE_LINES ((LCD_HEIGHT+4)/5 < 32 ? (LCD_HEIGHT+4)/5 : 32)
#if 1//shkim-20061214 : add to avoid compile error
#define DEFAULT_STACK_SIZE 0x400
#define HZ 100 
#endif
#define LCDADDR(x,y) ((fb_data *)lcd_framebuffer + y*LCD_WIDTH + x)	// By shkim 2006/12/14
enum fill_opt 
{
    OPT_NONE = 0,
    OPT_SET,
...
//////////////////////////////////////////////////////////////////////////////*/
fb_data *lcd_framebuffer = (fb_data *)0x40000000;	//DDR SDRAM_STARTADDR // By shkim 2006/12/14

static fb_data* lcd_backdrop = NULL;
static long lcd_backdrop_offset = 0;
...
#if 0 //shkim-20061214 : porting scroll
/* scrolling */
...
static struct scrollinfo scroll[2];	// Temp value to avoid linker error by shkim 2006/12/14
...
/*------------------------------------------------------------------------------
    Function name   : lcd_getstringsize
    Prototype       : 
    Return          : 
    Argument        :
    Comments        : 
...
{
#if 1 //shkim-20061214 : porting font
	return 0;
#else
...
//------------------------------------------------------------------------------
//	array of low level drawing functions
//------------------------------------------------------------------------------
...
void lcd_set_backdrop(fb_data* backdrop)
{
    ...
    if (backdrop)
    {
        lcd_backdrop_offset = (long)backdrop - (long)lcd_framebuffer;	// By shkim 2006/12/14
...
/*------------------------------------------------------------------------------
    Function name   : lcd_get_backdrop
    Prototype       : 
    Return          : 
    Argument        :
    Comments        : 
...
/*------------------------------------------------------------------------------
    Function name   : lcd_clear_display
    Prototype       : 
    Return          : 
    Argument        :
    Comments        : Clear the whole display
------------------------------------------------------------------------------*/
void lcd_clear_display(void)
{
    ...
    else
    {
        if (!lcd_backdrop)
            ...
            memcpy(dst, lcd_backdrop, LCD_WIDTH*LCD_HEIGHT*2);	// By shkim 2006/12/14
    }
#if 0 //shkim-20061214 : porting scroll    
    scrolling_lines = 0;
#endif    
...
/*------------------------------------------------------------------------------
    ...
    Return          : 
    Argument        :
    Comments        : Draw a horizontal line (optimised) 
------------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------------
    ...
    Return          : 
    Argument        :
    Comments        : Draw a rectangular box
------------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------------
    ...
    Return          : 
    Argument        :
    Comments        : Fill a rectangular area
------------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------------
    Function name   : lcd_mono_bitmap_part
    Prototype       : 
    Return          : 
    Argument        :
    Comments        : Draw a partial monochrome bitmap 
------------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------------
    Function name   : lcd_mono_bitmap
    Prototype       : 
    Return          : 
    Argument        :
    Comments        : Draw a full monochrome bitmap 
------------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------------
    Function name   : lcd_bitmap_part
    Prototype       : 
    Return          : 
    Argument        :
    Comments        : Draw a partial native bitmap 
------------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------------
    ...
    Return          : 
    Argument        :
    Comments        : Draw a full native bitmap 
------------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------------
    Function name   : lcd_bitmap_transparent_part
    Prototype       : 
    Return          : 
    Argument        :
    Comments        : Draw a partial native bitmap 
...
/*------------------------------------------------------------------------------
    Function name   : lcd_bitmap_transparent
    Prototype       : 
    Return          : 
    Argument        :
    Comments        : Draw a full native bitmap with a transparent color 
------------------------------------------------------------------------------*/
...
//------------------------------------------------------------------------------
//
//	the functions below need to be ported for scroll and font
//
//------------------------------------------------------------------------------
#if 0 //shkim-20061214 : porting font
/* put a string at a given pixel position, skipping first ofs pixel columns */
static void lcd_putsxyofs(int x, int y, int ofs, const unsigned char *str)
{
#if 0//shkim-20061214 : further work
    unsigned short ch;
    unsigned short *ucs;
    ...
    while ((ch = *ucs++) != 0 && x < LCD_WIDTH)
    {
        ...
        //width = font_get_width(pf,ch);//shkim-20061214 : font porting
      ...
      //  bits = font_get_bits(pf, ch);//shkim-20061214 : font porting
                           ...
                           int offset)
{
    ...
    //lcd_getstringsize(str, &w, &h);//shkim-20061214:further work
