 ...
 * but I'm not sure IRQ_INTR supports static function.
 */
IRQ_INTR void IsrEINT0(void);
IRQ_INTR void IsrEINT1(void);
IRQ_INTR void IsrEINT2(void);
IRQ_INTR void IsrEINT3(void);
IRQ_INTR void IsrIIC0(void);
IRQ_INTR void IsrIIC0_AAS(void);
IRQ_INTR void IsrTIMER0_TOF(void);
IRQ_INTR void IsrTIMER0_TMC(void);
IRQ_INTR void IsrTIMER1_TOF(void);
IRQ_INTR void IsrTIMER1_TMC(void);
IRQ_INTR void IsrTIMER2_TOF(void);
IRQ_INTR void IsrTIMER2_TMC(void);
IRQ_INTR void IsrEINT4(void);
IRQ_INTR void IsrEINT5(void);
IRQ_INTR void IsrEINT6(void);
IRQ_INTR void IsrEINT7(void);
IRQ_INTR void IsrIIC1(void);
IRQ_INTR void IsrIIC1_AAS(void);
IRQ_INTR void IsrWDT(void);
IRQ_INTR void IsrADC(void);
IRQ_INTR void IsrUTX(void);
IRQ_INTR void IsrURX(void);
IRQ_INTR void IsrTIMER3_TOF(void);
IRQ_INTR void IsrTIMER3_TMC(void);
IRQ_INTR void IsrTIMER4_TOF(void);
IRQ_INTR void IsrTIMER4_TMC(void);
IRQ_INTR void IsrTIMER5_TOF(void);
IRQ_INTR void IsrTIMER5_TMC(void);
IRQ_INTR void IsrTIMER6_TOF(void);
IRQ_INTR void IsrTIMER6_TMC(void);
IRQ_INTR void IsrTIMER7_TOF(void);
IRQ_INTR void IsrTIMER7_TMC(void);
...
/*----------------------------------------------------------
	...
	Argument		:
	Comments		:
		Regist the isr routine to vector table
		time > 0 : the number of loop time
----------------------------------------------------------*/
static void smtISRregist(void)
{
	 AddrEINT0 = (smtUint32)IsrEINT0;
	 AddrEINT1 = (smtUint32)IsrEINT1;
	 AddrEINT2 = (smtUint32)IsrEINT2;
	 AddrEINT3 = (smtUint32)IsrEINT3;
	 AddrIIC0 = (smtUint32)IsrIIC0;
	 AddrIIC0_AAS = (smtUint32)IsrIIC0_AAS;
	 AddrTIMER0_TOF = (smtUint32)IsrTIMER0_TOF;
	 AddrTIMER0_TMC = (smtUint32)IsrTIMER0_TMC;
	 AddrTIMER1_TOF = (smtUint32)IsrTIMER1_TOF;
	 AddrTIMER1_TMC = (smtUint32)IsrTIMER1_TMC;
	 AddrTIMER2_TOF = (smtUint32)IsrTIMER2_TOF;
	 AddrTIMER2_TMC = (smtUint32)IsrTIMER2_TMC;
	 AddrEINT4 = (smtUint32)IsrEINT4;
	 AddrEINT5 = (smtUint32)IsrEINT5;
	 AddrEINT6 = (smtUint32)IsrEINT6;
	 AddrEINT7 = (smtUint32)IsrEINT7;
	 AddrIIC1 = (smtUint32)IsrIIC1;
	 AddrIIC1_AAS = (smtUint32)IsrIIC1_AAS;
	 AddrWDT = (smtUint32)IsrWDT;
	 AddrADC = (smtUint32)IsrADC;
	 AddrUTX = (smtUint32)IsrUTX;
	 AddrURX = (smtUint32)IsrURX;
	 AddrTIMER3_TOF = (smtUint32)IsrTIMER3_TOF;
	 AddrTIMER3_TMC = (smtUint32)IsrTIMER3_TMC;
	 AddrTIMER4_TOF = (smtUint32)IsrTIMER4_TOF;
	 AddrTIMER4_TMC = (smtUint32)IsrTIMER4_TMC;
	 AddrTIMER5_TOF = (smtUint32)IsrTIMER5_TOF;
	 AddrTIMER5_TMC = (smtUint32)IsrTIMER5_TMC;
	 AddrTIMER6_TOF = (smtUint32)IsrTIMER6_TOF;
	 AddrTIMER6_TMC = (smtUint32)IsrTIMER6_TMC;
	 AddrTIMER7_TOF = (smtUint32)IsrTIMER7_TOF;
	 AddrTIMER7_TMC = (smtUint32)IsrTIMER7_TMC;
}
