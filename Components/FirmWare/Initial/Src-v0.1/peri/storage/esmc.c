...
smtUint32 ESMCTest(void)
{
	...
	*/
	...
	SMT_WRITE(ESMC_B3_CON, 
		0x1<<SHIFT_DN_FROM_MASK(TAS_MASK) | 0x1<<SHIFT_DN_FROM_MASK(TCSS_MASK) |
		0x1<<SHIFT_DN_FROM_MASK(TACC_MASK) | 0x2<<SHIFT_DN_FROM_MASK(TCSH_MASK) |
		0x2<<SHIFT_DN_FROM_MASK(TAH_MASK) | 0x1<<SHIFT_DN_FROM_MASK(WIDTH_MASK) );
	...
	SMT_WRITE(ESMC_B1_CON,
		0x1<<SHIFT_DN_FROM_MASK(TAS_MASK) | 0x1<<SHIFT_DN_FROM_MASK(TCSS_MASK) |
		0x1<<SHIFT_DN_FROM_MASK(TACC_MASK) | 0x2<<SHIFT_DN_FROM_MASK(TCSH_MASK) |
		0x2<<SHIFT_DN_FROM_MASK(TAH_MASK) );
