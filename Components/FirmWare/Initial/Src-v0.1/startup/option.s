...
;--------------------------------------------------------
; SkyWalker memory size setting
		GBLA	SKYWALKER_MEM_SIZE
SKYWALKER_MEM_SIZE  SETA	0x4000000
;SKYWALKER_MEM_SIZE SETA	0x8000000

		GBLA	SKYWALKER_MEM_BASE
SKYWALKER_MEM_BASE  SETA	0x30000000
;--------------------------------------------------------

;--------------------------------------------------------
; Start address of each stacks
	[ SKYWALKER_MEM_SIZE = 0x4000000
_STACK_BASEADDRESS		EQU	0x33ff8000
_MMUTT_STARTADDRESS		EQU	0x33ff8000
_ISR_STARTADDRESS		EQU	0x33ffff00
_RELOCATE_STARTADDR		EQU	0x33f00000
	]
	[ SKYWALKER_MEM_SIZE = 0x8000000
...
;--------------------------------------------------------
; main function using - Need to this??? (fix to use main()) - 2006/07/04
		GBLL	USE_MAIN 
;USE_MAIN			SETL	{TRUE}
USE_MAIN			SETL	{FALSE}
;--------------------------------------------------------
...
;--------------------------------------------------------
; If endian change is needed - Need to this??? (fix to little endian) - 2006/07/04
		GBLL	ENDIAN_CHANGE
ENDIAN_CHANGE		SETL	{FALSE}
;--------------------------------------------------------

;--------------------------------------------------------
; Hmm. What's the mean of ENTRY_BUS_WIDTH???
		GBLA	ENTRY_BUS_WIDTH
ENTRY_BUS_WIDTH		SETA	16
;--------------------------------------------------------

;--------------------------------------------------------
; Memory BANK bus width setting
;BUSWIDTH = 16,32
...
;CLKDIV_VAL		SETA	7	; 0=1:1:1/1=1:1:2/2=1:2:2/3=1:2:4/4=1:4:4/5=1:4:8/6=1:3:3/7=1:3:6
CLKDIV_VAL		SETA	5
;--------------------------------------------------------
...
; MPLL &  UPLL setting
	...
	[ FCLK = 271500000		; MPLL setting - M_MDIV / MPDIV / M_SDIV (Using in the Startup.s)
...
M_SDIV			EQU		0	; 2440X
	...
	[ UCLK = 48000000		; UPLL setting - U_MDIV / U_PDIV / U_SDIV (Using in the Startup.s)
