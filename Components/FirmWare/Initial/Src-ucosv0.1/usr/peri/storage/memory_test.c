	...
	switch(method) 
	{
		...
		case AM_SEQ:
			...
			for(u8Idx = 0; u8Idx < size; u8Idx++) 
			{
				...
				{
					MEMTDPRINTF(11, "[MEM ERROR] 8bits seq access fail\n");
					MEMTDPRINTF(11, "[MEM ERROR] addr:origin:read");
					MEMTDPRINTF(11, "-0x%08x|0x%08x:0x%08x\n",
			...
			MEMTDPRINTF(11, "[MEM TEST] 8bits seq acces OK!!!\n");			
		...
		case AM_NONSEQ:
			...
			for(u8Idx = 0; u8Idx < size; u8Idx+=8) 
			{
				if(*pSource != GetSeed(AT_08BITS, u8Idx, seed))
				{
					MEMTDPRINTF(11, "[MEM ERROR] 8bits none seq access fail\n");
					MEMTDPRINTF(11, "[MEM ERROR] addr:origin:read");
					MEMTDPRINTF(11, "-0x%08x|0x%08x:0x%08x\n",
							pSource, GetSeed(AT_08BITS, u8Idx, seed) ,*pSource);
			...
			MEMTDPRINTF(11, "[MEM TEST] 8bits none seq acces OK!!!\n");			
	...
	switch(method) 
	{
		...
		case AM_SEQ:
			...
			for(u16Idx = 0; u16Idx < size/sizeof(smtUint16); u16Idx++) 
			{
				...
				{
					MEMTDPRINTF(11, "[MEM ERROR] 16bits seq access faile\n");
					MEMTDPRINTF(11, "[MEM ERROR] addr:origin:read");
					MEMTDPRINTF(11, "-0x%08x|0x%08x:0x%08x\n",
			...
			MEMTDPRINTF(11, "[MEM TEST] 16bits seq acces OK!!!\n");			
		...
		case AM_NONSEQ:
			...
			for(u16Idx = 0; u16Idx < size/sizeof(smtUint16); u16Idx+=8) 
			{
				if(*pSource != GetSeed(AT_16BITS, u16Idx, seed))
				{
					MEMTDPRINTF(11, "[MEM ERROR] 16bits none seq access faile\n");
					MEMTDPRINTF(11, "[MEM ERROR] addr:origin:read");
					MEMTDPRINTF(11, "-0x%08x|0x%08x:0x%08x\n",
							pSource, GetSeed(AT_16BITS, u16Idx, seed) ,*pSource);
					return false;
			...
			MEMTDPRINTF(11, "[MEM TEST] 16bits none seq acces OK!!!\n");			
	...
	switch(method) 
	{
		...
		case AM_SEQ:
			...
			for(u32Idx = 0; u32Idx < size/sizeof(smtUint32); u32Idx++) 
			{
				...
				{
					MEMTDPRINTF(11, "[MEM ERROR] 32bits seq access fail\n");
					MEMTDPRINTF(11, "[MEM ERROR] addr:origin:read");
					MEMTDPRINTF(11, "-0x%08x|0x%08x:0x%08x\n",
			...
			MEMTDPRINTF(11, "[MEM TEST] 32bits seq acces OK!!!\n");			
		...
		case AM_NONSEQ:
			...
			for(u32Idx = 0; u32Idx < size/sizeof(smtUint32); u32Idx+=8) 
			{
				if(*pSource != GetSeed(AT_32BITS, u32Idx, seed))
				{
					MEMTDPRINTF(11, "[MEM ERROR] 32bits none seq access fail\n");
					MEMTDPRINTF(11, "[MEM ERROR] addr:origin:read");
					MEMTDPRINTF(11, "-0x%08x|0x%08x:0x%08x\n",
							pSource, GetSeed(AT_32BITS, u32Idx, seed) ,*pSource);
					return false;
			...
			MEMTDPRINTF(11, "[MEM TEST] 32bits none seq acces OK!!!\n");			
		...
		case AM_BURST:
		{
			...
			for(u32Idx = 0; u32Idx < (size/2)/sizeof(smtUint32); u32Idx++) 
			{
				if(*pSource != GetSeed(AT_32BITS, u32Idx, seed))
				{
					MEMTDPRINTF(11, "[MEM ERROR] 32bits burst access fail\n");
					MEMTDPRINTF(11, "[MEM ERROR] addr:origin:read");
					MEMTDPRINTF(11, "-0x%08x|0x%08x:0x%08x\n",
							pSource, GetSeed(AT_32BITS, u32Idx, seed) ,*pSource);
					return false;
			...
			MEMTDPRINTF(11, "[MEM TEST] 32bits burst access OK!!!\n");			
		}
		break;
	}
