...
#define REG_DM_BASEADDR		DM_BASEADDR
#define REG_DMA_BASE			DMAC_BASEADDR
#define REG_DMAG_BASE			DMA2D_BASEADDR
...
#define REG_MMC_BASE			MMC_BASEADDR
#define REG_NAND_BASE			NAND_BASEADDR
#define REG_TIMER_BASE			TIMER_BASEADDR
#define REG_UART0_BASE			UART0_BASEADDR
#define REG_UART1_BASE			UART1_BASEADDR
#define REG_UART2_BASE			UART2_BASEADDR
#define REG_UART3_BASE			UART3_BASEADDR
#define REG_VIC_BASE			VIC_BASEADDR
#define REG_VIF_BASE			VIF_BASEADDR
...
//UART ch2
#define REG_UART2MASTER		(REG_UART2_BASE+0x00)
#define REG_UART2STATUS		(REG_UART2_BASE+0x04)
#define REG_UART2BRD			(REG_UART2_BASE+0x08)
#define REG_UART2TXFIFO		(REG_UART2_BASE+0x0C)
#define REG_UART2RXFIFO		(REG_UART2_BASE+0x10)
#define REG_UART2RXTIMEOUT	(REG_UART2_BASE+0x14)

//UART ch3
#define REG_UART3MASTER		(REG_UART3_BASE+0x00)
#define REG_UART3STATUS		(REG_UART3_BASE+0x04)
#define REG_UART3BRD			(REG_UART3_BASE+0x08)
#define REG_UART3TXFIFO		(REG_UART3_BASE+0x0C)
#define REG_UART3RXFIFO		(REG_UART3_BASE+0x10)
#define REG_UART3RXTIMEOUT	(REG_UART3_BASE+0x14)
