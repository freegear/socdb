...
; PROJECT: arm_top
; ============================================================
; File Name: /SoCMaster-Example/SoCMasterXP8000/keypad/quartus/stripe.s
...
EXC_INPUT_CLK_FREQUENCY EQU (50000000)
EXC_AHB1_CLK_FREQUENCY EQU (125000000)
EXC_AHB2_CLK_FREQUENCY EQU (62500000)
EXC_SDRAM_CLK_FREQUENCY EQU (25000000)
...
EXC_EBI_BLOCK0_SIZE EQU (0x00800000)
EXC_EBI_BLOCK0_WIDTH EQU (16)
EXC_EBI_BLOCK0_NON_CACHEABLE EQU (1)
EXC_EBI_BLOCK0_CACHEABLE EQU (0)
EXC_EBI_BLOCK1_BASE EQU (0x40800000)
EXC_EBI_BLOCK1_SIZE EQU (0x00800000)
...
EXC_SPSRAM_BLOCK1_BASE EQU (0x00020000)
...
EXC_DPSRAM_BLOCK0_BASE EQU (0x00100000)
EXC_DPSRAM_BLOCK0_SIZE EQU (0x00040000)
EXC_DPSRAM_BLOCK0_WIDTH EQU (8)

; PLD Block(s)
EXC_PLD_BLOCK0_BASE EQU (0x10000000)
