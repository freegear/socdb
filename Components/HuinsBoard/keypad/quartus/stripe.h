/* megafunction wizard: %ARM-Based Excalibur%
   ...
   PROJECT: arm_top
   ============================================================
   File Name: /SoCMaster-Example/SoCMasterXP8000/keypad/quartus/stripe.h
...
#define	EXC_DPSRAM_BLOCK0_BASE (0x00100000)
#define	EXC_DPSRAM_BLOCK0_SIZE (0x00040000)
#define	EXC_DPSRAM_BLOCK0_WIDTH (8)

/* PLD Block(s) */
#define	EXC_PLD_BLOCK0_BASE (0x10000000)
