  ...
  /* Main and Proc_0 in the Ada version             */
{
	...
	REG   char      Ch_Index;
        ...
        Str_30          Str_2_Loc;
	REG   int       Run_Index;
	REG   int       Number_Of_Runs=400*700;
	...
	Next_Ptr_Glob = &G2;
	Ptr_Glob      = &G1;
#else /* MANIK_HARDWARE_ONLY */
#if defined(INPUT_ALLOWED)
#ifdef riscos
...
void Proc_1 (REG Rec_Pointer Ptr_Val_Par) /* executed once */
{
