...
package manikconfig is
    ...
    constant CONFIG_SDRAM_ADDR_W      : integer := 14;
    constant CONFIG_SDRAM_CKES        : integer := 1;
    constant CONFIG_ICACHE_ENABLED    : boolean := false;
    constant CONFIG_DCACHE_ENABLED    : boolean := false;
    ...
    constant CONFIG_SHIFT_SWIDTH      : integer := 1;
    constant CONFIG_MULT_BWIDTH       : integer := 2;
...
--    constant OCSYNCRAM_INIT : string := "gdbstub";
    ...
    constant IN_FREQ_MHZ   : integer := 100;  -- input clock frequency in MHZ
    ...
    constant FPGA_Family : string  := "Virtex";
