...
create_clock -name "MainCLK33"  -p 30.3 -w [list 0 15.15] [get_pins P_CLK33M/C]
...
#create_clock -name "mac_status_clk1" -p 60.6  -w [list 0  30.3] [get_pins {uUWBTOP/MACTOP_MODULE/A_MACCORE_TOP/B_RX/C_FILTER/s_chk_crc32}]
create_clock -name "mac_status_clk1" -p 60.6  -w [list 0  30.3] [get_pins {uUWBTOP/MACTOP_MODULE/A_MACCORE_TOP/B_RX/C_FILTER/U14822/Y}]

#create_clock -name "mac_status_clk2" -p 60.6  -w [list 0  30.3] [get_pins {uUWBTOP/MACTOP_MODULE/A_MACCORE_TOP/B_RX/C_FILTER/s_chk_len}]
create_clock -name "mac_status_clk2" -p 60.6  -w [list 0  30.3] [get_pins {uUWBTOP/MACTOP_MODULE/A_MACCORE_TOP/B_RX/C_FILTER/s_chk_len_reg/Q}]

#create_clock -name "mac_status_clk3" -p 60.6  -w [list 0  30.3] [get_pins {uUWBTOP/MACTOP_MODULE/A_MACCORE_TOP/B_RX/C_FILTER/s_phyrx_err}]
create_clock -name "mac_status_clk3" -p 60.6  -w [list 0  30.3] [get_pins {uUWBTOP/MACTOP_MODULE/A_MACCORE_TOP/B_RX/C_FILTER/test_point_6977_U6/Y}]

#create_clock -name "mac_status_clk3" -p 60.6  -w [list 0  30.3] [get_pins {uUWBTOP/MACTOP_MODULE/A_MACCORE_TOP/B_RX/C_FILTER/s_fi_proc_done2}]
create_clock -name "mac_status_clk3" -p 60.6  -w [list 0  30.3] [get_pins {uUWBTOP/MACTOP_MODULE/A_MACCORE_TOP/B_RX/C_FILTER/test_point_6975_U6/Y}]
