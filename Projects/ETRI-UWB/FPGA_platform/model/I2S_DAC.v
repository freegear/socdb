...
always @(posedge BCLK)
	...
	begin
		case(WORD_LEN)
		2'b00:
			$display($time, "DAC read data [%h]", {RightData[31:24], LeftDataTemp[31:24]});
		2'b01:
			$display($time, "DAC read data [%h]", {RightData[31:16], LeftDataTemp[31:16]});
		2'b10:
			$display($time, "DAC read data [%h, %h]", LeftDataTemp[31:8], RightData[31:8]);
		2'b11:
			$display($time, "DAC read data [%h, %h]", LeftDataTemp[31:0], RightData[31:0]);
		endcase
	end
endmodule
