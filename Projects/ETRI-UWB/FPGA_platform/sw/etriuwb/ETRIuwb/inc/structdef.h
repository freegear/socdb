...
#define	DMA_STARTINT_EN	0x01
#define DMA_ENDINT_EN	0x01
#define DMA_MAX_CHANNEL	0x08
...
typedef enum
{
	DMA_CHANNEL_DISABLE	= 0x00,
	DMA_CHANNEL_ENABLE	= 0x01
} DMA_CHANNEL;
...
#define ERR_DMA_CHANNEL_FULL_USE	0x10
#define ERR_DMA_TRANSFAIL			0x11

#define MAX_DMA_CHANNEL	(IRQ_DMA2D + 1)

typedef struct
{
	smtBoolean polling;
	
	smtBoolean status[MAX_DMA_CHANNEL];
	smtBoolean channel[MAX_DMA_CHANNEL];	
	smtBoolean intOn[MAX_DMA_CHANNEL];	
} DMA_STRUCT;
