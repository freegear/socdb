...
`define SDA_IDLE 		9'b000000001
`define SDA_IDLE1 		9'b000000000
`define SDA_RSTART		9'b000000010
`define SDA_START		9'b000000100
`define SDA_DATASHFT	9'b000001000
`define SDA_ACK			9'b000010000
`define SDA_ACKIDLE		9'b000100000
`define SDA_STOP		9'b001000000
`define SDA_STOP1		9'b010000000
`define SDA_STOP2		9'b100000000
...
always @(C_state)
begin 
  if (C_state == 9'b000000000)
    CAState = "IDLE1";
  else if (C_state == 9'b000000001)
    CAState = "IDLE";
  else if (C_state == 9'b000000010)
    CAState = "RSTART";
  else if (C_state == 9'b000000100)
    CAState = "START";
  else if (C_state == 9'b000001000)
    CAState = "DATASHFT";
  else if (C_state == 9'b000010000)
    CAState = "ACK";
  else if (C_state == 9'b000100000)
    CAState = "ACKIDLE";
  else if (C_state == 9'b001000000)
    CAState = "STOP";
  else if (C_state == 9'b010000000)
    CAState = "STOP1";
  else if (C_state == 9'b100000000)
    CAState = "STOP2";
end
...
always @(N_state)
begin 
  if (N_state == 9'b000000001)
    NAState = "IDLE";
  else if (N_state == 9'b000000010)
    NAState = "RSTART";
  else if (N_state == 9'b000000100)
    NAState = "START";
  else if (N_state == 9'b000001000)
    NAState = "DATASHFT";
  else if (N_state == 9'b000010000)
    NAState = "ACK";
  else if (N_state == 9'b000100000)
    NAState = "ACKIDLE";
  else if (N_state == 9'b001000000)
    NAState = "STOP";
  else if (N_state == 9'b010000000)
    NAState = "STOP1";
  else if (N_state == 9'b100000000)
    NAState = "STOP2";
end
