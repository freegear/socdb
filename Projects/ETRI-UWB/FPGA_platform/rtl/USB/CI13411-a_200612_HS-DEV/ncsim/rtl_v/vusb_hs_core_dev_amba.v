...
-- Input file was: vusb_hs_core_dev_amba.vhdl
-- Date Created: Thu Dec 21 22:43:47 2006
...
// ------------------------------------------------------------------------------
//  File          : $HeadURL: file:///ci/svn/USBCTRL/HSCTRL/tags/HSCTRL_1.1.A/digital/design/hsctrl/rtl_vhdl/vusb_hs_core_dev_amba.vhdl $                                
...
//  $Revision: 339 $                                                                   
module vusb_hs_core_dev_amba (clk,
   rst,
   aux_clk,
   xcvr_clk,
   xcvr_ser_clk,
...
// -------------------------------------------------------------------
assign s_haddr_i = s_haddr; 
assign s_htrans_i = s_htrans; 
assign s_hwrite_i = s_hwrite; 
assign s_hsize_i = s_hsize; 
assign s_hwdata_i = s_hwdata; 
assign s_hsel_i = s_hsel; 
assign s_hready_in_i = s_hready_in; 
...
// -------------------------------------------------------------------
vusb_hs_up_int_amba #(0,1,VUSB_HS_DEV_EP_TX,VUSB_HS_DEV_EP_RX) U_up_int (.clk(clk_i),
...
// -------------------------------------------------------------------
vusb_hs_dma_dev_amba #(VUSB_HS_DEV_EP_TX,VUSB_HS_DEV_EP_ADD_TX,VUSB_HS_DEV_EP_RX,VUSB_HS_DEV_EP_ADD_RX) U_dma (.clk(clk_i),
          //  do not change to clk!
          .rst_local(rst_local),
          .rst_local_a(rst_local_a),
          .m_haddr(m_haddr),
...
endmodule // module vusb_hs_core_dev_amba
