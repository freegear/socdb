...
#define TLEN512        512 
#define NFDATA_ADDR     NAND_BASEADDR+0x04
    ...
    for(j=0;j<totalSize;j++)
    {
        ...
        for(i=0;i<8;i++) {
            ...
            if(readData!=compValue){
                ...
                if(compValue==0xff) GPIO_Write(0xdee4);
                else if(compValue==0xffff) GPIO_Write(0xdee3);
                else if(compValue==0xffffffff) GPIO_Write(0xde2);
               	else GPIO_Write(0xdee1);
                while(1);
            }
            data0=data0+i;
            data1=data1+i;
