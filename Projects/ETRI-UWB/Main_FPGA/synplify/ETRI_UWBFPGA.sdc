...
define_attribute          {IDEAD} xc_loc {F28}
...
define_attribute          {HWRITE_M0} xc_loc {C14}
...
### DDR Probe Signal ### 2007-7-3 added
#define_attribute          {AWID_DDR[0]} xc_loc {}  
#define_attribute          {AWID_DDR[1]} xc_loc {}  
define_attribute          {AWADDR_DDR[0]} xc_loc {Y9}     #NET "FPGA_CON<132>" LOC = "Y9";
define_attribute          {AWADDR_DDR[1]} xc_loc {AA10}     #NET "FPGA_CON<133>" LOC = "AA10";
define_attribute          {AWADDR_DDR[2]} xc_loc {W5}     #NET "FPGA_CON<134>" LOC = "W5";
define_attribute          {AWADDR_DDR[3]} xc_loc {W6}     #NET "FPGA_CON<135>" LOC = "W6";
define_attribute          {AWADDR_DDR[4]} xc_loc {W9}     #NET "FPGA_CON<136>" LOC = "W9";
define_attribute          {AWADDR_DDR[5]} xc_loc {W10}     #NET "FPGA_CON<137>" LOC = "W10";
define_attribute          {AWADDR_DDR[6]} xc_loc {W7}     #NET "FPGA_CON<138>" LOC = "W7";
define_attribute          {AWADDR_DDR[7]} xc_loc {V7}     #NET "FPGA_CON<139>" LOC = "V7";
define_attribute          {AWADDR_DDR[8]} xc_loc {U2}     #NET "FPGA_CON<140>" LOC = "U2";
define_attribute          {AWADDR_DDR[9]} xc_loc {U3}     #NET "FPGA_CON<141>" LOC = "U3";
define_attribute          {AWADDR_DDR[10]} xc_loc {U1}    #NET "FPGA_CON<142>" LOC = "U1";
define_attribute          {AWADDR_DDR[11]} xc_loc {T1}    #NET "FPGA_CON<143>" LOC = "T1";
define_attribute          {AWADDR_DDR[12]} xc_loc {V5}    #NET "FPGA_CON<144>" LOC = "V5";
define_attribute          {AWADDR_DDR[13]} xc_loc {U5}    #NET "FPGA_CON<145>" LOC = "U5";
define_attribute          {AWADDR_DDR[14]} xc_loc {V9}    #NET "FPGA_CON<146>" LOC = "V9";
define_attribute          {AWADDR_DDR[15]} xc_loc {V10}    #NET "FPGA_CON<147>" LOC = "V10";
define_attribute          {AWADDR_DDR[16]} xc_loc {U6}    #NET "FPGA_CON<148>" LOC = "U6";
define_attribute          {AWADDR_DDR[17]} xc_loc {AU27}  #NET "FPGA_CON<445>" LOC = "AU27";
define_attribute          {AWADDR_DDR[18]} xc_loc {T3}    #NET "FPGA_CON<150>" LOC = "T3";
define_attribute          {AWADDR_DDR[19]} xc_loc {T4}    #NET "FPGA_CON<151>" LOC = "T4";
define_attribute          {AWADDR_DDR[20]} xc_loc {R1}    #NET "FPGA_CON<152>" LOC = "R1";
define_attribute          {AWADDR_DDR[21]} xc_loc {R2}    #NET "FPGA_CON<153>" LOC = "R2";
define_attribute          {AWADDR_DDR[22]} xc_loc {T5}    #NET "FPGA_CON<154>" LOC = "T5";
define_attribute          {AWADDR_DDR[23]} xc_loc {T6}    #NET "FPGA_CON<155>" LOC = "T6";
define_attribute          {AWADDR_DDR[24]} xc_loc {R3}    #NET "FPGA_CON<156>" LOC = "R3";
define_attribute          {AWADDR_DDR[25]} xc_loc {R4}    #NET "FPGA_CON<157>" LOC = "R4";
define_attribute          {AWADDR_DDR[26]} xc_loc {T9}    #NET "FPGA_CON<158>" LOC = "T9";
define_attribute          {AWADDR_DDR[27]} xc_loc {U10}    #NET "FPGA_CON<159>" LOC = "U10";
define_attribute          {AWADDR_DDR[28]} xc_loc {L1}    #NET "FPGA_CON<173>" LOC = "L1";
define_attribute          {AWADDR_DDR[29]} xc_loc {N4}    #NET "FPGA_CON<174>" LOC = "N4";
define_attribute          {AWADDR_DDR[30]} xc_loc {K2}    #NET "FPGA_CON<181>" LOC = "K2";
define_attribute          {AWADDR_DDR[31]} xc_loc {M5}    #NET "FPGA_CON<182>" LOC = "M5";
#define_attribute          {AWLEN_DDR[0]} xc_loc {}  
#define_attribute          {AWLEN_DDR[1]} xc_loc {}  
#define_attribute          {AWLEN_DDR[2]} xc_loc {}  
#define_attribute          {AWLEN_DDR[3]} xc_loc {}  
#define_attribute          {AWSIZE_DDR[0]} xc_loc {}  
#define_attribute          {AWSIZE_DDR[1]} xc_loc {}  
#define_attribute          {AWSIZE_DDR[2]} xc_loc {}  
#define_attribute          {AWBURST_DDR[0]} xc_loc {}  
#define_attribute          {AWBURST_DDR[1]} xc_loc {}  
define_attribute          {AWVALID_DDR} xc_loc {L5}       #NET "FPGA_CON<183>" LOC = "L5";
define_attribute          {AWREADY_DDR} xc_loc {J1}       #NET "FPGA_CON<184>" LOC = "J1";
#####################################################
#define_attribute          {WID_DDR[0]} xc_loc {}  
#define_attribute          {WID_DDR[1]} xc_loc {}  
#define_attribute          {WID_DDR[2]} xc_loc {}  
define_attribute          {WDATA_DDR[0]} xc_loc {J2}      #NET "FPGA_CON<185>" LOC = "J2";
define_attribute          {WDATA_DDR[1]} xc_loc {H2}      #NET "FPGA_CON<186>" LOC = "H2";
define_attribute          {WDATA_DDR[2]} xc_loc {H3}      #NET "FPGA_CON<187>" LOC = "H3";
define_attribute          {WDATA_DDR[3]} xc_loc {K3}      #NET "FPGA_CON<188>" LOC = "K3";
define_attribute          {WDATA_DDR[4]} xc_loc {K4}      #NET "FPGA_CON<189>" LOC = "K4";
define_attribute          {WDATA_DDR[5]} xc_loc {J4}      #NET "FPGA_CON<190>" LOC = "J4";
define_attribute          {WDATA_DDR[6]} xc_loc {H4}      #NET "FPGA_CON<191>" LOC = "H4";
define_attribute          {WDATA_DDR[7]} xc_loc {AF3}      #NET "FPGA_CON<192>" LOC = "AF3";
define_attribute          {WDATA_DDR[8]} xc_loc {AG3}      #NET "FPGA_CON<193>" LOC = "AG3";
define_attribute          {WDATA_DDR[9]} xc_loc {AE8}      #NET "FPGA_CON<194>" LOC = "AE8";
define_attribute          {WDATA_DDR[10]} xc_loc {AE9}     #NET "FPGA_CON<195>" LOC = "AE9";
define_attribute          {WDATA_DDR[11]} xc_loc {AG1}     #NET "FPGA_CON<196>" LOC = "AG1";
define_attribute          {WDATA_DDR[12]} xc_loc {AG2}     #NET "FPGA_CON<197>" LOC = "AG2";
define_attribute          {WDATA_DDR[13]} xc_loc {AF5}     #NET "FPGA_CON<198>" LOC = "AF5";
define_attribute          {WDATA_DDR[14]} xc_loc {AF6}     #NET "FPGA_CON<199>" LOC = "AF6";
define_attribute          {WDATA_DDR[15]} xc_loc {AJ2}     #NET "FPGA_CON<313>" LOC = "AJ2";
define_attribute          {WDATA_DDR[16]} xc_loc {AG6}     #NET "FPGA_CON<314>" LOC = "AG6";
define_attribute          {WDATA_DDR[17]} xc_loc {AG7}     #NET "FPGA_CON<315>" LOC = "AG7";
define_attribute          {WDATA_DDR[18]} xc_loc {AH2}     #NET "FPGA_CON<316>" LOC = "AH2";
define_attribute          {WDATA_DDR[19]} xc_loc {AH3}     #NET "FPGA_CON<317>" LOC = "AH3";
define_attribute          {WDATA_DDR[20]} xc_loc {AG5}     #NET "FPGA_CON<318>" LOC = "AG5";
define_attribute          {WDATA_DDR[21]} xc_loc {AH5}     #NET "FPGA_CON<319>" LOC = "AH5";
define_attribute          {WDATA_DDR[22]} xc_loc {AW10}     #NET "FPGA_CON<320>" LOC = "AW10";
define_attribute          {WDATA_DDR[23]} xc_loc {AW11}     #NET "FPGA_CON<321>" LOC = "AW11";
define_attribute          {WDATA_DDR[24]} xc_loc {AV14}     #NET "FPGA_CON<322>" LOC = "AV14";
define_attribute          {WDATA_DDR[25]} xc_loc {AW14}     #NET "FPGA_CON<323>" LOC = "AW14";
define_attribute          {WDATA_DDR[26]} xc_loc {AU10}     #NET "FPGA_CON<324>" LOC = "AU10";
define_attribute          {WDATA_DDR[27]} xc_loc {AV10}     #NET "FPGA_CON<325>" LOC = "AV10";
define_attribute          {WDATA_DDR[28]} xc_loc {AR13}     #NET "FPGA_CON<326>" LOC = "AR13";
define_attribute          {WDATA_DDR[29]} xc_loc {AT13}     #NET "FPGA_CON<327>" LOC = "AT13";
define_attribute          {WDATA_DDR[30]} xc_loc {AR11}     #NET "FPGA_CON<328>" LOC = "AR11";
define_attribute          {WDATA_DDR[31]} xc_loc {AT11}     #NET "FPGA_CON<329>" LOC = "AT11";
#define_attribute          {WSTRB_DDR[0]} xc_loc {}  
#define_attribute          {WSTRB_DDR[1]} xc_loc {}  
#define_attribute          {WSTRB_DDR[2]} xc_loc {}  
#define_attribute          {WSTRB_DDR[3]} xc_loc {}  
#define_attribute          {WLAST_DDR} xc_loc {}  
define_attribute          {WVALID_DDR} xc_loc {AR29}        #NET "FPGA_CON<443>" LOC = "AR29";
define_attribute          {WREADY_DDR} xc_loc {AU26}        #NET "FPGA_CON<444>" LOC = "AU26";
#####################################################

########### not Used pin ############
#   NET "FPGA_CON<149>" LOC = "U7"; # ERROR PIN
#	NET "FPGA_CON<446>" LOC = "AT28";
#   NET "FPGA_CON<447>" LOC = "AR28";
#####################################
#
# I/O standards
#
