...
/*
// i) 이상하다. -> 연산자의 우선 순위가 있나벼...
wire [8:0] RGammaOutAx = (RGammaLUT[RGammaIn[7:4]]) + ((RGammaLUT[RGammaIn[7:4]+1] - (RGammaLUT[RGammaIn[7:4]]))*RGammaIn[3:0])>>4;
wire [8:0] GGammaOutAx = (GGammaLUT[RGammaIn[7:4]]) + ((GGammaLUT[RGammaIn[7:4]+1] - (GGammaLUT[RGammaIn[7:4]]))*GGammaIn[3:0])>>4;
wire [8:0] BGammaOutAx = (BGammaLUT[RGammaIn[7:4]]) + ((BGammaLUT[RGammaIn[7:4]+1] - (BGammaLUT[RGammaIn[7:4]]))*BGammaIn[3:0])>>4;

//						Always Greater
wire [7:0] debug1 = RGammaLUT[RGammaIn[7:4]+1] - RGammaLUT[RGammaIn[7:4]];
wire [7:0] debug2 = RGammaLUT[RGammaIn[3:0]];
wire [7:0] debug0 = RGammaLUT[RGammaIn[7:4]];
wire [7:0] debug3 = (RGammaLUT[RGammaIn[7:4]+1] - (RGammaLUT[RGammaIn[7:4]]))*RGammaIn[3:0];
wire [7:0] debug4 = ((RGammaLUT[RGammaIn[7:4]+1] - (RGammaLUT[RGammaIn[7:4]]))*RGammaIn[3:0])>>4;
*/
...
// iii) 이것만 되네..^^
wire [7:0] RAx0 = RGammaLUT[RGammaIn[7:4]];
wire [7:0] GAx0 = GGammaLUT[GGammaIn[7:4]];
wire [7:0] BAx0 = BGammaLUT[BGammaIn[7:4]];

wire [7:0] RAx1 = GammaEn ? (((RGammaLUT[RGammaIn[7:4]+1] - (RGammaLUT[RGammaIn[7:4]]))*RGammaIn[3:0])>>4) : 0;
wire [7:0] GAx1 = GammaEn ? (((GGammaLUT[GGammaIn[7:4]+1] - (GGammaLUT[GGammaIn[7:4]]))*GGammaIn[3:0])>>4) : 0;
wire [7:0] BAx1 = GammaEn ? (((BGammaLUT[BGammaIn[7:4]+1] - (BGammaLUT[BGammaIn[7:4]]))*BGammaIn[3:0])>>4) : 0;

wire [8:0] RGammaOutAx = GammaEn ? (RAx0 + RAx1) : 0;
wire [8:0] GGammaOutAx = GammaEn ? (GAx0 + GAx1) : 0;
wire [8:0] BGammaOutAx = GammaEn ? (BAx0 + BAx1) : 0;
