...
output			COEN; 	// Command Output Enable #
...
assign	SD_DQSI0_X  = TestMode ? ACLK : Dly0Sel[0] ? SD_DQSI0_BUF_F  : SD_DQSI0_DLY_C;
assign	nSD_DQSI0_X = TestMode ? ACLK : Dly0Sel[0] ? nSD_DQSI0_BUF_F : nSD_DQSI0_DLY_C;
assign	SD_DQSI1_X  = TestMode ? ACLK : Dly1Sel[0] ? SD_DQSI1_BUF_F  : SD_DQSI1_DLY_C;
assign	nSD_DQSI1_X = TestMode ? ACLK : Dly1Sel[0] ? nSD_DQSI1_BUF_F : nSD_DQSI1_DLY_C;
...
BUFX2 DQSI0BUF_X  ( .A(SD_DQSI0_X),  .Y(SD_DQSI0_Y) );
BUFX2 DQSI1BUF_X  ( .A(SD_DQSI1_X),  .Y(SD_DQSI1_Y) );
BUFX2 nDQSI0BUF_X ( .A(nSD_DQSI0_X), .Y(nSD_DQSI0_Y) );
BUFX2 nDQSI1BUF_X ( .A(nSD_DQSI1_X), .Y(nSD_DQSI1_Y) );
