...
add wave -noupdate -color Gold -format Literal -itemcolor Gold /Tb_NFTop/uNFTop/uNFAPBIF/TransSize
add wave -noupdate -color {Slate Blue} -format Logic -itemcolor {Slate Blue} /Tb_NFTop/uNFTop/uNFAPBIF/APBWriteEn
add wave -noupdate -color Magenta -format Logic -itemcolor Magenta -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/FIFOWrEn
add wave -noupdate -color Magenta -format Literal -itemcolor Magenta /Tb_NFTop/uNFTop/uNFAPBIF/FIFOWrCnt
add wave -noupdate -color {Slate Blue} -format Literal -itemcolor {Slate Blue} -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/FIFOWrData
...
add wave -noupdate -color Magenta -format Literal -itemcolor Magenta -radix hexadecimal /Tb_NFTop/uNFTop/EXT_SFR_DIN
add wave -noupdate -color Magenta -format Literal -itemcolor Magenta -radix hexadecimal /Tb_NFTop/uNFTop/EXT_SFR_DOUT
add wave -noupdate -color Magenta -format Literal -itemcolor Magenta -radix hexadecimal /Tb_NFTop/uNFTop/EXT_SFR_ADDR
add wave -noupdate -color Magenta -format Logic -itemcolor Magenta -radix hexadecimal /Tb_NFTop/uNFTop/EXT_SFR_WR
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/uNFAPBIF/WRDDly
add wave -noupdate -divider {New Divider}
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/uNFAPBIF/We
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/uNFAPBIF/Oe
add wave -noupdate -format Literal -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/WDATA
add wave -noupdate -format Literal -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/RDATA
add wave -noupdate -format Literal -radix hexadecimal /Tb_NFTop/data_read/rdata
add wave -noupdate -divider {New Divider}
add wave -noupdate -format Literal -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/uNFDFIFO/DFIFO0
add wave -noupdate -format Literal -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/uNFDFIFO/DFIFO1
...
add wave -noupdate -divider {New Divider}
add wave -noupdate -color Magenta -format Logic -itemcolor Magenta -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/FIFORdDataEnIn
add wave -noupdate -color Magenta -format Literal -itemcolor Magenta -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/FIFORdData
add wave -noupdate -color Gold -format Literal -itemcolor Gold -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/uNFDFIFO/FIFORdDataOut
add wave -noupdate -color Gold -format Logic -itemcolor Gold -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/FIFORdEn
add wave -noupdate -color Gold -format Literal -itemcolor Gold -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/FIFOData
add wave -noupdate -color Gold -format Logic -itemcolor Gold /Tb_NFTop/uNFTop/uNFAPBIF/APBReadEn
add wave -noupdate -color Gold -format Literal -itemcolor Gold /Tb_NFTop/uNFTop/uNFAPBIF/FIFORdCnt
add wave -noupdate -divider {New Divider}
add wave -noupdate -format Literal -radix hexadecimal /Tb_NFTop/write_data/byte1
add wave -noupdate -format Literal -radix hexadecimal /Tb_NFTop/write_data/byte2
add wave -noupdate -divider {New Divider}
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/nNFCE0
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/nNFCE1
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/nNFCE2
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/nNFCE3
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/RnB0
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/RnB1
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/RnB2
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/RnB3
add wave -noupdate -divider {New Divider}
...
add wave -noupdate -format Literal -itemcolor Gold /Tb_NFTop/uNFTop/uNFAPBIF/FIFOWrCnt
...
add wave -noupdate -divider {First OPER}
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/uNFCtrl/ChipSel
...
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/uNFAPBIF/uNFDFIFO/FIFOFullOut
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/uNFAPBIF/uNFDFIFO/FIFOHalfFullOut
add wave -noupdate -format Logic -itemcolor Gold -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/FIFOWrEn
add wave -noupdate -format Literal -itemcolor Gold /Tb_NFTop/uNFTop/uNFAPBIF/FIFOWrCnt
add wave -noupdate -format Literal -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/uNFDFIFO/DFIFO0
add wave -noupdate -format Literal -radix hexadecimal /Tb_NFTop/uNFTop/uNFAPBIF/uNFDFIFO/DFIFO1
add wave -noupdate -divider {New Divider}
...
add wave -noupdate -divider {New Divider}
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/uNFAPBIF/FIFOWrCollect
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/uNFAPBIF/FIFOWrCnt
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/uNFAPBIF/TransSize
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/uNFAPBIF/FIFOData
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/uNFAPBIF/FIFORdCnt
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/uNFAPBIF/uNFDFIFO/DFIFO0
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/uNFAPBIF/uNFDFIFO/DFIFO1
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/nNFCE2
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/nNFCE0
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/nNFCE1
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/nNFCE3
...
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/uNFAPBIF/We
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/uNFAPBIF/Oe
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/uNFAPBIF/WDATA
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/uNFAPBIF/RDATA
add wave -noupdate -format Literal /Tb_NFTop/data_read/rdata
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/EXT_SFR_DIN
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/EXT_SFR_DOUT
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/EXT_SFR_ADDR
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/EXT_SFR_WR
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/uNFAPBIF/WRDDly
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {88130000 ps} 0} {{Cursor 2} {2758579880 ps} 0} {{Cursor 3} {1088520710 ps} 0} {{Cursor 4} {129480 ps} 0}
...
update
WaveRestoreZoom {0 ps} {896820 ps}
