...
module RF2SH8x32_on (
   ...
   assign re_flagB0 = !(_CENB || _WENB[0]);
   assign re_flagB1 = !(_CENB || _WENB[1]);
   assign re_flagB2 = !(_CENB || _WENB[2]);
   assign re_flagB3 = !(_CENB || _WENB[3]);
...
`ifdef TIMING
   specify
      ...
      $setuphold(posedge CLKB &&& re_flagB0, negedge DB[0],1.000, 0.500, NOT_DB0);
      $setuphold(posedge CLKB &&& re_flagB0, posedge DB[1],1.000, 0.500, NOT_DB1);
      $setuphold(posedge CLKB &&& re_flagB0, negedge DB[1],1.000, 0.500, NOT_DB1);
      $setuphold(posedge CLKB &&& re_flagB0, posedge DB[2],1.000, 0.500, NOT_DB2);
      $setuphold(posedge CLKB &&& re_flagB0, negedge DB[2],1.000, 0.500, NOT_DB2);
      $setuphold(posedge CLKB &&& re_flagB0, posedge DB[3],1.000, 0.500, NOT_DB3);
      $setuphold(posedge CLKB &&& re_flagB0, negedge DB[3],1.000, 0.500, NOT_DB3);
      $setuphold(posedge CLKB &&& re_flagB0, posedge DB[4],1.000, 0.500, NOT_DB4);
      $setuphold(posedge CLKB &&& re_flagB0, negedge DB[4],1.000, 0.500, NOT_DB4);
      $setuphold(posedge CLKB &&& re_flagB0, posedge DB[5],1.000, 0.500, NOT_DB5);
      $setuphold(posedge CLKB &&& re_flagB0, negedge DB[5],1.000, 0.500, NOT_DB5);
      $setuphold(posedge CLKB &&& re_flagB0, posedge DB[6],1.000, 0.500, NOT_DB6);
      $setuphold(posedge CLKB &&& re_flagB0, negedge DB[6],1.000, 0.500, NOT_DB6);
      $setuphold(posedge CLKB &&& re_flagB0, posedge DB[7],1.000, 0.500, NOT_DB7);
      $setuphold(posedge CLKB &&& re_flagB0, negedge DB[7],1.000, 0.500, NOT_DB7);
      $setuphold(posedge CLKB &&& re_flagB1, posedge DB[8],1.000, 0.500, NOT_DB8);
      $setuphold(posedge CLKB &&& re_flagB1, negedge DB[8],1.000, 0.500, NOT_DB8);
      $setuphold(posedge CLKB &&& re_flagB1, posedge DB[9],1.000, 0.500, NOT_DB9);
      $setuphold(posedge CLKB &&& re_flagB1, negedge DB[9],1.000, 0.500, NOT_DB9);
      $setuphold(posedge CLKB &&& re_flagB1, posedge DB[10],1.000, 0.500, NOT_DB10);
      $setuphold(posedge CLKB &&& re_flagB1, negedge DB[10],1.000, 0.500, NOT_DB10);
      $setuphold(posedge CLKB &&& re_flagB1, posedge DB[11],1.000, 0.500, NOT_DB11);
      $setuphold(posedge CLKB &&& re_flagB1, negedge DB[11],1.000, 0.500, NOT_DB11);
      $setuphold(posedge CLKB &&& re_flagB1, posedge DB[12],1.000, 0.500, NOT_DB12);
      $setuphold(posedge CLKB &&& re_flagB1, negedge DB[12],1.000, 0.500, NOT_DB12);
      $setuphold(posedge CLKB &&& re_flagB1, posedge DB[13],1.000, 0.500, NOT_DB13);
      $setuphold(posedge CLKB &&& re_flagB1, negedge DB[13],1.000, 0.500, NOT_DB13);
      $setuphold(posedge CLKB &&& re_flagB1, posedge DB[14],1.000, 0.500, NOT_DB14);
      $setuphold(posedge CLKB &&& re_flagB1, negedge DB[14],1.000, 0.500, NOT_DB14);
      $setuphold(posedge CLKB &&& re_flagB1, posedge DB[15],1.000, 0.500, NOT_DB15);
      $setuphold(posedge CLKB &&& re_flagB1, negedge DB[15],1.000, 0.500, NOT_DB15);
      $setuphold(posedge CLKB &&& re_flagB2, posedge DB[16],1.000, 0.500, NOT_DB16);
      $setuphold(posedge CLKB &&& re_flagB2, negedge DB[16],1.000, 0.500, NOT_DB16);
      $setuphold(posedge CLKB &&& re_flagB2, posedge DB[17],1.000, 0.500, NOT_DB17);
      $setuphold(posedge CLKB &&& re_flagB2, negedge DB[17],1.000, 0.500, NOT_DB17);
      $setuphold(posedge CLKB &&& re_flagB2, posedge DB[18],1.000, 0.500, NOT_DB18);
      $setuphold(posedge CLKB &&& re_flagB2, negedge DB[18],1.000, 0.500, NOT_DB18);
      $setuphold(posedge CLKB &&& re_flagB2, posedge DB[19],1.000, 0.500, NOT_DB19);
      $setuphold(posedge CLKB &&& re_flagB2, negedge DB[19],1.000, 0.500, NOT_DB19);
      $setuphold(posedge CLKB &&& re_flagB2, posedge DB[20],1.000, 0.500, NOT_DB20);
      $setuphold(posedge CLKB &&& re_flagB2, negedge DB[20],1.000, 0.500, NOT_DB20);
      $setuphold(posedge CLKB &&& re_flagB2, posedge DB[21],1.000, 0.500, NOT_DB21);
      $setuphold(posedge CLKB &&& re_flagB2, negedge DB[21],1.000, 0.500, NOT_DB21);
      $setuphold(posedge CLKB &&& re_flagB2, posedge DB[22],1.000, 0.500, NOT_DB22);
      $setuphold(posedge CLKB &&& re_flagB2, negedge DB[22],1.000, 0.500, NOT_DB22);
      $setuphold(posedge CLKB &&& re_flagB2, posedge DB[23],1.000, 0.500, NOT_DB23);
      $setuphold(posedge CLKB &&& re_flagB2, negedge DB[23],1.000, 0.500, NOT_DB23);
      $setuphold(posedge CLKB &&& re_flagB3, posedge DB[24],1.000, 0.500, NOT_DB24);
      $setuphold(posedge CLKB &&& re_flagB3, negedge DB[24],1.000, 0.500, NOT_DB24);
      $setuphold(posedge CLKB &&& re_flagB3, posedge DB[25],1.000, 0.500, NOT_DB25);
      $setuphold(posedge CLKB &&& re_flagB3, negedge DB[25],1.000, 0.500, NOT_DB25);
      $setuphold(posedge CLKB &&& re_flagB3, posedge DB[26],1.000, 0.500, NOT_DB26);
      $setuphold(posedge CLKB &&& re_flagB3, negedge DB[26],1.000, 0.500, NOT_DB26);
      $setuphold(posedge CLKB &&& re_flagB3, posedge DB[27],1.000, 0.500, NOT_DB27);
      $setuphold(posedge CLKB &&& re_flagB3, negedge DB[27],1.000, 0.500, NOT_DB27);
      $setuphold(posedge CLKB &&& re_flagB3, posedge DB[28],1.000, 0.500, NOT_DB28);
      $setuphold(posedge CLKB &&& re_flagB3, negedge DB[28],1.000, 0.500, NOT_DB28);
      $setuphold(posedge CLKB &&& re_flagB3, posedge DB[29],1.000, 0.500, NOT_DB29);
      $setuphold(posedge CLKB &&& re_flagB3, negedge DB[29],1.000, 0.500, NOT_DB29);
      $setuphold(posedge CLKB &&& re_flagB3, posedge DB[30],1.000, 0.500, NOT_DB30);
      $setuphold(posedge CLKB &&& re_flagB3, negedge DB[30],1.000, 0.500, NOT_DB30);
      $setuphold(posedge CLKB &&& re_flagB3, posedge DB[31],1.000, 0.500, NOT_DB31);
      $setuphold(posedge CLKB &&& re_flagB3, negedge DB[31],1.000, 0.500, NOT_DB31);
