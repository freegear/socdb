...
//=======================================================================================
// "BLK_BIT" is width of bits for blk address in a chip, 4096 blocks,12 bits
...
//---------------------------------------------------------------------------------------
`define CHP_BIT           27      // width of bits for whole chip address
`define ADD_BIT           26      // width of bits for the required input address
//---------------------------------------------------------------------------------------
`define BLK_BIT           12      // width of bits for block address
...
//---------------------------------------------------------------------------------------
`define BLK_IN_MEMORY     4096    // number of blocks in whole memory
...
//---------------------------------------------------------------------------------------
`define ADD_CYCLES        4       // number of addr cycles is required to input
//---------------------------------------------------------------------------------------