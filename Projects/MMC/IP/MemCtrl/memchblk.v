...
assign RAM0_0_CEN = (CpuRAM_Sel0)?  (CpuRAM_Addr[1:0] == 2'b00) : 
					(NandRAM0_Sel0)? (NandRAM_Addr0[1:0] == 2'b00):
					(NandRAM1_Sel0)? (NandRAM_Addr1[1:0] == 2'b00): RAM_SEL0 & ~MMC_CEn0;

assign RAM0_1_CEN = (CpuRAM_Sel0)?  (CpuRAM_Addr[1:0] == 2'b01) : 
					(NandRAM0_Sel0)? (NandRAM_Addr0[1:0] == 2'b01):
					(NandRAM1_Sel0)? (NandRAM_Addr1[1:0] == 2'b01): RAM_SEL0 & ~MMC_CEn1;

assign RAM0_2_CEN = (CpuRAM_Sel0)?  (CpuRAM_Addr[1:0] == 2'b10) : 
					(NandRAM0_Sel0)? (NandRAM_Addr0[1:0] == 2'b10):
					(NandRAM1_Sel0)? (NandRAM_Addr1[1:0] == 2'b10): RAM_SEL0 & ~MMC_CEn2;

assign RAM0_3_CEN = (CpuRAM_Sel0)?  (CpuRAM_Addr[1:0] == 2'b11) : 
					(NandRAM0_Sel0)? (NandRAM_Addr0[1:0] == 2'b11): 
					(NandRAM1_Sel0)? (NandRAM_Addr1[1:0] == 2'b11): RAM_SEL0 & ~MMC_CEn3;

assign RAM1_0_CEN = (CpuRAM_Sel1)?  (CpuRAM_Addr[1:0] == 2'b00) : 
					(NandRAM0_Sel1)? (NandRAM_Addr0[1:0] == 2'b00):
					(NandRAM1_Sel1)? (NandRAM_Addr1[1:0] == 2'b00): RAM_SEL1 & ~MMC_CEn0;

assign RAM1_1_CEN = (CpuRAM_Sel1)?  (CpuRAM_Addr[1:0] == 2'b01) : 
					(NandRAM0_Sel1)? (NandRAM_Addr0[1:0] == 2'b01): 
					(NandRAM1_Sel1)? (NandRAM_Addr1[1:0] == 2'b01): RAM_SEL1 & ~MMC_CEn1;

assign RAM1_2_CEN = (CpuRAM_Sel1)?  (CpuRAM_Addr[1:0] == 2'b10) : 
					(NandRAM0_Sel1)? (NandRAM_Addr0[1:0] == 2'b10):
					(NandRAM1_Sel1)? (NandRAM_Addr1[1:0] == 2'b10): RAM_SEL1 & ~MMC_CEn2;

assign RAM1_3_CEN = (CpuRAM_Sel1)?  (CpuRAM_Addr[1:0] == 2'b11) : 
					(NandRAM0_Sel1)? (NandRAM_Addr0[1:0] == 2'b11):
					(NandRAM1_Sel1)? (NandRAM_Addr1[1:0] == 2'b11): RAM_SEL1 & ~MMC_CEn3;
...
assign RAM0_WEN = 	(CpuRAM_Sel0)? 	~Cpu_Wen :
					(NandRAM0_Sel0)?~NandRAM_Wen0:
					(NandRAM1_Sel0)?~NandRAM_Wen1: RAM_SEL0 & ~MMC_Wen ;

assign RAM1_WEN =	(CpuRAM_Sel1)? 	~Cpu_Wen : 
					(NandRAM0_Sel1)?~NandRAM_Wen0: 
					(NandRAM1_Sel1)?~NandRAM_Wen1: RAM_SEL1 & ~MMC_Wen ;
...
assign RAM2_ADDR = (NandRAM0_Sel2)? NandRAM_Addr0 :
					(NandRAM1_Sel2)? NandRAM_Addr1 : CpuRAM_Addr[10:0];
assign RAM3_ADDR = (NandRAM0_Sel3)? NandRAM_Addr0 :
					(NandRAM1_Sel3)? NandRAM_Addr1 : CpuRAM_Addr[10:0];
assign RAM4_ADDR = (NandRAM0_Sel4)? NandRAM_Addr0 : 
					(NandRAM1_Sel4)? NandRAM_Addr1 : CpuRAM_Addr[10:0];
assign RAM5_ADDR = (NandRAM0_Sel5)? NandRAM_Addr0 :
...
//wire			RAM_Sel4;
//wire			RAM_Sel5;
//assign RAM_Sel2 =	(CpuRAM_Sel2)|(NandRAM0_Sel2)|(NandRAM1_Sel2);
//assign RAM_Sel3 =	(CpuRAM_Sel3)|(NandRAM0_Sel3)|(NandRAM1_Sel3);
//assign RAM_Sel4 =	(CpuRAM_Sel4)|(NandRAM0_Sel4)|(NandRAM1_Sel4);
//assign RAM_Sel5 =	(CpuRAM_Sel5)|(NandRAM0_Sel5)|(NandRAM1_Sel5);
...
assign RAM2_DATAi =	(NandRAM0_Sel2)? NandRAM0_DATAi:
					(NandRAM1_Sel2)? NandRAM1_DATAi: CpuRAM_DATAi[7:0];
assign RAM3_DATAi =	(NandRAM0_Sel3)? NandRAM0_DATAi:
					(NandRAM1_Sel3)? NandRAM1_DATAi: CpuRAM_DATAi[7:0];
assign RAM4_DATAi =	(NandRAM0_Sel4)? NandRAM0_DATAi:
					(NandRAM1_Sel4)? NandRAM1_DATAi: CpuRAM_DATAi[7:0];
assign RAM5_DATAi =	(NandRAM0_Sel5)? NandRAM0_DATAi:
