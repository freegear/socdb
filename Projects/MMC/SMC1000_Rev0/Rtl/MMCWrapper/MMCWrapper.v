...
assign		ABORT_INT = ~si_abortb; // Abort Interrupt interrupt (edge)


reg	[11:0]	SDDatCnt;
reg	[11:0]	SDDatCntSync1;
reg	[11:0]	SDDatCntSync;
...
mmcwrapper_regif mmcwrapper_regif(
	...
	.SDDatCnt				(SDDatCntSync		)
);


// for monitoring Datcnt
...
begin
	...
	begin
	SDDatCntSync1 <= SDDatCnt;
	SDDatCntSync <= SDDatCntSync1 ;
	end
