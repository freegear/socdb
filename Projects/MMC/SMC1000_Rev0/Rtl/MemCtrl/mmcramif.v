...
reg 	[11:0]	BlkDatCnt;
reg 	[11:0]	TriggerBlkDatCnt;
reg 	[11:0]	NextTriggerBlkDatCnt;
...
always @(MMCRAM_Addr or BlkDatCnt or TransferStart or TransferBlkAddr or TransferSize or MRAMState or si_wrb or si_rdb or TriggerBlkDatCnt)
begin
	NextMMCRAM_Addr= MMCRAM_Addr;
	NextBlkDatCnt = BlkDatCnt;
	NextTriggerBlkDatCnt = TriggerBlkDatCnt;
	if (TransferStart)
	begin
	NextMMCRAM_Addr = TransferBlkAddr;
	NextBlkDatCnt = TransferSize;
	NextTriggerBlkDatCnt = 0; 
	end
//	else if ( (MRAMState==`TRANSFER)&& ((~si_wrb)|(~si_rdb)) )
	...
	NextTriggerBlkDatCnt = TriggerBlkDatCnt +1;
	end
end
...
begin
	...
	TriggerBlkDatCnt <= NextTriggerBlkDatCnt;
	end
end
