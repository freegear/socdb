...
assign	BlkDatCnt0_r		= CS[7];
assign	BlkDatCnt1_r		= CS[8];
...
always @(	NandRAM0_Sel_r or 
			...
			TransferBlkAddr or
			TransferSize or
			MMCRAM_Sel1 or MMCRAM_Sel0 or NandMode or TransferDone or Rdy_sel or BlkDatCnt0_r or 
BlkDatCnt1_r or BlkDatCnt)
begin
	case(1'b1)
	...
	MMCRAMCtrl_r	:EXT_SFR_DIN <= {MMCRAM_Sel1,
									...
									TransferDone,
									1'b0 };
	BlkDatCnt0_r		: EXT_SFR_DIN <= BlkDatCnt[7:0];
	BlkDatCnt1_r		: EXT_SFR_DIN <= {4'b0000,BlkDatCnt[11:8]};
