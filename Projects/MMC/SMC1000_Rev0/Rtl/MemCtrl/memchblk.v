...
reg [1:0] dNandRAM_Addr0;
reg [1:0] dNandRAM_Addr1;
...
begin 
	...
	dNandRAM_Addr1 <= NandRAM_Addr1;
end

assign NandRAM0_DATAo = (NandRAM0_Sel0)? ((dNandRAM_Addr0[1:0]== 2'b00)?RAM0_DATAo[7:0]:
										 (dNandRAM_Addr0[1:0]== 2'b01)?RAM0_DATAo[15:8]:
										 (dNandRAM_Addr0[1:0]== 2'b10)?RAM0_DATAo[23:16]:RAM0_DATAo[31:24]):
						(NandRAM0_Sel1)? ((dNandRAM_Addr0[1:0]== 2'b00)?RAM1_DATAo[7:0]:
										 (dNandRAM_Addr0[1:0]== 2'b01)?RAM1_DATAo[15:8]:
										 (dNandRAM_Addr0[1:0]== 2'b10)?RAM1_DATAo[23:16]:RAM1_DATAo[31:24]):
						(NandRAM0_Sel2)? RAM2_DATAo :
						(NandRAM0_Sel3)? RAM3_DATAo : 
						(NandRAM0_Sel4)? RAM4_DATAo : 
						(NandRAM0_Sel5)? RAM5_DATAo : 8'b00000000 ;

assign NandRAM1_DATAo = (NandRAM1_Sel0)? ((dNandRAM_Addr1[1:0]== 2'b00)?RAM0_DATAo[7:0]:
										 (dNandRAM_Addr1[1:0]== 2'b01)?RAM0_DATAo[15:8]:
										 (dNandRAM_Addr1[1:0]== 2'b10)?RAM0_DATAo[23:16]:RAM0_DATAo[31:24]):
						(NandRAM1_Sel1)? ((dNandRAM_Addr1[1:0]== 2'b00)?RAM1_DATAo[7:0]:
										 (dNandRAM_Addr1[1:0]== 2'b01)?RAM1_DATAo[15:8]:
										 (dNandRAM_Addr1[1:0]== 2'b10)?RAM1_DATAo[23:16]:RAM1_DATAo[31:24]):
