...
wire	NFOPER0_adr 	= CS[0];//(EXT_SFR_ADDR== 4'h0);
wire	NFOPER1_adr 	= CS[1];//(EXT_SFR_ADDR== 4'h1);
wire	NFOPER2_adr 	= CS[2];//(EXT_SFR_ADDR== 4'h2);
wire	NFOPER3_adr 	= CS[3];//(EXT_SFR_ADDR== 4'h3);
wire 	NFCONF0_adr 	= CS[4];//(EXT_SFR_ADDR==4'h5);
wire 	NFCONF1_adr 	= CS[5];//(EXT_SFR_ADDR==4'h6);
wire 	NFCONF2_adr 	= CS[6];//(EXT_SFR_ADDR==4'h7);
wire 	NFCTRL0_adr 	= CS[7];//(EXT_SFR_ADDR==4'h8);
wire 	NFCTRL1_adr 	= CS[8];//(EXT_SFR_ADDR==4'h9);
wire 	NFSTAT0_adr 	= CS[9];//(EXT_SFR_ADDR==4'hA);
wire 	NFSTAT1_adr 	= CS[10];//(EXT_SFR_ADDR==4'hB);
wire 	NFSTAT2_adr 	= CS[11];//(EXT_SFR_ADDR==4'hC);
wire 	NFSTAT3_adr 	= CS[12];//(EXT_SFR_ADDR==4'hD);
wire 	NFFIFOSTAT0_adr = CS[13];//(EXT_SFR_ADDR==4'hE);
wire 	NFFIFOSTAT1_adr = CS[14];//(EXT_SFR_ADDR==4'hF);
