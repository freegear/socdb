...
///////////////////////////////////////////////////////// 
*/
extern smtUint8 ml_buffer[FTL_PAGE_MAXSIZE]; 
...
)
{
	...
	ret = FTL_O_LowInit(); 
	if(ret == SMT_FALSE) {
		SMT_FTL_DPRINTF("FTL_LowInit fail!!!\n");
		return SMT_FALSE;
	}
	...
	ret = FTL_O_Format();
	if(ret == SMT_FALSE) {
		SMT_FTL_DPRINTF("FTL_O_Format fail!!!\n");
		return SMT_FALSE;
	}
...
)
{
	...
	ret = FTL_O_LowInit();
	if(ret == SMT_FALSE) {
		SMT_FTL_DPRINTF("FTL_O_LowInit fail!!!\n");
		return SMT_FALSE;
	}

	ret = FTL_O_Init();
	if(ret == SMT_FALSE){
		SMT_FTL_DPRINTF("FTL_O_Init fail!!!\n");
		return SMT_FALSE;
	}

	ret = FTL_O_BuildMap();
	if(ret == SMT_FALSE){
		SMT_FTL_DPRINTF("FTL_O_BuildMap fail!!!\n");
		return SMT_FALSE;
	}

	ret = FTL_O_BuildLog();
	if(ret == SMT_FALSE){
		SMT_FTL_DPRINTF("FTL_O_BuildLog fail!!!\n");
		return SMT_FALSE;
	}
...
{
	smtUint32 totalSec = FTL_O_GetMaxSector();
