...
typedef struct
{
	...
	smtUint8 	lockedCnt;
	ST_LOG 		*curLog;
	ST_LOG 		logs[MAX_LOG_BLOCK_AVAILABLE];
...
///////////////////////////////////////////////////////// 
*/
extern ST_FRAG 			gFragCache;
extern ST_MAPDIR 		gMapDir[MAX_FRAGNUM_AVAILABLE];

extern unsigned char 	gFlushBuffer[MAX_PAGE_SIZE];
extern unsigned char 	gTempBuffer[MAX_PAGE_SIZE]; 


extern ST_LOG_CACHE		gLogCache;
extern ST_FLUSH_DATA	gFlush;
extern ST_MAP_BLOCKS	gMapBlocks;
/*
/////////////////////////////////////////////////////////
        FUNCTIONS 
///////////////////////////////////////////////////////// 
...
extern smtBoolean 	FTL_C_FindLog		(smtBlkAddr lba);
