...
void DDRTest(void)
{
	...
	smt2UartPrint(11,"[MEM] DDR/SRAM Simple test start!!!\n");
	...
	//--------------------------------------------------------------------------
	smt2UartPrint(11, "[MEM] PHASE 0 : single write => single/burst read\n");
	...
	//smt2UartPrint(11, "[MEM] single write - single read Done!!!\n");
	...
	//smt2UartPrint(11, "[MEM] single write - burst read Done!!!\n");

	//--------------------------------------------------------------------------
	// PHASE 1 : burst write => single/burst read
	// burst write DDR region
	//--------------------------------------------------------------------------
	smt2UartPrint(11, "[MEM] PHASE 1 : burst write => single/burst read\n");
	...
	for(i = 0; i < DDR_TEST_COUNT; i++)
	{
		...
		if(data != DATA1(i))
		{
			...
			smt2UartPrint(11, "[MEM] Error 0x%08x|0x%08x:0x%08x\n",
					i*4, data, expected_data);
			goto error;
		}
	}
	//smt2UartPrint(11, "[MEM] PHASE1 burst write - single read Done!!!\n");
	...
	//smt2UartPrint(11, "[MEM] PHASE1 burst write - burst read Done!!!\n");

	//--------------------------------------------------------------------------
	// PHASE 2 : single write => single/burst read
	// single write
	//--------------------------------------------------------------------------
	smt2UartPrint(11, "[MEM] PHASE 2 : single write => single/burst read\n");
	...
	//smt2UartPrint(11, "[MEM] PHASE2 single write - single read Done!!!\n");
	...
	//smt2UartPrint(11, "[MEM] PHASE2 single write - burst read Done.\n");
	
	//--------------------------------------------------------------------------
	// PHASE 3 : single write => single/burst read(byte)
	// single write(byte)
	//--------------------------------------------------------------------------
	smt2UartPrint(11, "[MEM] PHASE 3 : single write => single/burst read(byte)\n");
	...
	//smt2UartPrint(11, "[MEM] PHASE3 single write - single read Done.\n");
	...
	//smt2UartPrint(11, "[MEM] PHASE3 sing write - burst read Done.\n");

	smt2UartPrint(11,"[MEM] DDR/SRAM Simple test end!!!\n");
	return;

error:
	
	smt2UartPrint(11,"Error(Read %08x when expected %08x)\n", 
		data, expected_data);
	//GPIOWrite(0x5dead);
...
void EthernetReadWriteTest(void)
{
	...
	smt2UartPrint(11,"LAN91C111 Register Read/Write Test...");
	...
	return;
error:
	smt2UartPrint(11,"Error : Read 0x%04x when 0x%04x expected\n", 
		data , data_expected);
	return;
}
/*----------------------------------------------------------
...
void NORTest(void)
{
	...
	return;
error:
	smt2UartPrint(11,"Error(Read %02x when %02x expected)\n", 
		data, expected_data);
	return;
}
