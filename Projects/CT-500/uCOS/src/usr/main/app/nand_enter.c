...
static int IdRead(void)
{
    ...
    id[3] = smtNANDGetData();
    id[4] = smtNANDGetData();	
	smt2UartPrint(11, "[NAND] ID code dectect: 0x%02x, 0x%02x, 0x%02x, 0x%02x\n",
...
void NandTest(void)
{
	...
	smt2UartPrint(11,"[NAND] Simple test start\n");
	...
	//smt2UartPrint(11, "[NAND] Block erase Done!!!\n");
	...
	//smt2UartPrint(11, "[NAND] Program Done!!!\n");
	...
	//smt2UartPrint(11, "[NAND] Read & Verify Done!!!\n");

	smt2UartPrint(11,"[NAND] Simple test Done\n");
...
error:
	...
	{
	case 0: 
		smt2UartPrint(11,"[NAND] Error(ID Read)\n"); 
		break;
		
	case 1: 
		smt2UartPrint(11,"[NAND] Error(Block Erase)\n"); 
		break;
		
	case 2: 
		smt2UartPrint(11,"[NAND] Error(Data Write)\n"); 
		break;
		
	case 3: 
		smt2UartPrint(11,"[NAND] Error(Data Read)\n"); 
		break;
		
	default: 
		smt2UartPrint(11,"[NAND] Error\n"); 
		break;
	}
}
