...
smtUint32 VideoWithGDMATest()
{
	...
	smt2UartPrint(11,"jpeg decoding.......\n");
	JpegDecode(pjpgData, (JPEGBYTE *)VIDEO_SRC0_BASEADDR, &width, &height);
	smt2UartPrint(11, "finished jpeg0 decoding!!\n");

	pjpgData = (smtUint8*)PANORAMA_3;
	smt2UartPrint(11,"jpeg decoding.......\n");
	JpegDecode(pjpgData, (JPEGBYTE *)VIDEO_SRC1_BASEADDR, &width, &height);
	smt2UartPrint(11, "finished jpeg1 decoding!!\n");
	...
	smt2UartPrint(11,"press 'a' or 's' to move right/left\n");
	smt2UartPrint(11,"press 'c' to change screen\n");
	while(1)
	{
