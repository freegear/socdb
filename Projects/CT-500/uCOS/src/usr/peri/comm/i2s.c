...
smtUint32 I2STestTXTransmit(void)
{
	...
	// 1, polling
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S TX TEST]-TRANSMIT polling test!!!\n");
	...
	// 2. DMA
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S TX TEST]-TRANSMIT DMA test!!!\n");
...
smtUint32 I2STestTXBitWidth(void)
{
	...
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S TX TEST]-BITWIDTH I2S 8bits test!!!\n");
	...
	I2SDPRINTF(11, "[I2S TX TEST]-BITWIDTH I2S 16bits test!!!\n");
	...
	//-------------------------------------------------------	
	I2SDPRINTF(11, "[I2S TX TEST]-BITWIDTH I2S 24bits test!!!\n");
	...
	for(tIdx = 0; tIdx <  128*1024/2; tIdx++) 
	{
		...
		smtI2SSetData((sounddata[tIdx]&0xFFFF)<<8);	
		...
		smtI2SSetData(((sounddata[tIdx]>>16)&0xFFFF)<<8);	
	}
	...
	//-------------------------------------------------------		
	I2SDPRINTF(11, "[I2S TX TEST]-BITWIDTH I2S 32bits test!!!\n");
	...
	for(tIdx = 0; tIdx <  128*1024/2; tIdx++) 
	{
		...
		smtI2SSetData((sounddata[tIdx]&0xffff)<<16);	
		...
		smtI2SSetData(((sounddata[tIdx]>>16)&0xffff)<<16);	
...
smtUint32 I2STestTXSampleRate(void)
{
	...
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S TX TEST]-SAMPLERATE 11025Hz test!!!\n");		
	...
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S TX TEST]-SAMPLERATE 22050Hz test!!!\n");
	...
	//	I2S TX 44100Hz, 16bits
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S TX TEST]-SAMPLERATE 44100Hz test!!!\n");
	...
	//-------------------------------------------------------	
	I2SDPRINTF(11, "[I2S TX TEST]-SAMPLERATE 48000Hz test!!!\n");
...
smtUint32 I2STestTXEvent(void)
{
	...
	I2SDPRINTF(11, "[I2S TX TEST]-EVENT underrun status polling test!!!\n");
	...
	//	2. interrupt test
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S TX TEST]-EVENT underrun status interrupt test!!!\n");
...
smtUint32 I2STestRXTransmit(void)
{
	...
	smtGetI2SMode(I2S_DIR_RX, &I2SCtrl);		
	I2SCtrl.DMAIntEn = 0x0;
	smtSetI2SMode(I2S_DIR_RX, &I2SCtrl);		
...
smtUint32 I2STestRXBitWidthTest(void)
{
	...
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S RX TEST]-BITWIDTH I2S 8bits test!!!\n");
	...
	//-------------------------------------------------------	
	I2SDPRINTF(11, "[I2S RX TEST]-BITWIDTH I2S 16bits test!!!\n");
	...
	//-------------------------------------------------------		
	I2SDPRINTF(11, "[I2S RX TEST]-BITWIDTH I2S 24bits test!!!\n");
	...
	//-------------------------------------------------------			
	I2SDPRINTF(11, "[I2S RX TEST]-BITWIDTH I2S 32bits test!!!\n");
...
smtUint32 I2STestRXSampleRateTest(void)
{
	...
	//-------------------------------------------------------		
	I2SDPRINTF(11, "[I2S RX TEST]-SAMPLERATE 11025Hz test!!!\n");		
	...
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S RX TEST]-SAMPLERATE 22050Hz test!!!\n");		
	...
	//-------------------------------------------------------	
	I2SDPRINTF(11, "[I2S RX TEST]-SAMPLERATE 44100Hz test!!!\n");		
...
smtUint32 I2STestRXEvent(void)
{
	...
	//	1. polling test
	//-------------------------------------------------------	
	I2SDPRINTF(11, "[I2S RX TEST]-EVENT overrun status polling test!!!\n");
	...
	//	2. interrupt test
	//-------------------------------------------------------	
	I2SDPRINTF(11, "[I2S RX TEST]-EVENT overrun status interrupt test!!!\n");
...
smtUint32 I2STest(void)
{
	...
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S RX TEST]-TRANSMIT test start !!!\n");
	...
	if(I2STestRet)
	{
		...
		{
		case 1:
			I2SDPRINTF(11, "[I2S RX ERROR]-TRANSMIT polling test fail!!!\n");
			break;
		case 2:
			I2SDPRINTF(11, "[I2S RX ERROR]-TRANSMIT DMA test fail!!!\n");
			break;
		}
		goto I2SError;
	}
	...
	{
		I2SDPRINTF(11, "[I2S RX TEST]-TRANSMIT OK!!!\n");
	}	
	...
	//-------------------------------------------------------	
	I2SDPRINTF(11, "[I2S RX TEST]-EVENT test start !!!\n");
	...
	if(I2STestRet)
	{
		...
		{
		case 1:
			I2SDPRINTF(11, "[I2S RX ERROR]-EVENT overrun polling test fail!!!\n");
			break;
		case 2:
			I2SDPRINTF(11, "[I2S RX ERROR]-EVENT overrun interrupt test fail!!!\n");
			break;
		}		
		goto I2SError;
	}
	...
	{
		I2SDPRINTF(11, "[I2S RX TEST]-EVENT OK!!!\n");
	}
	
	//-------------------------------------------------------
	//	I2S RX test 2 bitwidth test (8/16/24/32)bits
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S RX TEST]-BITWIDTH test start !!!\n");
	...
	{
		I2SDPRINTF(11, "[I2S RX TEST]-BITWIDTH OK!!!\n");
	}
		
	//-------------------------------------------------------
	//	I2S RX test 3 samplerate test (11025/22050/44100/48000)Hz
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S RX TEST]-SAMPLERATE test start !!!\n");
	...
	{
		I2SDPRINTF(11, "[I2S RX TEST]-SAMPLERATE OK!!!\n");
	}

	//-------------------------------------------------------
	//	I2S TX test 0 (CPU/DMA)
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S TX TEST]-TRANSMIT test start !!!\n");
	...
	if(I2STestRet)
	{
		...
		{
		case 1:
			I2SDPRINTF(11, "[I2S TX ERROR]-TRANSMIT polling test fail!!!\n");
			break;
		case 2:
			I2SDPRINTF(11, "[I2S TX ERROR]-TRANSMIT DMA test fail!!!\n");
			break;
		}
		goto I2SError;
	}
	...
	{
		I2SDPRINTF(11, "[I2S TX TEST]-TRANSMIT OK!!!\n");
	}

	//-------------------------------------------------------
	//	I2S TX test 1 (underrun interrupt, polling)
	//-------------------------------------------------------	
	I2SDPRINTF(11, "[I2S TX TEST]-EVENT test start !!!\n");
	...
	if(I2STestRet)
	{
		...
		{
		case 1:
			I2SDPRINTF(11, "[I2S TX ERROR]-EVENT underrun polling test fail!!!\n");
			break;
		case 2:
			I2SDPRINTF(11, "[I2S TX ERROR]-EVENT underrun interrupt test fail!!!\n");
			break;
		}		
		goto I2SError;
	}
	...
	{
		I2SDPRINTF(11, "[I2S TX TEST]-EVENT OK!!!\n");
	}
	
	//-------------------------------------------------------
	//	I2S TX test 2 bitswidth test (8/16/24/32)bits
	//-------------------------------------------------------
	I2SDPRINTF(11, "[I2S TX TEST]-BITWIDTH test start !!!\n");
	...
	if(I2STestRet)
	{
		...
		{
		case 1:
			I2SDPRINTF(11, "[I2S TX ERROR]-BITWIDTH I2S 8bit fail!!!\n");
			break;
		case 2:
			I2SDPRINTF(11, "[I2S TX ERROR]-BITWIDTH I2S 16bit test fail!!!\n");
			break;
		case 3:
			I2SDPRINTF(11, "[I2S TX ERROR]-BITWIDTH I2S 24bit test fail!!!\n");
			break;						
		case 4:
			I2SDPRINTF(11, "[I2S TX ERROR]-BITWIDTH I2S 32bit test fail!!!\n");
			break;			
		}		
		goto I2SError;
	}
	...
	{
		I2SDPRINTF(11, "[I2S TX TEST]-BITWIDTH OK!!!\n");
	}

	//-------------------------------------------------------
	//	I2S TX test 3 sample rate test (11025/22050/44100/48000) Hz
	//-------------------------------------------------------	
	I2SDPRINTF(11, "[I2S TX TEST]-SAMPLERATE test start !!!\n");
	...
	if(I2STestRet)
	{
		...
		{
		case 1:
			I2SDPRINTF(11, "[I2S TX ERROR]-SAMPLERATE I2S 11025 Hz!!!\n");
			break;
		case 2:
			I2SDPRINTF(11, "[I2S TX ERROR]-SAMPLERATE I2S 22050 Hz!!!\n");
			break;
		case 3:
			I2SDPRINTF(11, "[I2S TX ERROR]-SAMPLERATE I2S 44100 Hz!!!\n");
			break;						
		case 4:
			I2SDPRINTF(11, "[I2S TX ERROR]-SAMPLERATE I2S 48000 Hz!!!\n");
			break;			
		}		
		goto I2SError;
	}
	...
	{
		I2SDPRINTF(11, "[I2S TX TEST]-SAMPLERATE OK!!!\n");
	}
...
I2SError:
	I2SDPRINTF(11, "[I2S TX TEST] FAIL!!!\n");
	return 	(!NO_ERROR);
}
