...
void smtNANDSetOPT0(NAND_OPT0 *popt0)
{
	...
	/*
	NANDDPRINTF(11, "smtNANDSetOPT0: 0x%08x\n",
...
void smtNANDSetOPT1(NAND_OPT1 *popt1)
{
	...
	/*
	NANDDPRINTF(11, "smtNANDSetOPT1: 0x%08x\n",
...
{
	/*
	NANDDPRINTF(11, "smtNANDSetOPT2: 0x%08x\n",
...
{
	return (smtUint32)SMT_READ(NANDDATA);
}
...
void smtNANDSetStatus(NAND_STAT *pstatus)
{
	...
	//NANDDPRINTF(11, "smtNANDSetStatus: 0x%08x\n", reg);
