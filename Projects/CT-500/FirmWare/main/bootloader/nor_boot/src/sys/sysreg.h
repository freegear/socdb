...
#define UARTXMASTER(x)		(*(volatile unsigned *)(UART0_BASEADDR+0x00+(0x20*x)))
#define UARTXSTATUS(x)		(*(volatile unsigned *)(UART0_BASEADDR+0x04+(0x20*x)))
#define UARTXBRD(x)			(*(volatile unsigned *)(UART0_BASEADDR+0x08+(0x20*x)))
#define UARTXTXFIFO(x)		(*(volatile unsigned *)(UART0_BASEADDR+0x0C+(0x20*x)))
#define UARTXRXFIFO(x)		(*(volatile unsigned *)(UART0_BASEADDR+0x10+(0x20*x)))
#define UARTXRXTO(x)		(*(volatile unsigned *)(UART0_BASEADDR+0x14+(0x20*x)))
...
#define CPALADDR			(*(volatile unsigned *)(DM_BASEADDR+0x024))
#define CPALM				(*(volatile unsigned *)(DM_BASEADDR+0x028))
...
#define GPALADDR			(*(volatile unsigned *)(DM_BASEADDR+0x054))
#define GPALM				(*(volatile unsigned *)(DM_BASEADDR+0x058))
//Video Plane
...
#define GGAMMAXX(x)			(*(volatile unsigned *)(DM_BASEADDR+0x100+((x)*0x4)))
//Video Gamma
...
#define VGAMMAXX(x)			(*(volatile unsigned *)(DM_BASEADDR+0x200+((x)*0x4)))
/* Video Encoder */
