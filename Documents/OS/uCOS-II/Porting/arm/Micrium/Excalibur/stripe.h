...
#ifndef	STRIPE_H_INCLUDED
#define	STRIPE_H_INCLUDED

#define EXC_DEFINE_PROCESSOR_BIG_ENDIAN
#define EXC_DEFINE_BOOT_FROM_FLASH

#define	EXC_INPUT_CLK_FREQUENCY (38400000)
#define	EXC_AHB1_CLK_FREQUENCY (153600000)
#define	EXC_AHB2_CLK_FREQUENCY (76800000)
#define	EXC_SDRAM_CLK_FREQUENCY (124800000)

/* Registers Block */
#define	EXC_REGISTERS_BASE (0x00100000)
...
#define	EXC_SPSRAM_BLOCK1_BASE (0x04000000)
#define	EXC_SPSRAM_BLOCK1_SIZE (0x00020000)

/* Dual Port SRAM Block(s) */
#define	EXC_DPSRAM_BLOCK0_BASE (0x00020000)
#define	EXC_DPSRAM_BLOCK0_SIZE (0x00010000)
#define	EXC_DPSRAM_BLOCK0_WIDTH (0)
#define	EXC_DPSRAM_BLOCK1_BASE (0x04020000)
#define	EXC_DPSRAM_BLOCK1_SIZE (0x00010000)
#define	EXC_DPSRAM_BLOCK1_WIDTH (0)

/* PLD Block(s) */
#define	EXC_PLD_BLOCK0_BASE (0x08000000)
#define	EXC_PLD_BLOCK0_SIZE (0x08000000)
#define	EXC_PLD_BLOCK0_NON_CACHEABLE
#define	EXC_PLD_BLOCK1_BASE (0x20000000)
#define	EXC_PLD_BLOCK1_SIZE (0x20000000)
#define	EXC_PLD_BLOCK1_NON_CACHEABLE
#define	EXC_PLD_BLOCK2_BASE (0x40000000)
#define	EXC_PLD_BLOCK2_SIZE (0x40000000)
#define	EXC_PLD_BLOCK2_NON_CACHEABLE
#define	EXC_PLD_BLOCK3_BASE (0x80000000)
#define	EXC_PLD_BLOCK3_SIZE (0x40000000)
