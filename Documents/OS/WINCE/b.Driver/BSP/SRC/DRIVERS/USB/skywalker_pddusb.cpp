...
#define SC2410_SIG '2410' // "SC2410" signature

#define IS_VALID_SC2410_CONTEXT(ptr) \
    ( (ptr != NULL) && (ptr->dwSig == SC2410_SIG) )
                ...
                )
{
    ...
    DEBUGCHK(pContext->dwSig == SC2410_SIG);
