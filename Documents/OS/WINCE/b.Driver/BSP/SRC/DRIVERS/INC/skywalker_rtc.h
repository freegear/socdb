...
//------------------------------------------------------------------------------
//
//  Header: skywalker_rtc.h
//
//  Defines the Real Time Clock (RTC) register layout and associated 
//  types and constants.
//
#ifndef __S3C2410X_RTC_H__
#define __S3C2410X_RTC_H__
...
//------------------------------------------------------------------------------
//
//  Type: S3C2410X_RTC_REG    
//
//  RTC control registers. This register bank is located by the constant 
//  S3C2410X_BASE_REG_XX_RTC in the configuration file s3c2410x_base_reg_cfg.h.
//

typedef struct {
    UINT32 PAD1[16];                // pad to - 0x3C
    UINT32 RTCCON;                  // control reg
    UINT32 TICINT;                  // tick time count reg
    UINT32 PAD2[2];                 // pad
...
} S3C2410X_RTC_REG, *PS3C2410X_RTC_REG;    
