...
//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_MEMCTRL
//
//  Locates the memory controller register block.
//

#define S3C2410X_BASE_REG_PA_MEMCTRL            (0x48000000)            

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_USB
//
//  Locates the USB controller register block.
//
#define S3C2410X_BASE_REG_PA_USB                (0x49000000)

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_INTR
//
//  Locates the interrupt (INTR) controller register block.
//
#define S3C2410X_BASE_REG_PA_INTR               (0x4A000000)

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_DMA
//
//  Locates the DMA controller register block.
//
#define S3C2410X_BASE_REG_PA_DMA                (0x4B000000)            

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_CLOCK_POWER
//
//  Locates the clock and power register block
//
#define S3C2410X_BASE_REG_PA_CLOCK_POWER        (0x4C000000)

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_LCD
//
//  Locates the LCD controller register block.
//
#define S3C2410X_BASE_REG_PA_LCD                (0x4D000000)           

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_NAND
//
//  Locates the NAND controller register block.
//

#define S3C2410X_BASE_REG_PA_NAND               (0x4E000000)            

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_UART0/1/2
//
...
//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_PWM
//
//  Locates the PWM timer controller register block.
//

#define S3C2410X_BASE_REG_PA_PWM                (0x51000000)            

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_USBD
//
//  Locates the USB device controller register block.
//

#define S3C2410X_BASE_REG_PA_USBD               (0x52000000)            

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_WATCHDOG
//
//  Locates the watchdog timer register block.
//

#define S3C2410X_BASE_REG_PA_WATCHDOG           (0x53000000)            

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_IICBUS
//
//  Locates the IIC Bus register block.
//
#define S3C2410X_BASE_REG_PA_IICBUS             (0x54000000)           

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_IISBUS
//
//  Locates the IIS Bus register block.
//
#define S3C2410X_BASE_REG_PA_IISBUS             (0x55000000)           

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_IOPORT
//
...
//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_RTC
//
//  Locates the real time clock (RTC) register block.
//
#define S3C2410X_BASE_REG_PA_RTC                (0x57000000)

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_ADC
//
//  Locates the A/D converter register block.
//
#define S3C2410X_BASE_REG_PA_ADC                (0x58000000)           

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_SPI
//
//  Locates the SPI register block.
//
#define S3C2410X_BASE_REG_PA_SPI                (0x59000000)           

//------------------------------------------------------------------------------
//
//  Define:  S3C2410X_BASE_REG_PA_SDI
//
//  Locates the SDI register block.
//
#define S3C2410X_BASE_REG_PA_SDI                (0x5A000000)           
