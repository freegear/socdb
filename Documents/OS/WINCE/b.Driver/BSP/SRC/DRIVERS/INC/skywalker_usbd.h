...
//------------------------------------------------------------------------------
//
//  Header: skywalker_usbd.h
//
//  Defines the USB device controller CPU register layout and definitions.
//
#ifndef __S3C2410X_USBD_H
#define __S3C2410X_USBD_H
...
//------------------------------------------------------------------------------
//
//  Type: S3C2410X_USBD_REG    
//
//  Defines the USB device control register block. This register bank is
//  located by the constant S3C2410X_BASE_REG_PA_USBD in configuration file 
//  s3c2410_base_reg_cfg.h.
//
...
} S3C2410X_USBD_REG, *PS3C2410X_USBD_REG;
