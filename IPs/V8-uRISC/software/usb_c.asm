...
start:
		LDI r4,0xb1 ;__Lbss
		LDI r5,0xf2 ;__Lbss>>8
		LDI r2,0x85 ;main__15e
		LDI r3,0x05 ;main__15e>>8
		XOR r0
start__9:
		DEC r2
		BRCS start__f ;(+03)
...
;		puts("\aHigh bit stuck\r\n");
		LDI r4,0xa9 ;__Lstrings+0x49
		LDI r5,0x35 ;__Lstrings+0x49>>8
		JSR _puts
;		putFlush();
		JSR _putFlush
;		goto test_high_bit;
...
main__b8:
		LDI r4,0x60 ;__Lstrings
		LDI r5,0x35 ;__Lstrings>>8
		JSR _puts
;				continue;
		JMP main__134
;
...
main__12e:
		...
		JSR _putUnknown
main__134:
		LDI r4,0x00 ;_MainMenuString
		LDI r5,0xf0 ;_MainMenuString>>8
		JSR _puts
		JSR _putFlush
main__13e:
...
_Interrupt0Stub:
		...
		PSH r5
;	InterruptStub("\r\nInt0 ");
		LDI r4,0xa1 ;__Lstrings+0x41
		LDI r5,0x35 ;__Lstrings+0x41>>8
...
_Interrupt1Stub:
		...
		PSH r5
;	InterruptStub("\r\nInt1 ");
		LDI r4,0x99 ;__Lstrings+0x39
		LDI r5,0x35 ;__Lstrings+0x39>>8
		JMP _Interrupt7Stub__a
;}
;#pragma interrupt_level 1
...
_Interrupt2Stub:
		...
		PSH r5
;	InterruptStub("\r\nInt2 ");
		LDI r4,0x91 ;__Lstrings+0x31
		LDI r5,0x35 ;__Lstrings+0x31>>8
		JMP _Interrupt7Stub__a
;}
;#if !WANT_TIMER
...
;	TIMER_CTL = 0;
		...
		STA r0,_TIMER_CTL
;	InterruptStub("\r\nInt3 ");
		LDI r4,0x89 ;__Lstrings+0x29
		LDI r5,0x35 ;__Lstrings+0x29>>8
		JMP _Interrupt7Stub__a
;}
;#endif
;#pragma interrupt_level 1
...
_Interrupt4Stub:
		...
		PSH r5
;	InterruptStub("\r\nInt4 ");
		LDI r4,0x81 ;__Lstrings+0x21
		LDI r5,0x35 ;__Lstrings+0x21>>8
		JMP _Interrupt7Stub__a
;}
;//#pragma interrupt_level 1
...
_Interrupt6Stub:
		...
		PSH r5
;	InterruptStub("\r\nInt6 ");
		LDI r4,0x79 ;__Lstrings+0x19
		LDI r5,0x35 ;__Lstrings+0x19>>8
		JMP _Interrupt7Stub__a
;}
;#pragma interrupt_level 1
...
_Interrupt7Stub:
		...
		PSH r5
;	InterruptStub("\r\nInt7 ");
		LDI r4,0x71 ;__Lstrings+0x11
		LDI r5,0x35 ;__Lstrings+0x11>>8
_Interrupt7Stub__a:
		JSR _InterruptStub
;}
		POP r5
...
;				puts("?\r\n\r\n");
_AudioMenu__70:
		LDI r4,0x7c ;__Lstrings+0x11c
		LDI r5,0x36 ;__Lstrings+0x11c>>8
		JSR _puts
_AudioMenu__77:
		LDI r4,0xbb ;__Lstrings+0x5b
		LDI r5,0x35 ;__Lstrings+0x5b>>8
		JSR _puts
_AudioMenu__7e:
		JSR _putCrlf
		LDI r4,0x26
...
_AudioInit__4:
		...
		LDA r0,_psr+0x6
		CMP r1
		BRCS _AudioInit__24 ;(+14)
;			if ((AUDIO_ADDR & 0x80) == 0)	// test init bit
_AudioInit__10:
		LDA r0,_AUDIO_ADDR
		BRPL _AudioInit__24 ;(+0f)
		LDA r0,_psr+0x6
		INC r0
		STA r0,_psr+0x6
		LDI r1,0x10
...
;			AUDIO_DATA = A_TABLE[b];
		LDI r2,0x21 ;_A_TABLE
		LDI r3,0xf0 ;_A_TABLE>>8
		LDA r0,_psr+0x6
		LDI r1,0x00
		ADD r2
		T0X r2
...
;	puts("=Max, Capture done\r\n");
		LDI r4,0x67 ;__Lstrings+0x107
		LDI r5,0x36 ;__Lstrings+0x107>>8
		JMP _puts
;	return;
;}
;
...
;			o2.b.l = o.pb[2];
		...
		LDA r3,A_UsbSendIn
		LDO r2,0x02
		STA r0,Aa_UsbVendSetEndPoint+0x2
;			o2.b.h = o.pb[3];
		LDO r2,0x03
		STA r0,Aa_UsbVendSetEndPoint+0x3
;
;			o3.b.l = o.pb[1];
		LDO r2,0x01
...
_HostDumpRegs__df:
		LDA r2,Aa_UsbVendSetEndPoint+0x2
		LDA r3,Aa_UsbVendSetEndPoint+0x3
		LDX r2
		BRMI _HostDumpRegs__ef ;(+07)
		LDI r0,0x6e ;__Lstrings+0x20e
		LDI r1,0x37 ;__Lstrings+0x20e>>8
		JMP _HostDumpRegs__f3
_HostDumpRegs__ef:
		LDI r0,0x87 ;__Lstrings+0x227
		LDI r1,0x37 ;__Lstrings+0x227>>8
_HostDumpRegs__f3:
		T0X r2
		PSH r1
		POP r3
...
_HostDumpRegs__100:
		LDI r4,0x23 ;__Lstrings+0x1c3
		LDI r5,0x37 ;__Lstrings+0x1c3>>8
		JSR _puts
		JMP _HostDumpRegs__186
;					case 0x20: puts("Cls ");	break;
_HostDumpRegs__10a:
		LDI r4,0x01 ;__Lstrings+0x1a1
		LDI r5,0x37 ;__Lstrings+0x1a1>>8
		JSR _puts
		JMP _HostDumpRegs__186
;					case 0x40: puts("Vnd ");	break;
_HostDumpRegs__114:
		LDI r4,0x28 ;__Lstrings+0x1c8
		LDI r5,0x37 ;__Lstrings+0x1c8>>8
		JSR _puts
		JMP _HostDumpRegs__186
;					case 0x60: puts("Rsv ");	break;
_HostDumpRegs__11e:
		LDI r4,0xe8 ;__Lstrings+0x188
		LDI r5,0x36 ;__Lstrings+0x188>>8
		JSR _puts
		JMP _HostDumpRegs__186
_HostDumpRegs__128:
		LDI r1,0x60
...
_HostDumpRegs__154:
		LDI r4,0xed ;__Lstrings+0x18d
		LDI r5,0x36 ;__Lstrings+0x18d>>8
		JSR _puts
		JMP _HostDumpRegs__238
;					case 0x01: puts("Int ");	break;
_HostDumpRegs__15e:
		LDI r4,0xf2 ;__Lstrings+0x192
		LDI r5,0x36 ;__Lstrings+0x192>>8
		JSR _puts
		JMP _HostDumpRegs__238
;					case 0x02: puts("End ");	break;
_HostDumpRegs__168:
		LDI r4,0x2d ;__Lstrings+0x1cd
		LDI r5,0x37 ;__Lstrings+0x1cd>>8
		JSR _puts
		JMP _HostDumpRegs__238
;					case 0x03: puts("Oth ");	break;
_HostDumpRegs__172:
		LDI r4,0x1e ;__Lstrings+0x1be
		LDI r5,0x37 ;__Lstrings+0x1be>>8
		JSR _puts
		JMP _HostDumpRegs__238
...
_HostDumpRegs__1ac:
		LDI r4,0x3c ;__Lstrings+0x1dc
		LDI r5,0x37 ;__Lstrings+0x1dc>>8
		JSR _puts
		JMP _HostDumpRegs__290
;					case 1: puts("CLR_FEAT ");	break;
_HostDumpRegs__1b6:
		LDI r4,0x50 ;__Lstrings+0x1f0
		LDI r5,0x37 ;__Lstrings+0x1f0>>8
		JSR _puts
		JMP _HostDumpRegs__290
;					case 2: puts("reserved ");	break;
_HostDumpRegs__1c0:
		LDI r4,0x32 ;__Lstrings+0x1d2
		LDI r5,0x37 ;__Lstrings+0x1d2>>8
		JSR _puts
		JMP _HostDumpRegs__290
;					case 3: puts("SET_FEAT ");	break;
_HostDumpRegs__1ca:
		LDI r4,0x46 ;__Lstrings+0x1e6
		LDI r5,0x37 ;__Lstrings+0x1e6>>8
		JSR _puts
		JMP _HostDumpRegs__290
...
_HostDumpRegs__1de:
		LDI r4,0x64 ;__Lstrings+0x204
		LDI r5,0x37 ;__Lstrings+0x204>>8
		JSR _puts
		JMP _HostDumpRegs__290
;					case 6: puts("GET_DESC ");	break;
_HostDumpRegs__1e8:
		LDI r4,0x96 ;__Lstrings+0x236
		LDI r5,0x37 ;__Lstrings+0x236>>8
		JSR _puts
		JMP _HostDumpRegs__290
;					case 7: puts("SET_DESC ");	break;
_HostDumpRegs__1f2:
		LDI r4,0x8c ;__Lstrings+0x22c
		LDI r5,0x37 ;__Lstrings+0x22c>>8
		JSR _puts
		JMP _HostDumpRegs__290
;					case 8: puts("GET_CONF ");	break;
_HostDumpRegs__1fc:
		LDI r4,0x7d ;__Lstrings+0x21d
		LDI r5,0x37 ;__Lstrings+0x21d>>8
		JSR _puts
		JMP _HostDumpRegs__290
;					case 9: puts("SET_CONF ");	break;
_HostDumpRegs__206:
		LDI r4,0x73 ;__Lstrings+0x213
		LDI r5,0x37 ;__Lstrings+0x213>>8
		JSR _puts
		JMP _HostDumpRegs__290
;					case 10: puts("GET_IFC  ");	break;
_HostDumpRegs__210:
		LDI r4,0xff ;__Lstrings+0x29f
		LDI r5,0x37 ;__Lstrings+0x29f>>8
		JSR _puts
		JMP _HostDumpRegs__290
;					case 11: puts("SET_IFC  ");	break;
_HostDumpRegs__21a:
		LDI r4,0xf5 ;__Lstrings+0x295
		LDI r5,0x37 ;__Lstrings+0x295>>8
		JSR _puts
		JMP _HostDumpRegs__290
;					case 12: puts("SYNCH_FR ");	break;
_HostDumpRegs__224:
		LDI r4,0x5a ;__Lstrings+0x1fa
		LDI r5,0x37 ;__Lstrings+0x1fa>>8
		JSR _puts
		JMP _HostDumpRegs__290
;					default: puts("unknown  ");	break;
_HostDumpRegs__22e:
		LDI r4,0xeb ;__Lstrings+0x28b
		LDI r5,0x37 ;__Lstrings+0x28b>>8
		JSR _puts
		JMP _HostDumpRegs__290
_HostDumpRegs__238:
		LDA r2,Aa_UsbVendSetEndPoint+0x2
...
;				putb(*o2.pb++);
_HostDumpRegs__27b:
		LDA r0,Aa_UsbVendSetEndPoint+0x3
		T0X r3
		T0X r1
		LDA r0,Aa_UsbVendSetEndPoint+0x2
		T0X r2
		UPP r0
		STA r0,Aa_UsbVendSetEndPoint+0x2
		STA r1,Aa_UsbVendSetEndPoint+0x3
		LDX r2
		T0X r4
		JSR _putb
_HostDumpRegs__290:
...
;		puts(UsbMenuString);
_UsbMenu:
		LDI r4,0x8c ;_UsbMenuString
		LDI r5,0xf0 ;_UsbMenuString>>8
		JSR _puts
;		putFlush();
		JSR _putFlush
;input:
...
;					{
;					puts("todo ");
		LDI r4,0x06 ;__Lstrings+0x1a6
		LDI r5,0x37 ;__Lstrings+0x1a6>>8
		JSR _puts
;					puts("contains ");
		LDI r4,0xf7 ;__Lstrings+0x197
		LDI r5,0x36 ;__Lstrings+0x197>>8
		JSR _puts
;					putws(todo.wLength);
		LDA r4,_todo
		LDA r5,_todo+0x1
...
;	puts("USB_HOST_STATE = ");
_UsbVariables__89:
		LDI r4,0xa0 ;__Lstrings+0x240
		LDI r5,0x37 ;__Lstrings+0x240>>8
		JSR _puts
;	putb(USB_HOST_STATE);
...
;	puts("USB_META_STATE_WANTED = ");
		LDI r4,0xc4 ;__Lstrings+0x264
		LDI r5,0x37 ;__Lstrings+0x264>>8
		JSR _puts
...
;	putCrlf();
		JSR _putCrlf
;	puts("USB_META_STATE = ");
		LDI r4,0xb2 ;__Lstrings+0x252
		LDI r5,0x37 ;__Lstrings+0x252>>8
		JSR _puts
;	putb(USB_META_STATE);
...
_MetaState__b:
		LDI r4,0xc1 ;__Lstrings+0x161
		LDI r5,0x36 ;__Lstrings+0x161>>8
		JSR _puts
;			putb(USB_META_STATE);
		LDA r4,_USB_META_STATE
		JSR _putb
...
;			putb(USB_META_STATE_WANTED);
		...
		JSR _putb
;			puts("\r\n\a");
		LDI r4,0xc9 ;__Lstrings+0x369
		LDI r5,0x38 ;__Lstrings+0x369>>8
		JMP _puts
_MetaState__2a:
		LDA r0,_USB_META_STATE
		LDI r4,0xef
...
_MetaState11__1c:
		STA r0,Aa_UsbVendSetEndPoint+0x2
		LDI r2,0x48 ;_tx_get_desc_device
		LDI r3,0xf0 ;_tx_get_desc_device>>8
		LDA r4,_speed
		JMP _SendSetup
;	return;
;}
...
;		{
;		puts("Value hosed\r\n");
		LDI r4,0x91 ;__Lstrings+0x331
		LDI r5,0x38 ;__Lstrings+0x331>>8
		JSR _puts
...
;	SendSetup(0|speed, (PBYTE)&tx_set_addr, (PBYTE)&rx_desc_device, USB_PACKET_LENGTH_0);
		...
		LDI r0,0xf0
		STA r0,Aa_UsbVendSetEndPoint+0x2
		LDI r2,0xa1 ;_tx_set_addr
		LDI r3,0xf2 ;_tx_set_addr>>8
		LDA r4,_speed
		JMP _SendSetup
;
;	return;
...
;	puts("Configured device:");
		LDI r4,0xd5 ;__Lstrings+0x175
		LDI r5,0x36 ;__Lstrings+0x175>>8
		JSR _puts
...
_MetaState15:
		LDI r4,0x69 ;__Lstrings+0x309
		LDI r5,0x38 ;__Lstrings+0x309>>8
		JSR _puts
...
_MetaState20:
		LDI r4,0x9f ;__Lstrings+0x33f
		LDI r5,0x38 ;__Lstrings+0x33f>>8
		JSR _puts
...
;	SendSetup(USB_CURRENT_ADDR, (PBYTE)&tx_get_desc_config, (PBYTE)&rx_desc_config, USB_PACKET_LENGTH_BYTE23);
		...
		LDI r0,0xf2
		STA r0,Aa_UsbVendSetEndPoint+0x2
		LDI r2,0x50 ;_tx_get_desc_config
		LDI r3,0xf0 ;_tx_get_desc_config>>8
		LDA r4,_USB_CURRENT_ADDR
		JMP _SendSetup
;	return;
;}
...
;		puts("Should have been zero\r\n");
		LDI r4,0x51 ;__Lstrings+0x2f1
		LDI r5,0x38 ;__Lstrings+0x2f1>>8
		JSR _puts
;
;	putFlush();
_MetaState25__1c:
...
;	SendSetup(USB_CURRENT_ADDR, (PBYTE)&tx_set_config, rx_null_packet, USB_PACKET_LENGTH_0);
		...
		LDI r0,0xf0
		STA r0,Aa_UsbVendSetEndPoint+0x2
		LDI r2,0x60 ;_tx_set_config
		LDI r3,0xf0 ;_tx_set_config>>8
		LDA r4,_USB_CURRENT_ADDR
		JMP _SendSetup
;
;	return;
...
_MetaState26:
		...
		INC r0
		STA r0,Aa_UsbVendSetEndPoint+0x2
		LDI r2,0x68 ;_tx_get_config
		LDI r3,0xf0 ;_tx_get_config>>8
		LDA r4,_USB_CURRENT_ADDR
		JMP _SendSetup
;	return;
;}
...
;		puts("Should have been ");
		LDI r4,0x0c ;__Lstrings+0x1ac
		LDI r5,0x37 ;__Lstrings+0x1ac>>8
		JSR _puts
;		putb(USB_CURRENT_CONFIG);
		LDA r4,_USB_CURRENT_CONFIG
		JSR _putb
...
_MetaState27__29:
		LDI r4,0x1d ;__Lstrings+0x2bd
		LDI r5,0x38 ;__Lstrings+0x2bd>>8
		JSR _puts
;
;//#if DEBUG_USB_STRINGS
;//	MetaState30();
...
_MetaState42:
		LDI r4,0xb0 ;__Lstrings+0x150
		LDI r5,0x36 ;__Lstrings+0x150>>8
		JSR _puts
...
;	SendSetup(USB_CURRENT_ADDR, (PBYTE)&tx_set_port_feature, rx_null_packet, USB_PACKET_LENGTH_0);
		...
		LDI r0,0xf0
		STA r0,Aa_UsbVendSetEndPoint+0x2
		LDI r2,0x70 ;_tx_set_port_feature
		LDI r3,0xf0 ;_tx_set_port_feature>>8
		LDA r4,_USB_CURRENT_ADDR
		JMP _SendSetup
;	return;
;}
...
;	SendSetup(USB_CURRENT_ADDR, (PBYTE)&tx_get_port_status, (PBYTE)&rx_port_status, 4);
		...
		LDI r0,0x04
		STA r0,Aa_UsbVendSetEndPoint+0x2
		LDI r2,0x78 ;_tx_get_port_status
		LDI r3,0xf0 ;_tx_get_port_status>>8
		LDA r4,_USB_CURRENT_ADDR
		JMP _SendSetup
;	return;
;}
...
;	SendSetup(USB_CURRENT_ADDR, (PBYTE)&tx_enable_echo, rx_null_packet, USB_PACKET_LENGTH_0);	// expect 0 bytes returned
		...
		LDI r0,0xf0
		STA r0,Aa_UsbVendSetEndPoint+0x2
		LDI r2,0x80 ;_tx_enable_echo
		LDI r3,0xf0 ;_tx_enable_echo>>8
		LDA r4,_USB_CURRENT_ADDR
		JMP _SendSetup
;	return;
;}
...
_MetaState51:
		LDI r4,0x35 ;__Lstrings+0x2d5
		LDI r5,0x38 ;__Lstrings+0x2d5>>8
		JSR _puts
;
;	ResetMetaStateWanted();
		JMP _ResetMetaStateWanted
...
;	puts("MetaState60: ");
_MetaState60:
		LDI r4,0xdd ;__Lstrings+0x27d
		LDI r5,0x37 ;__Lstrings+0x27d>>8
		JSR _puts
;	puts("todo ");
		LDI r4,0x06 ;__Lstrings+0x1a6
		LDI r5,0x37 ;__Lstrings+0x1a6>>8
...
;	todo.pBuffer += wBufferSize;
		...
		TX0 r3
		T0X r1
		STA r2,Aa_UsbVendSetEndPoint+0x2
		STA r1,Aa_UsbVendSetEndPoint+0x3
		LDA r0,_todo+0x2
		LDA r1,Aa_UsbVendSetEndPoint+0x2
		ADD r1
		STA r0,_todo+0x2
		LDA r0,_todo+0x3
		LDA r1,Aa_UsbVendSetEndPoint+0x3
		ADC r1
		STA r0,_todo+0x3
...
_MetaState61:
		LDI r4,0x95 ;__Lstrings+0x135
		LDI r5,0x36 ;__Lstrings+0x135>>8
		JSR _puts
;putw(todo.wLength);
		LDA r4,_todo
		LDA r5,_todo+0x1
...
;	puts("todo is done\r\n");
_MetaState61__1f:
		LDI r4,0x82 ;__Lstrings+0x322
		LDI r5,0x38 ;__Lstrings+0x322>>8
		JSR _puts
;	bSomethingTodo = 0;
		XOR r0
		STA r0,_bSomethingTodo
...
_HostDebounceAttachDetach:
		LDI r4,0x82 ;__Lstrings+0x122
		LDI r5,0x36 ;__Lstrings+0x122>>8
		JSR _puts
;putb(usb.control);
		LDA r4,_usb+0x5
		JSR _putb
...
;	o1.w = (o1.w + HOST_WAIT.w) & 0x7ff;
		LDI r2,0xff ;_AudioSawtooth+0x4b
		LDI r3,0x07 ;_AudioSawtooth+0x4b>>8
		LDA r4,_HOST_WAIT
...
;	{
;	puts("\r\ndelay timed out\r\n");
		LDI r4,0x09 ;__Lstrings+0x2a9
		LDI r5,0x38 ;__Lstrings+0x2a9>>8
		JSR _puts
;	putFlush();
		JMP _putFlush
;	}
...
_RAM2EEPROM:
		LDI r4,0xe0 ;__Lstrings+0x380
		LDI r5,0x38 ;__Lstrings+0x380>>8
		JSR _puts
;	putFlush();
		JSR _putFlush
;
...
;	puts(" \aEEPROM written\r\n");
		LDI r4,0xcd ;__Lstrings+0x36d
		LDI r5,0x38 ;__Lstrings+0x36d>>8
_RAM2EEPROM__126:
		JSR _puts
;
;exit:
...
;	puts(" \aEEPROM write FAILED\r\n");
		LDI r4,0xfb ;__Lstrings+0x39b
		LDI r5,0x38 ;__Lstrings+0x39b>>8
...
_UartReadHexWord:
		LDI r2,0x20
		LDI r4,0x9b ;_linebuf
		LDI r5,0xf0 ;_linebuf>>8
		JSR _UartReadString
...
_UartReadHexWord__24:
		LDI r2,0x9b ;_linebuf
		LDI r3,0xf0 ;_linebuf>>8
		LDA r0,_bTimesUp+0x4
		LDI r1,0x00
		ADD r2
		T0X r2
...
;	l = 0;
_UartReadString:
		STA r2,Aa_UsbVendSetEndPoint
		STA r4,Aa_UsbVendSetEndPoint+0x1
		STA r5,Aa_UsbVendSetEndPoint+0x2
		XOR r0
_UartReadString__a:
...
_UartReadString__3f:
		...
		LDA r3,Aa_UsbVendSetEndPoint+0x2
		LDA r0,_bTimesUp+0x5
		LDI r1,0x00
		ADD r2
		T0X r2
...
;	do	{
;		putFlushOneIfReady();
_UartGetAndEchoChar__4:
		JSR _putFlushOneIfReady
;		} while (!UartCharWaiting());
		JSR _UartCharWaiting
		T0X r1
		BREQ _UartGetAndEchoChar__4 ;(-09)
;
;	c = UartReadChar();
		JSR _UartReadChar
		STA r0,_bTimesUp+0x7
...
;	puts(" = Unknown Command\r\n");
		LDI r4,0x13 ;__Lstrings+0x3b3
		LDI r5,0x39 ;__Lstrings+0x3b3>>8
		JMP _puts
;	return;
;}
;
...
;
;	puts("Up\r\n");
		LDI r4,0x28 ;__Lstrings+0x3c8
		LDI r5,0x39 ;__Lstrings+0x3c8>>8
		JMP _puts
;
;	return;
;}
...
;	usbSave = usb;
		LDI r2,0x80 ;_usb
		LDI r3,0x02 ;_usb>>8
		LDI r4,0x15 ;_usbSave
		LDI r5,0xf7 ;_usbSave>>8
		LDI r1,0x11
...
;		USB_LAST_OUT[usbSave.ep] = (usbSave.status >> 2) & 1;
		LDI r2,0x01 ;_USB_LAST_OUT
		LDI r3,0xf7 ;_USB_LAST_OUT>>8
		LDA r0,_usbSave+0xe
		LDI r1,0x00
		ADD r2
		T0X r2
...
;			PUTS("~42", "Attach ignored\r\n");
		LDI r4,0x80 ;__Lstrings+0x820
		LDI r5,0x3d ;__Lstrings+0x820>>8
		JSR _puts
;			putFlush();
		JSR _putFlush
;			}
...
_UsbTargetIntService__f8:
		LDI r4,0x20 ;__Lstrings+0x6c0
		LDI r5,0x3c ;__Lstrings+0x6c0>>8
		JSR _UsbStall
;		}
;
...
_UsbPowered__a:
		...
		STA r0,Aa_UsbVendSetEndPoint
		LDI r2,0x00
		LDI r4,0x09 ;_USB_NEXT_OUT
		LDI r5,0xf7 ;_USB_NEXT_OUT>>8
		JSR _memset
;	memset(USB_LAST_OUT, 0xff, ENDPOINTS);
		LDI r0,0x04
		STA r0,Aa_UsbVendSetEndPoint
		LDI r2,0xff
		LDI r4,0x01 ;_USB_LAST_OUT
		LDI r5,0xf7 ;_USB_LAST_OUT>>8
		JSR _memset
;	memset(USB_NEXT_IN, 0, ENDPOINTS);
		LDI r0,0x04
		STA r0,Aa_UsbVendSetEndPoint
		LDI r2,0x00
		LDI r4,0x05 ;_USB_NEXT_IN
		LDI r5,0xf7 ;_USB_NEXT_IN>>8
		JSR _memset
;
...
_UsbSuspend:
		LDI r4,0xa5 ;__Lstrings+0x645
		LDI r5,0x3b ;__Lstrings+0x645>>8
;	return;
;}
;
;void UsbStall(PBYTE p)
...
_UsbStall:
		...
		LDI r4,0xf5 ;__Lstrings+0x795
		LDI r5,0x3c ;__Lstrings+0x795>>8
		JSR _puts
;	puts(p);
		LDA r4,A_UsbSendIn
		...
		JSR _puts
;	puts(" - stalling\r\n");
		LDI r4,0x72 ;__Lstrings+0x812
		LDI r5,0x3d ;__Lstrings+0x812>>8
		JSR _puts
;	putFlush();
		JSR _putFlush
;
...
;									STALL("~1", "UsbAddress: EP not 0");
		LDI r4,0x5d ;__Lstrings+0x7fd
		LDI r5,0x3d ;__Lstrings+0x7fd>>8
		JMP _UsbAddress__3f
...
_UsbAddress__3b:
		LDI r4,0x2d ;__Lstrings+0x3cd
		LDI r5,0x39 ;__Lstrings+0x3cd>>8
_UsbAddress__3f:
		JSR _UsbStall
;								UsbProvideRxBDT(TRUE);			// release the RX BDT again now that we're done
		LDI r4,0x01
...
;			PUTS("~3", "UsbConfig: BDT owned by host\r\n\a");
		LDI r4,0xab ;__Lstrings+0x84b
		LDI r5,0x3d ;__Lstrings+0x84b>>8
		JSR _puts
;			}
;
...
;		{
;		if (!bExtraRxBDT[ep])
		LDI r2,0xbc ;_bExtraRxBDT
		LDI r3,0xf0 ;_bExtraRxBDT>>8
		TX0 r5
		LDI r1,0x00
		ADD r2
		T0X r2
...
;	onion.pBDT->pid = 0x88 | RECV_DATA01[ep];	// change OWN back to the VUSB (provide it)
		LDI r2,0xdc ;_RECV_DATA01
		LDI r3,0xf6 ;_RECV_DATA01>>8
		TX0 r5
		LDI r1,0x00
		ADD r2
		T0X r2
...
;		{
;		puts("\aError:");
		LDI r4,0xff ;__Lstrings+0x79f
		LDI r5,0x3c ;__Lstrings+0x79f>>8
		JSR _puts
;		putb(bError);
		LDA r4,_UART_NEXT+0x3
		JSR _putb
...
_UsbTokenDoneEP0__6e:
		LDI r4,0x5d ;__Lstrings+0x3fd
		LDI r5,0x39 ;__Lstrings+0x3fd>>8
		JMP _UsbStall
...
_UsbTokenDoneEP0__9b:
		LDI r4,0x93 ;__Lstrings+0x533
		LDI r5,0x3a ;__Lstrings+0x533>>8
		JMP _UsbStall
;	return;
;}
;
...
_UsbGetStatus__6b:
		LDI r4,0xab ;__Lstrings+0x44b
		LDI r5,0x39 ;__Lstrings+0x44b>>8
		JMP _UsbStall
;				return;
;				}
;
...
_UsbGetStatus__95:
		LDI r4,0x50 ;__Lstrings+0x6f0
		LDI r5,0x3c ;__Lstrings+0x6f0>>8
		JMP _UsbStall
_UsbGetStatus__9c:
		LDI r1,0x7c
		LDA r0,_cBDT
...
;				STALL("~6", "UsbClearFeature: not CLR_ENDPOINT");
		LDI r4,0xfe ;__Lstrings+0x69e
		LDI r5,0x3b ;__Lstrings+0x69e>>8
		JMP _UsbStall
;				return;
;				}
;			if (setup.wValue.w)
...
;				STALL("~7", "UsbClearFeature: wValue not 0");
		LDI r4,0x3f ;__Lstrings+0x7df
		LDI r5,0x3d ;__Lstrings+0x7df>>8
		JMP _UsbStall
;				return;
;				}
;
...
_UsbClearFeature__9c:
		XOR r0
		LDA r2,Aa_UsbVendSetEndPoint+0x3
...
;			USB_NEXT_OUT[ep] = USB_LAST_OUT[ep] + 1;
		LDI r2,0x09 ;_USB_NEXT_OUT
		LDI r3,0xf7 ;_USB_NEXT_OUT>>8
		LDA r0,Aa_UsbVendSetEndPoint
		LDI r1,0x00
		ADD r2
		T0X r2
...
;			SEND_DATA01[ep] = 0x00;	// next in token from this ep will use data0
		LDI r2,0xe0 ;_SEND_DATA01
		LDI r3,0xf6 ;_SEND_DATA01>>8
		TX0 r4
		LDI r1,0x00
...
_UsbClearFeature__1b2:
		LDI r4,0x92 ;__Lstrings+0x432
		LDI r5,0x39 ;__Lstrings+0x432>>8
		JMP _UsbStall
;	return;
;}
;
...
;			STALL("~8", "UsbSetFeature: bad own");
		LDI r4,0x7b ;__Lstrings+0x41b
		LDI r5,0x39 ;__Lstrings+0x41b>>8
		JMP _UsbStall
;			return;
;			}
;		return;
...
;			STALL("~9", "UsbSetFeature: not CLR_ENDPOINT");
		LDI r4,0xde ;__Lstrings+0x67e
		LDI r5,0x3b ;__Lstrings+0x67e>>8
		JMP _UsbStall
;			return;
;			}
;		if (setup.wValue.w)
...
;			STALL("~10", "UsbSetFeature: wValue not 0");
		LDI r4,0x23 ;__Lstrings+0x7c3
		LDI r5,0x3d ;__Lstrings+0x7c3>>8
		JMP _UsbStall
;			return;
;			}
...
;		STALL("~11", "UsbSetAddress: not In Data1");
		LDI r4,0x07 ;__Lstrings+0x7a7
		LDI r5,0x3d ;__Lstrings+0x7a7>>8
		JSR _UsbStall
;//		return;
;		}
;
...
_UsbGetDescription:
		LDI r2,0xc0 ;_USB_MAX_PACKET
		LDI r3,0xf0 ;_USB_MAX_PACKET>>8
		LDA r0,_usbSave+0xe
		LDI r1,0x00
		ADD r0
		ROL r1
...
_UsbGetDescription__cc:
		LDI r2,0xdc ;_USB_DEBUG+0x114
		LDI r3,0xf1 ;_USB_DEBUG+0x114>>8
		LDA r0,_setup+0x2
		LDI r1,0x00
		ADD r0
		ROL r1
...
;				STALL("~12", " - UsbGetDescription: bad wValue");
		LDI r4,0xcd ;__Lstrings+0x46d
		LDI r5,0x39 ;__Lstrings+0x46d>>8
		JMP _UsbStall
...
_UsbGetDescription__1c2:
		LDI r4,0xc5 ;__Lstrings+0x765
		LDI r5,0x3c ;__Lstrings+0x765>>8
		JSR _puts
;		putb(cBDT.pid);
		LDA r4,_cBDT
		JSR _putb
...
;		STALL("~13", "UsbGetDescription: Bad PID");
		LDI r4,0x81 ;__Lstrings+0x721
		LDI r5,0x3c ;__Lstrings+0x721>>8
		JMP _UsbStall
;		return;
;		}
;
...
_UsbSetDescription:
		LDI r4,0xbb ;__Lstrings+0x65b
		LDI r5,0x3b ;__Lstrings+0x65b>>8
		JMP _UsbStall
;	return;
;}
;
...
;			STALL("~15", "UsbGetConfig: bad bRequestType");
		LDI r4,0x10 ;__Lstrings+0x4b0
		LDI r5,0x3a ;__Lstrings+0x4b0>>8
		JMP _UsbStall
;			return;
;			}
...
;	STALL("~3", "UsbGetConfig Bad PID");
		LDI r4,0x3b ;__Lstrings+0x6db
		LDI r5,0x3c ;__Lstrings+0x6db>>8
		JMP _UsbStall
;	return;
;}
;
...
_UsbSetConfig:
		...
		STA r0,Aa_UsbVendSetEndPoint
		LDI r2,0x00
		LDI r4,0xe0 ;_SEND_DATA01
		LDI r5,0xf6 ;_SEND_DATA01>>8
		JSR _memset
;	memset(RECV_DATA01, 0x00, ENDPOINTS);	// stores the Data1/0 PID
		LDI r0,0x04
		STA r0,Aa_UsbVendSetEndPoint
		LDI r2,0x00
		LDI r4,0xdc ;_RECV_DATA01
		LDI r5,0xf6 ;_RECV_DATA01>>8
		JSR _memset
;
;	if (IS_TOKEN_SETUP_DATA0)
		LDI r1,0x7c
...
;			USB_STATE = ADDRESS_STATE;
		...
		STA r0,_USB_STATE
;			puts("USC:Addr=");
		LDI r4,0xb2 ;__Lstrings+0x752
		LDI r5,0x3c ;__Lstrings+0x752>>8
		JSR _puts
;			putb(usbSave.address);
		LDA r4,_usbSave+0x6
		JSR _putb
...
;			putb(USB_CURR_CONFIG);
		...
		JSR _putb
;			puts("!=");
		LDI r4,0xf2 ;__Lstrings+0x792
		LDI r5,0x3c ;__Lstrings+0x792>>8
		JSR _puts
;			putb(USB_CONFIG_DESC[5]);
		LDA r4,_USB_CONFIG_DESC+0x5
		JSR _putb
;			UsbStall("UsbSetConfig");
		LDI r4,0xc0 ;__Lstrings+0x460
		LDI r5,0x39 ;__Lstrings+0x460>>8
		JMP _UsbStall
;			return;
;			}
;
...
;		STALL("~16", "UsbSetConfig: Bad PID");
		LDI r4,0x9c ;__Lstrings+0x73c
		LDI r5,0x3c ;__Lstrings+0x73c>>8
		JMP _UsbStall
;		return;
;		}
;
...
;			STALL("~17", "UsbGetInterface: bad bRequestType");
		LDI r4,0x71 ;__Lstrings+0x511
		LDI r5,0x3a ;__Lstrings+0x511>>8
		JMP _UsbStall
;			return;
;			}
;
...
_UsbGetInterface__48:
		LDI r4,0x8c ;__Lstrings+0x62c
		LDI r5,0x3b ;__Lstrings+0x62c>>8
		JMP _UsbStall
;	return;
;}
;
...
;		{
;		puts("I=");
		LDI r4,0xef ;__Lstrings+0x78f
		LDI r5,0x3c ;__Lstrings+0x78f>>8
		JSR _puts
...
;			STALL("~20", "UsbSetInterface: bad bRequestType");
		LDI r4,0x4f ;__Lstrings+0x4ef
		LDI r5,0x3a ;__Lstrings+0x4ef>>8
		JMP _UsbStall
;			return;
;			}
;		
...
_UsbSetInterface__50:
		LDI r2,0xd9 ;_pDataOut+0x2
		LDI r3,0xf6 ;_pDataOut+0x2>>8
		LDA r0,_setup+0x4
		LDI r1,0x00
		ADD r2
		T0X r2
...
_UsbSetInterface__7f:
		LDI r4,0x73 ;__Lstrings+0x613
		LDI r5,0x3b ;__Lstrings+0x613>>8
		JMP _UsbStall
;	return;
;}
;
...
;			STALL("~23", "UsbSynchFrame: bad bRequestType");
		LDI r4,0x2f ;__Lstrings+0x4cf
		LDI r5,0x3a ;__Lstrings+0x4cf>>8
		JMP _UsbStall
;			return;
;			}
;		
...
_UsbSynchFrame__3e:
		LDI r4,0x5c ;__Lstrings+0x5fc
		LDI r5,0x3b ;__Lstrings+0x5fc>>8
		JMP _UsbStall
;	return;
;}
;
...
;		STALL("~26", "UsbTokenDoneEP1_Speaker: bad pid");
		LDI r4,0x3b ;__Lstrings+0x5db
		LDI r5,0x3b ;__Lstrings+0x5db>>8
		JMP _UsbStall
;		return;
;		}
;
...
;		STALL("~27", "UsbTokenDoneEPn: bad bRequestType");
		LDI r4,0xee ;__Lstrings+0x48e
		LDI r5,0x39 ;__Lstrings+0x48e>>8
		JMP _UsbStall
;		return;
;		}
;
...
;		PUTS("~41", " - USB Buffer not OWNed\r\n");
		LDI r4,0x91 ;__Lstrings+0x831
		LDI r5,0x3d ;__Lstrings+0x831>>8
		JSR _puts
;		return NULL;
		XOR r0
		T0X r1
...
_UsbVendor__27:
		LDI r4,0x45 ;__Lstrings+0x3e5
		LDI r5,0x39 ;__Lstrings+0x3e5>>8
		JMP _UsbStall
;	return;
;}
;
...
_UsbVendSetStatus__44:
		LDI r4,0xed ;__Lstrings+0x58d
		LDI r5,0x3a ;__Lstrings+0x58d>>8
		JMP _UsbStall
;
;	return;
;}
...
_UsbVendGetStatus__43:
		LDI r4,0x07 ;__Lstrings+0x5a7
		LDI r5,0x3b ;__Lstrings+0x5a7>>8
		JMP _UsbStall
;	return;
;}
;
...
;		INIT_ONION_WITH_BDT_FOR_EP(onion,ep);	// point to BDT for specified EP
		LDI r1,0x70
		STA r1,Aa_UsbVendSetEndPoint+0x2
		TX0 r4
		ADD r4
		ADD r0
		ADD r0
...
_UsbVendSetEndPoint__e4:
		LDI r4,0xb5 ;__Lstrings+0x555
		LDI r5,0x3a ;__Lstrings+0x555>>8
		JMP _UsbStall
;
;	return;
;}
...
_UsbVendGetEndPoint__4d:
		LDI r4,0xd1 ;__Lstrings+0x571
		LDI r5,0x3a ;__Lstrings+0x571>>8
		JMP _UsbStall
;	return;
;}
;
...
_UsbVendBreakOwns__ab:
		LDI r4,0x21 ;__Lstrings+0x5c1
		LDI r5,0x3b ;__Lstrings+0x5c1>>8
		JMP _UsbStall
;	return;
;}
;
...
;	if (iFailCount == 1)
		...
		STA r3,Aa_UsbVendSetEndPoint+0x2
		TX0 r2
		DEC r0
		OR  r3
...
;		puts("\r\n\aERROR:USB Failed BIST\r\n\aExpected=");
		LDI r4,0xca ;__Lstrings+0x76a
		LDI r5,0x3c ;__Lstrings+0x76a>>8
		JSR _puts
;		putb(b);
		LDA r4,Aa_UsbVendSetEndPoint
		JSR _putb
;		puts(" Actual=");
		LDI r4,0xbc ;__Lstrings+0x75c
		LDI r5,0x3c ;__Lstrings+0x75c>>8
		JSR _puts
;		putb(b2);
...
_UsbRegRW__52:
		...
		LDA r5,Aa_UsbVendSetEndPoint+0x2
		JSR _putw
;		iFailCount++;
		LDA r0,Aa_UsbVendSetEndPoint+0x1
		LDA r1,Aa_UsbVendSetEndPoint+0x2
...
;	PUTS("~35", "PrinterClassSetup: Bad PID");
		LDI r4,0x66 ;__Lstrings+0x706
		LDI r5,0x3c ;__Lstrings+0x706>>8
		JMP _puts
;	goto done;
;
;done:
...
_DOWNLOAD:
		LDI r4,0xcb ;__Lstrings+0x86b
		LDI r5,0x3d ;__Lstrings+0x86b>>8
		JSR _puts
;	putFlush();
		JSR _putFlush
;	
...
__Lstrings+0x11:	.string "\r\n"
		.string "Int7 \0"
__Lstrings+0x19:	.string "\r\n"
		.string "Int6 \0"
__Lstrings+0x21:	.string "\r\n"
		.string "Int4 \0"
__Lstrings+0x29:	.string "\r\n"
		.string "Int3 \0"
__Lstrings+0x31:	.string "\r\n"
		.string "Int2 \0"
__Lstrings+0x39:	.string "\r\n"
		.string "Int1 \0"
__Lstrings+0x41:	.string "\r\n"
		.string "Int0 \0"
__Lstrings+0x49:	.string "\aHigh bit stuck\r\n\0"
__Lstrings+0x5b:	.string "\r\n"
		...
		.string "= = Show Freq\r\n"
		.string "x = Exit\0"
__Lstrings+0x107:	.string "=Max, Capture done\r\n\0"
__Lstrings+0x11c:	.string "?\r\n"
		.string "\r\n\0"
__Lstrings+0x122:	.string "HDAD: usb.control=\0"
__Lstrings+0x135:	.string "MetaState61: todo.wLength=\0"
__Lstrings+0x150:	.string "Got port status:\0"
__Lstrings+0x161:	.string "Invalid meta state:\0"
__Lstrings+0x175:	.string "Configured device:\0"
__Lstrings+0x188:	.string "Rsv \0"
__Lstrings+0x18d:	.string "Dev \0"
__Lstrings+0x192:	.string "Int \0"
__Lstrings+0x197:	.string "contains \0"
__Lstrings+0x1a1:	.string "Cls \0"
__Lstrings+0x1a6:	.string "todo \0"
__Lstrings+0x1ac:	.string "Should have been \0"
__Lstrings+0x1be:	.string "Oth \0"
__Lstrings+0x1c3:	.string "Std \0"
__Lstrings+0x1c8:	.string "Vnd \0"
__Lstrings+0x1cd:	.string "End \0"
__Lstrings+0x1d2:	.string "reserved \0"
__Lstrings+0x1dc:	.string "GET_STAT \0"
__Lstrings+0x1e6:	.string "SET_FEAT \0"
__Lstrings+0x1f0:	.string "CLR_FEAT \0"
__Lstrings+0x1fa:	.string "SYNCH_FR \0"
__Lstrings+0x204:	.string "SET_ADDR \0"
__Lstrings+0x20e:	.string "D>H \0"
__Lstrings+0x213:	.string "SET_CONF \0"
__Lstrings+0x21d:	.string "GET_CONF \0"
__Lstrings+0x227:	.string "H>D \0"
__Lstrings+0x22c:	.string "SET_DESC \0"
__Lstrings+0x236:	.string "GET_DESC \0"
__Lstrings+0x240:	.string "USB_HOST_STATE = \0"
__Lstrings+0x252:	.string "USB_META_STATE = \0"
__Lstrings+0x264:	.string "USB_META_STATE_WANTED = \0"
__Lstrings+0x27d:	.string "MetaState60: \0"
__Lstrings+0x28b:	.string "unknown  \0"
__Lstrings+0x295:	.string "SET_IFC  \0"
__Lstrings+0x29f:	.string "GET_IFC  \0"
__Lstrings+0x2a9:	.string "\r\n"
		.string "delay timed out\r\n\0"
__Lstrings+0x2bd:	.string "End of Chapter 9 test\r\n\0"
__Lstrings+0x2d5:	.string "Enable echo has been sent\r\n\0"
__Lstrings+0x2f1:	.string "Should have been zero\r\n\0"
__Lstrings+0x309:	.string "Host mode init is done\r\n\0"
__Lstrings+0x322:	.string "todo is done\r\n\0"
__Lstrings+0x331:	.string "Value hosed\r\n\0"
__Lstrings+0x33f:	.string "\r\n"
		.string "Starting Chapter 9 test on address 1!\r\n\0"
__Lstrings+0x369:	.string "\r\n"
		.string "\a\0"
__Lstrings+0x36d:	.string " \aEEPROM written\r\n\0"
__Lstrings+0x380:	.string "\r\n"
		.string "Copying SRAM to EEPROM\r\n\0"
__Lstrings+0x39b:	.string " \aEEPROM write FAILED\r\n\0"
__Lstrings+0x3b3:	.string " = Unknown Command\r\n\0"
__Lstrings+0x3c8:	.string "Up\r\n\0"
__Lstrings+0x3cd:	.string "UsbAddress: bad request\0"
__Lstrings+0x3e5:	.string "UsbVendor: bad bRequest\0"
__Lstrings+0x3fd:	.string "UsbTokenDoneEP0: bad bRequest\0"
__Lstrings+0x41b:	.string "UsbSetFeature: bad own\0"
__Lstrings+0x432:	.string "UsbClearFeature: bad own\0"
__Lstrings+0x44b:	.string "UsbGetStatus BAD own\0"
__Lstrings+0x460:	.string "UsbSetConfig\0"
__Lstrings+0x46d:	.string " - UsbGetDescription: bad wValue\0"
__Lstrings+0x48e:	.string "UsbTokenDoneEPn: bad bRequestType\0"
__Lstrings+0x4b0:	.string "UsbGetConfig: bad bRequestType\0"
__Lstrings+0x4cf:	.string "UsbSynchFrame: bad bRequestType\0"
__Lstrings+0x4ef:	.string "UsbSetInterface: bad bRequestType\0"
__Lstrings+0x511:	.string "UsbGetInterface: bad bRequestType\0"
__Lstrings+0x533:	.string "UsbTokenDoneEP0: bad bRequestType\0"
__Lstrings+0x555:	.string "UsbVendSetEndPoint: bad pid\0"
__Lstrings+0x571:	.string "UsbVendGetEndPoint: bad pid\0"
__Lstrings+0x58d:	.string "UsbVendSetStatus: bad pid\0"
__Lstrings+0x5a7:	.string "UsbVendGetStatus: bad pid\0"
__Lstrings+0x5c1:	.string "UsbVendBreakOwns: bad pid\0"
__Lstrings+0x5db:	.string "UsbTokenDoneEP1_Speaker: bad pid\0"
__Lstrings+0x5fc:	.string "UsbSynchFrame: bad pid\0"
__Lstrings+0x613:	.string "UsbSetInterface: bad pid\0"
__Lstrings+0x62c:	.string "UsbGetInterface: bad pid\0"
__Lstrings+0x645:	.string "SUSPEND not supported\0"
__Lstrings+0x65b:	.string "UsbSetDescription: not implemented\0"
__Lstrings+0x67e:	.string "UsbSetFeature: not CLR_ENDPOINT\0"
__Lstrings+0x69e:	.string "UsbClearFeature: not CLR_ENDPOINT\0"
__Lstrings+0x6c0:	.string "UNEXPECTED BIT IN INT_STAT\0"
__Lstrings+0x6db:	.string "UsbGetConfig Bad PID\0"
__Lstrings+0x6f0:	.string "UsbGetStatus: Bad PID\0"
__Lstrings+0x706:	.string "PrinterClassSetup: Bad PID\0"
__Lstrings+0x721:	.string "UsbGetDescription: Bad PID\0"
__Lstrings+0x73c:	.string "UsbSetConfig: Bad PID\0"
__Lstrings+0x752:	.string "USC:Addr=\0"
__Lstrings+0x75c:	.string " Actual=\0"
__Lstrings+0x765:	.string "pid=\0"
__Lstrings+0x76a:	.string "\r\n"
		.string "\aERROR:USB Failed BIST\r\n"
		.string "\aExpected=\0"
__Lstrings+0x78f:	.string "I=\0"
__Lstrings+0x792:	.string "!=\0"
__Lstrings+0x795:	.string "\a\r\n"
		.string "Error:\0"
__Lstrings+0x79f:	.string "\aError:\0"
__Lstrings+0x7a7:	.string "UsbSetAddress: not In Data1\0"
__Lstrings+0x7c3:	.string "UsbSetFeature: wValue not 0\0"
__Lstrings+0x7df:	.string "UsbClearFeature: wValue not 0\0"
__Lstrings+0x7fd:	.string "UsbAddress: EP not 0\0"
__Lstrings+0x812:	.string " - stalling\r\n\0"
__Lstrings+0x820:	.string "Attach ignored\r\n\0"
__Lstrings+0x831:	.string " - USB Buffer not OWNed\r\n\0"
__Lstrings+0x84b:	.string "UsbConfig: BDT owned by host\r\n"
		.string "\a\0"
__Lstrings+0x86b:	.string "Ready to download\r\n\0"

.org 0xf000
_MainMenuString:	.byte 0x4d
_MainMenuString+0x1:	.string "ain Menu Nov 17 1999 12:01:44\r\n\0"
_A_TABLE:	.byte 0xa0
		.byte 0xa0
		.byte 0x9f
		.byte 0x9f
...
_USB_DEBUG+0xf1:	.byte 0x00
		...
		.byte 0x8e
		.byte 0xf1
_USB_DEBUG+0x126:	.byte 0xb9
_USB_DEBUG+0x127:	.byte 0xf1
...
Aa_UsbVendSetEndPoint+0x1:
	.org 0xf82b
Aa_UsbVendSetEndPoint+0x2:
	.org 0xf82c
Aa_UsbVendSetEndPoint+0x3:
	.org 0xf82d
Aa_HostSetNextInBdt:
	.org 0xf82e
A_UsbSendIn:
