...
--
-- Description:
--	VHDL entity for the TI ti21lv03 IEEE-1394 Physical Layer
...
-- Revision History
-- $Log: ti21lv03.vhd,v $
-- Revision 1.1  1998/04/03 17:54:23  eric
-- Initial revision
--
--------------------------------------------------------------------------------
library ieee, std;
...
attribute package_type of ti21lv03 : ENTITY is "ti21lv03@LQFP64";

-- TI ti21lv03SSOP56 power and ground pin assignments
attribute GND_pins : string_array;

--Analog and digital grounds combined

attribute GND_pins of ti21lv03 : entity is ("8 ","10","17","18","26","32","41",
                                            "49","50","52","53","61","63","64");

-- I/O pin assignments
attribute pin_number of reset_n    : signal is  "1 ";
attribute pin_number of lps        : signal is  "2 ";
attribute pin_number of lreq       : signal is  "3 ";
attribute pin_number of dvdd4      : signal is  "4 ";
attribute pin_number of dvdd5      : signal is  "5 ";
attribute pin_number of dvdd6      : signal is  "6 ";
attribute pin_number of pd         : signal is  "7 ";
-- DGND			        		 8
attribute pin_number of sysclk     : signal is  "9 ";
-- DGND			        		 10
attribute pin_number of ctl0       : signal is  "11";
attribute pin_number of ctl1       : signal is  "12";
attribute pin_number of d0         : signal is  "13";
attribute pin_number of d1         : signal is  "14";
attribute pin_number of d2         : signal is  "15";
attribute pin_number of d3         : signal is  "16";
-- DGND			        		 17
-- DGND			        		 18
attribute pin_number of dvdd19     : signal is  "19";
attribute pin_number of dvdd20     : signal is  "20";
attribute pin_number of testm2     : signal is  "21";
attribute pin_number of testm1     : signal is  "22";
attribute pin_number of cps        : signal is  "23";
attribute pin_number of avdd24     : signal is  "24";
attribute pin_number of avdd25     : signal is  "25";
-- AGND						 26
attribute pin_number of c_lokon    : signal is  "27";
attribute pin_number of pc0        : signal is  "28";
attribute pin_number of pc1        : signal is  "29";
attribute pin_number of pc2        : signal is  "30";
attribute pin_number of cna        : signal is  "31";
-- AGND						 32
attribute pin_number of tpb3_n     : signal is  "33";
attribute pin_number of tpb3       : signal is  "34";
attribute pin_number of tpa3_n     : signal is  "35";
attribute pin_number of tpa3       : signal is  "36";
attribute pin_number of tpb2_n     : signal is  "37";
attribute pin_number of tpb2       : signal is  "38";
attribute pin_number of tpa2_n     : signal is  "39";
attribute pin_number of tpa2       : signal is  "40";
-- AGND						 41
attribute pin_number of tpb1_n     : signal is  "42";
attribute pin_number of tpb1       : signal is  "43";
attribute pin_number of tpa1_n     : signal is  "44";
attribute pin_number of tpa1       : signal is  "45";
attribute pin_number of tpbias1    : signal is  "46";
attribute pin_number of tpbias2    : signal is  "47";
attribute pin_number of tpbias3    : signal is  "48";
-- AGND						 49
-- AGND						 50
attribute pin_number of avdd51     : signal is  "51";
-- PLLGND					 52
-- PLLGND					 53
attribute pin_number of filter     : signal is  "54";
attribute pin_number of avdd55     : signal is  "55";
attribute pin_number of xi         : signal is  "56";
attribute pin_number of xo         : signal is  "57";
attribute pin_number of pllvdd     : signal is  "58";
attribute pin_number of r0         : signal is  "59";
attribute pin_number of r1         : signal is  "60";
-- AGND						 61
attribute pin_number of iso_n      : signal is  "62";
-- DGND						 63
-- DGND						 64

end ti21lv03;

ARCHITECTURE empty OF ti21lv03 IS

BEGIN -- empty
	filter     <= 'Z';    -- PLL filter I/O pin to external filter
        cna        <= '0';    -- Cable not Active output
	sysclk     <= '0';    -- serial clock to link
	ctl0       <= 'Z';    -- link interface control 0
	ctl1       <= 'Z';    -- link interface control 1
	d0         <= 'Z';    -- link interface data 0
	d1         <= 'Z';    -- link interface data 1
	d2         <= 'Z';    -- link interface data 2
	d3         <= 'Z';    -- link interface data 3
	c_lokon    <= 'Z';    -- configuration manager contender input or link on output
	tpbias1    <= '0';    -- bias voltage output
	tpbias2    <= '0';    -- bias voltage output
	tpbias3    <= '0';    -- bias voltage output
	r0         <= '0';    -- external bias resistor pin
	tpb3_n     <= 'Z';    -- Port 3 B-
	tpb3       <= 'Z';    -- Port 3 B+
	tpa3_n     <= 'Z';    -- Port 3 A-
	tpa3	   <= 'Z';    -- Port 3 A+
...
END empty;  -- of ti21lv03
-- architecture behavioral of ti21lv03 is
...
--             assert terse report "Tx Broadcast packet forwarded by ti21lv03"
--               severity NOTE;
--             ctlst <= idle;
--             arb_reset_gap <= false;
--           elsif ((packet_data(4) AND "11110000") = "10000000") then -- cycle start echo
--             assert terse report "Tx Cycle Start packet forwarded by ti21lv03"
--               severity NOTE;
--             ctlst <= idle;
--             arb_reset_gap <= false;
--           elsif ((packet_data(4) AND "11110000") = "10100000") then -- iso packet echo
--             assert terse report "Tx Isochronous packet forwarded by ti21lv03"
--               severity NOTE;
--             ctlst <= idle;
--             arb_reset_gap <= false;
--           else
--             ctlst <= tx_ackw;
--             assert terse report "Tx Asynchronous packet forwarded by ti21lv03"
--               severity NOTE;
--           end IF;
...
--           assert terse report "Rx Broadcast packet forwarded by ti21lv03"
--             severity NOTE;
--           ctlst <= idle;
--           arb_reset_gap <= false;
--         elsif (iso_packet) then
--           assert terse report "Rx Isochronous packet forwarded by ti21lv03"
--             severity NOTE;
--           ctlst <= idle;
--           arb_reset_gap <= false;
--         elsif (cyc_strt_packet) then
--           assert terse report "Rx Cycle Start packet forwarded by ti21lv03"
--             severity NOTE;
--           ctlst <= idle;
--           arb_reset_gap <= false;
--         elsif arb_reset_gap then
--           assert now < 1 ns report "Receive Ack timeout detected by ti21lv03"
--             severity FAILURE;
--           ctlst <= idle;
--           arb_reset_gap <= false;
--         end if;
