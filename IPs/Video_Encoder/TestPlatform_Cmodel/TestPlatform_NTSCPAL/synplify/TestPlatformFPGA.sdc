...
# D:\data\NTSC_PAL\TestPlatform2\synplify\TestPlatformFPGA.sdc
# Written on Tue Nov 28 21:20:24 2006
...
# Clocks
#
define_clock            -name {Clock}  -freq 60.000 -clockgroup default_clkgroup_0
define_clock            -name {Clock2}  -freq 55.000 -clockgroup default_clkgroup_2
define_clock            -name {i:Core.ClockResetGen.BUSClk_reg}  -freq 30.000 -clockgroup default_clkgroup_0
define_clock            -name {i:Core.ClockResetGen.APBClk_div}  -freq 30.000 -clockgroup default_clkgroup_0
