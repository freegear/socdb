...
create_relative_clock -base_clock Clock_setting -multiply 4285 -divide 1000 -duty_cycle 50.00 |TestPlatformCore:Core|MMCTop:MMCTop|mmc_Prescaler:Prescaler|MMC_CLKOUT_c_setting -target |TestPlatformCore:Core|MMCTop:MMCTop|mmc_Prescaler:Prescaler|MMC_CLKOUT_c -disable
...
create_relative_clock -base_clock Clock_setting -multiply 2 -divide 1 -duty_cycle 50.00 |TestPlatformCore:Core|ClockResetGen_1s_1s_0_500000_1s:ClockResetGen|SD_CLK_c_setting -target |TestPlatformCore:Core|ClockResetGen_1s_1s_0_500000_1s:ClockResetGen|SD_CLK_c -disable
create_base_clock Clock2_setting -fmax 55.0mhz -duty_cycle 50.00 -target Clock2 -disable
create_base_clock Clock_setting -fmax 60.0mhz -duty_cycle 50.00 -target Clock -disable
