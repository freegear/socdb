...
input 			DnScaleEn;
input 			UpScaleEn;
input [VW:0]	ScaleInXSize;
input [VW:0]	ScaleInYSize;
...
reg [VW:0]		ScaleOutXCount;
reg [VW:0]		ScaleOutYCount;
wire			ScaleOutXEnd;
wire			ScaleOutXInc;
wire			ScaleOutYEnd;
...
wire [VW+1:0] UpScaleXTSize = VPlaneXSize+16;
