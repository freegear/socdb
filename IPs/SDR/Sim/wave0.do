...
add wave -noupdate -format Logic /TbSDR/SDRTop/SDRCtl/SmallQSz
...
WaveRestoreCursors {{Cursor 1} {152636014 ps} 0} {{Cursor 2} {140878543981 ps} 0} {{Cursor 3} {2704766250 ps} 0} {{Cursor 6} {6079923750 ps} 0}
...
update
WaveRestoreZoom {151493562 ps} {153688583 ps}
