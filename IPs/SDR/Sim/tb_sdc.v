...
assign #SDLY SDdati = SDdat;

assign SDclk  = ACLK;

wire #SDLY FDClk  = ACLK;
...
// Different Bank & Row
  DataEn = 1'b1;
`ifdef MISS
  AXIWriteCmd(32'h000003F4, 7, 0, 1);
`else
  AXIWriteCmd(32'h0000000C, 7, 0, 2);
`endif
`ifdef MISS
  AXIWriteCmd(32'h010023F8, 3, 1, 1);
`else
  AXIWriteCmd(32'h01002018, 3, 1, 2);
`endif
...
// Same Bank & Row
  AXIWriteCmd(32'h00000050, 3, 4, 1);
  AXIWriteCmd(32'h00000064, 3, 5, 2);
  AXIWriteCmd(32'h00000020, 3, 6, 1);
  AXIWriteCmd(32'h00000030, 3, 7, 1);

// Mix Single/Burst
  AXIWriteCmd(32'h00010000, 7, 8, 1);
  AXIWriteCmd(32'h00020000, 0, 9, 1);

  // DQM Mask Test
  AXIWriteCmd(32'h00030000, 7, 10, 1);
end
endtask
...
begin
// Different Bank & Row
  AXIWriteData(7, 2'b0, 32'h00001110, 0);
  AXIWriteData(3, 2'b0, 32'h00002220, 1);
...
// Same Bank & Row
  AXIWriteData(3, 2'b0, 32'h00009990, 4);
  AXIWriteData(3, 2'b0, 32'h0000aaa0, 5);
  AXIWriteData(3, 2'b0, 32'h0000bbb0, 6);
  AXIWriteData(3, 2'b0, 32'h0000ccc0, 7);

// Mix Single/Burst
  AXIWriteData(7, 2'b0, 32'h0000ddd0, 8);
  AXIWriteData(0, 2'b0, 32'h0000eeee, 9);

  // DQM Mask Test
  AXIWriteData(7, 2'b0, 32'h0000fff0, 10);
  DataEn = 1'b0;
end
endtask
...
// Different Bank & Row
`ifdef MISS
  AXIReadCmd(32'h000003F4, 7, 0, 1);
  AXIReadCmd(32'h010023F8, 3, 1, 1);
`else
  AXIReadCmd(32'h0000000C, 7, 0, 2);
  AXIReadCmd(32'h01002018, 3, 1, 2);
`endif
...
// Same Bank & Row
  AXIReadCmd(32'h00000050, 3, 4, 1);
  AXIReadCmd(32'h00000060, 3, 5, 1);
  AXIReadCmd(32'h00000020, 3, 6, 1);
  AXIReadCmd(32'h00000030, 3, 7, 1);

// Mix Single/Burst
  AXIReadCmd(32'h00010000, 3, 8, 1);
  AXIReadCmd(32'h00020000, 0, 9, 1);

  // DQM Mask Test
  AXIReadCmd(32'h00030000, 7, 10, 1);
end
endtask
//--------------------------------------------------
// Initialize
