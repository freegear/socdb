...
always @(negedge PRESETB or posedge PCLK)
	if (!PRESETB)	AllRasUpEn  <= 1;
	else if (Reg4Wr)AllRasUpEn  <= PWDATA[0]; 
...
wire [31:0] Reg4Data = {20'b0, RQFull, WQFull, selfref_cnt, stable_cnt, SDRBusy, AllRasUpEn};
