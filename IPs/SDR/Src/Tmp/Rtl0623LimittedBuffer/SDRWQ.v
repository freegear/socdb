...
module SDRWQ (nRST, Clk, WriteEn, ReadEn, WrData, RdData, FullFlag, HFullFlag, EmptyFlag, 
			  WrapEn, WrapCnt, IncRdCnt);
...
//wire [WQCD:0] RdCnt = WrapEn ? WrapCnt : IncRdCnt;
...
assign FullFlag  =  &DatCnt;//[WQCD:1] & ~DatCnt[0];
assign HFullFlag =   DatCnt[WQCD];
