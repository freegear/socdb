...
parameter WQCD  = 8 -1;			// Q Count Depth
parameter WQD   = 256 -1;			// Q Depth (Command Depth * Maximum Burst(16) * 2)
parameter WQW   = (DW+1) + (BW+1) -1;	// Q Width

// Read Data Que Define
parameter RQCD  = 8 -1;			// Q Count Depth
parameter RQD   = 256 -1;			// Q Depth(Command Depth * Maximum Burst(16) * 2)
...
parameter RBLQCD  = 4 -1;
parameter RBLQD   = 16 -1;
...
parameter CD = 5  -1;			// Q Count Depth
