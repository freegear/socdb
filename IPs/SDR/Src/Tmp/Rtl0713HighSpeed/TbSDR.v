...
//  APBWrite(32'h00000010, 32'h0000_0001); // Always RAS Queue Update Enable when Scheduled Memory Access 
//  APBWrite(32'h00000010, 32'h0000_0000); // Needed RAS Queue Update Enable when Scheduled Memory Access 
//  APBWrite(32'h00000010, 32'h0000_0002); // Small Que and Needed RAS Queue Update Enable when Scheduled Memory Access 
  APBRead(10'h000);
  APBRead(10'h004);
  APBRead(10'h008);
  APBRead(10'h00C);
...
wire SampleCountEn = Count[10] & $random;
