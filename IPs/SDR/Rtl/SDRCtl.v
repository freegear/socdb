...
output 			DiValid;
output 			DoValid;
output 			QueEmp;	// RAS/CAS Queue Empty
output 			QueFul;	// RAS/CAS Queue Full
output 			QueErr;	// RAS/CAS Queue Error
output 			RdLast;
output [ID:0] 	RdId;
output [ID:0] 	WrId;
output 			Port16Bit;
...
assign QueEmp  = cmd_empty;	// RAS/CAS Queue Empty
assign QueFul  = cmd_full | cmd_mask;	// RAS/CAS Queue Full
assign QueErr  = BA_REQ &  cmd_full_d;	// RAS/CAS Queue Error
assign RdLast  = bf_last;
assign RdId = do_id;
assign WrId = di_id;
assign Port16Bit = Port16BitSel;
assign olAddrSiz = ColAddrSiz;
