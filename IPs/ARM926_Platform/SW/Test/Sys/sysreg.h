...
#define ESMC_B0_CON     	(*(volatile unsigned *)(ESMC_BASE_ADDR+0x00))
#define ESMC_B1_CON     	(*(volatile unsigned *)(ESMC_BASE_ADDR+0x04))
#define ESMC_B2_CON     	(*(volatile unsigned *)(ESMC_BASE_ADDR+0x08))
#define ESMC_B3_CON     	(*(volatile unsigned *)(ESMC_BASE_ADDR+0x0C))
...
#define GPALM				(*(volatile unsigned *)(DM_BASEADDR+0x064))
