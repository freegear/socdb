 ...
 * but I'm not sure __irq supports static function.
 */
__irq void IsrEINT0(void);
__irq void IsrEINT1(void);
__irq void IsrEINT2(void);
__irq void IsrEINT3(void);
__irq void IsrIIC0(void);
__irq void IsrIIC0_AAS(void);
__irq void IsrTIMER0_TOF(void);
__irq void IsrTIMER0_TMC(void);
__irq void IsrTIMER1_TOF(void);
__irq void IsrTIMER1_TMC(void);
__irq void IsrTIMER2_TOF(void);
__irq void IsrTIMER2_TMC(void);
__irq void IsrEINT4(void);
__irq void IsrEINT5(void);
__irq void IsrEINT6(void);
__irq void IsrEINT7(void);
__irq void IsrIIC1(void);
__irq void IsrIIC1_AAS(void);
__irq void IsrWDT(void);
__irq void IsrADC(void);
__irq void IsrUTX(void);
__irq void IsrURX(void);
__irq void IsrTIMER3_TOF(void);
__irq void IsrTIMER3_TMC(void);
__irq void IsrTIMER4_TOF(void);
__irq void IsrTIMER4_TMC(void);
__irq void IsrTIMER5_TOF(void);
__irq void IsrTIMER5_TMC(void);
__irq void IsrTIMER6_TOF(void);
__irq void IsrTIMER6_TMC(void);
__irq void IsrTIMER7_TOF(void);
__irq void IsrTIMER7_TMC(void);
