...
wire [31:0] Reg1Data = {16'b0, XasQBug, 7'b0, RdDataPol, RdDataInSel, ColAddrSiz, 2'b0, AddrSwapDis, SDREnStatus};
...
assign BA_STS[10]  = dqs_request;
assign BA_STS[12:11] = ColAddrSiz;
assign BA_STS[13]    = RdDataInSel;
assign BA_STS[14]    = RdDataPol;

assign i_ba_req  = BA_REQ & ~cmd_full_d;
//assign rs_read   = tcl + rs_write + 3'b011; // "read_precharge_truncation" ddr model, Further Study, DDR Burst4
...
//		tclp     = 2;
    	...
    	case(ercmd)
    	  	erc_idle    : pttn  = cmd_nop;
    	  	erc_powerup : pttn  = cmd_nop;
    	  	erc_epc :
    	  	begin
    	  	  	pttn    = cmd_precharge;
    	  	  	SD_ADDR[10] <= 1;
...
begin
	...
	else if (SDREnStatus & SDRBusy & do_valid & ((tclp==2 & di_request) | (tclp==3 & di_request_d1))) begin
		RWCollision0 <= 1'b1;
	end
	else begin
		RWCollision0 <= 1'b0;
