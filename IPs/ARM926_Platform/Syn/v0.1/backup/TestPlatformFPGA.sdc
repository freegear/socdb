...
# Written on Mon Nov 27 16:55:07 2006
...
# Clocks
#
define_clock            -name {Clock}  -freq 100.000 -clockgroup default_clkgroup_0
define_clock            -name {i:Core.ClockResetGen.BUSClk_reg}  -freq 50.000 -clockgroup default_clkgroup_0
define_clock            -name {i:Core.ClockResetGen.APBClk_div}  -freq 50.000 -clockgroup default_clkgroup_0
...
define_clock            -name {i:Core.MMCTop.Prescaler.MMC_CLK}  -freq 50.000 -clockgroup default_clkgroup_0
define_clock            -name {i:Core.LCDClk}  -freq 50.000 -clockgroup default_clkgroup_0
define_clock            -name {i:Core.ClockResetGen.CPUClk_reg}  -freq 50.000 -clockgroup default_clkgroup_0
