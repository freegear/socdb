...
action vlog +incdir+$MDFY_ARM926 $RTL_PATH/ARMWrap/arm926_axi.v
...
# Top
action vlog +incdir+$MDFY_ARM926 $RTL_PATH/Top/TestPlatformCore.v
action vlog +incdir+$RTL_PATH/Top+$MDFY_ARM926 $RTL_PATH/Top/TestPlatformFPGA.v

# Test Bench Compile
action vlog $MOD_PATH/eprom16bit.v
action vlog $MOD_PATH/ddr.v

action vlog +incdir+$RTL_PATH/Top+$MDFY_ARM926 $RTL_PATH/Top/tb.v
