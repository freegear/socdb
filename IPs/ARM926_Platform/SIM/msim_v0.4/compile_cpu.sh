...
COM_INC_PATH=$ARM_MEM_RTL_PATH/4funcsim
MAIN_ARM926=$ARM_MEM_RTL_PATH2/MAIN_ARM926EJS
MDFY_ARM926=$ARM_MEM_RTL_PATH/ARM926EJS
MDFY_CACHE=$ARM_MEM_RTL_PATH/Cache
MDFY_MMU=$ARM_MEM_RTL_PATH/MMU

# CPU

# ARM9EJS directory
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsJDec.v  
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsJInBuf.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsJNullPtr.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsJStack.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsClkBlk.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsWRegDecoder.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsREG.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsFwd.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsRegC.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsIMM.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsIPipe.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsISyncr.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsMASeq.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsMainSeq.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsMem.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsPSR.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsPipeCtl.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsRegFwd.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsShALUADec.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsShALUTDec.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsShALUSeq.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsShALUCtl.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsWRegDec.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsMulCtl.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsCoreCtl.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsLU.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsSat.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsAU.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsArmShifter.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsShifter.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsSatTimes2.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsCLZ.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsExecute.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsRam3r2wSDff.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsRegBank.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsMulDP.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsCoreDP.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsWptctl.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsDbgCommsctl.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsICEctl.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsTapScanctl.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsDbgctl.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsWptdp.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsDbgCommsdp.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsICEdp.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsTapScandp.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsDbgdp.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsDbg.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsAGU.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/a9ejsJArrayBndChk.v
action vlog +incdir+$ARM_RTL_PATH/ARM9EJS $ARM_RTL_PATH/ARM9EJS/ARM9EJS.v
...
action vlog +incdir+$ARM_RTL_PATH/Cache $ARM_RTL_PATH/Cache/a926DataCache.v
action vlog +incdir+$ARM_RTL_PATH/Cache $ARM_RTL_PATH/Cache/a926InstrCache.v
...
action vlog +incdir+$ARM_RTL_PATH/MMU $ARM_RTL_PATH/MMU/a926ejsUTLB.v
...
# ARM926EJS directory
action vlog +incdir+$MAIN_ARM926 $ARM_RTL_PATH/ARM926EJS/dummy_buffer.v
action vlog +incdir+$MAIN_ARM926 $ARM_RTL_PATH/ARM926EJS/a926ejsClkBlk.v
action vlog +incdir+$MAIN_ARM926 $ARM_RTL_PATH/ARM926EJS/a926ejsDRoute.v
action vlog +incdir+$MAIN_ARM926 $ARM_RTL_PATH/ARM926EJS/a926ejsIRoute.v
action vlog +incdir+$MAIN_ARM926 $ARM_RTL_PATH/ARM926EJS/a926ejsSysCtl.v
action vlog +incdir+$MAIN_ARM926 $ARM_RTL_PATH/ARM926EJS/a926ejsFCSE.v
action vlog +incdir+$MAIN_ARM926 $ARM_RTL_PATH/ARM926EJS/ARM9EJSwrap.v
action vlog +incdir+$MAIN_ARM926 $ARM_RTL_PATH/ARM926EJS/a926ejsClkGate.v
action vlog +incdir+$MAIN_ARM926 $ARM_RTL_PATH/ARM926EJS/TestWrapper.v
action vlog +incdir+$MAIN_ARM926 $ARM_RTL_PATH/ARM926EJS/ARM926EJSCore.v
...
action vlog $MAIN_ARM926/DirtyRam8k.v
...
#####################################
MEMaLIB=$ARM_MEM_RTL_PATH2/MEM/LIB
# cache ram
action vlog $MEMaLIB/DDataRam8k.v
action vlog $MEMaLIB/DataRamPrim.v
action vlog $MEMaLIB/DirtyRamPrim.v
action vlog $MEMaLIB/ITagRam8k.v
action vlog $MEMaLIB/DTagRam8k.v
action vlog $MEMaLIB/DirtyRam8ka.v
action vlog $MEMaLIB/IDataRam8k.v
action vlog $MEMaLIB/ValidRam4k.v

# mmu ram
action vlog $MEMaLIB/MMURam30.v
action vlog $MEMaLIB/MMURam26.v


#BIST
action vlog +incdir+$MAIN_ARM926                               $MAIN_ARM926/a926ejsBIST.v
action vlog +incdir+$MAIN_ARM926                               $MAIN_ARM926/a926ejsBISTComp.v
action vlog +incdir+$MAIN_ARM926                               $MAIN_ARM926/a926ejsBISTDC.v
action vlog +incdir+$MAIN_ARM926                               $MAIN_ARM926/a926ejsBISTIC.v
action vlog +incdir+$MAIN_ARM926                               $MAIN_ARM926/a926ejsBISTTAP.v

#synopsys DW
#DW_PATH=../../../synopsys_dw
#action vlog         $DW_PATH/dw04/src_ver/DW_tap.v
action vlog         $MAIN_ARM926/DW/DW_tap.v


action vlog                                                    $MAIN_ARM926/jtag_sync.v
action vlog +incdir+$MAIN_ARM926                               $MAIN_ARM926/ARM926EJS_8K8K-S.v
#action vlog +incdir+$MAIN_ARM926                               $MAIN_ARM926/ARM926EJS_BIST_8K8K-S.v
...
action vlog +incdir+$MAIN_ARM926                               $ARM_RTL_PATH/ARM926EJS/a926ejsSysDebug.v
