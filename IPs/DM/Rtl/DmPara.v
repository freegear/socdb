...
parameter IW = 2 -1;	// ID Width
parameter BW = 4 -1;

// Image Size
parameter XW = 11 -1;	// Display X Width
parameter YW = 11 -1;	// Display Y Width
parameter CW = 10 -1;	// Cursor Width
parameter GW = 11 -1;	// Graphic Width
parameter VW = 11 -1;	// Video Width
...
// Cursor Plane
parameter CCON    	= 10'h10;  
parameter CBLND   	= 10'h14;  
parameter CBMOD   	= 10'h18;  
parameter CBASE   	= 10'h1C; 

parameter CADDR   	= 10'h20;  
parameter CPALA   	= 10'h24;
parameter CPALM   	= 10'h28;
parameter CADDR2  	= 10'h38;  
parameter CBLINK   	= 10'h3C;  

// BackGround
parameter BGCOL   	= 10'h30;  

// Graphic Plane
parameter GCON    	= 10'h40;  
parameter GBLND   	= 10'h44;  
parameter GBMOD   	= 10'h48;  
parameter GBASE   	= 10'h4C;  

parameter GADDR   	= 10'h50;  
parameter GPALA   	= 10'h54;  
parameter GPALM   	= 10'h58;  
...
// Video Plane
parameter VCON    	= 10'h60;        
parameter VBLND   	= 10'h64;   
parameter VBMOD   	= 10'h68;   
parameter VBASE   	= 10'h6C;

parameter VADDR   	= 10'h70;   
parameter VADDR2  	= 10'h74;

// Video Scaler
parameter SCON    	= 10'h80;
parameter SSIZE   	= 10'h84;   
parameter SRATIO  	= 10'h88; 
