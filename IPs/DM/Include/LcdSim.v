...
wire [ 2:0]	GPlanePixFormat = 4;		// 0: 8bit, 2: RGB565, 3:ARGB1555, 4:RGB888, 5:ARGB8888
...
//`else
wire		VPlaneInterlaceEn = 0; // Interlace Source Video to Progressive Display
`ifdef PAL
...
wire       	LCDEn = 0;
`ifdef NTSC
wire [ 7:0] LCDHFP = 0;//63*2;	// HFP+HBP = 80(720-640)
wire [ 7:0] LCDHBP = 0;//17*2;
wire [ 8:0] LCDHSW = 138*2;			// 1716
wire [10:0] LCDCPL = LCDXSize*2;	//1440
wire [ 5:0] LCDVSW = 3;
wire [10:0] LCDLPS = LCDYSize;
wire [ 7:0] LCDVBP = 18-10;
wire [ 7:0] LCDVFP = 1+10;
wire       	LCDIVS = 0;         
wire       	LCDIHS = 0; 
...
wire [ 7:0] LCDHFP = 0;//63*2;	// HFP+HBP = 80(720-640)
wire [ 7:0] LCDHBP = 0;//17*2;
wire [ 8:0] LCDHSW = (138+6)*2;		// 1728
wire [10:0] LCDCPL = LCDXSize*2;	// 1440
wire [ 5:0] LCDVSW = 3;
wire [10:0] LCDLPS = LCDYSize;
wire [ 7:0] LCDVBP = 20-10;
wire [ 7:0] LCDVFP = 1+10;
wire       	LCDIVS = 0;         
wire       	LCDIHS = 0; 
wire       	LCDIEO = 0;         
