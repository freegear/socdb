...
enum attr_type {TYPE_UNKNOWN, TYPE_LOAD, TYPE_STORE, TYPE_MOVE, TYPE_EXTEND, TYPE_LOGIC, TYPE_ADD, TYPE_MUL, TYPE_SHIFT, TYPE_COMPARE, TYPE_BRANCH, TYPE_JUMP, TYPE_FP};
...
#define MAX_ISSUE_DELAY 16
#define MIN_BLOCKAGE 1
#define MAX_BLOCKAGE 16
