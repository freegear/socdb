...
const unsigned short mode_precision[NUM_MACHINE_MODES] =
{
  ...
  4*BITS_PER_UNIT,         /* CCNE */
  4*BITS_PER_UNIT,         /* CCLE */
  4*BITS_PER_UNIT,         /* CCGE */
  4*BITS_PER_UNIT,         /* CCLT */
  4*BITS_PER_UNIT,         /* CCGT */
  4*BITS_PER_UNIT,         /* CCLEU */
  4*BITS_PER_UNIT,         /* CCGEU */
  4*BITS_PER_UNIT,         /* CCLTU */
  4*BITS_PER_UNIT,         /* CCGTU */
...
#define MODE_MASK(m)                          \
  ...
  MODE_MASK (4*BITS_PER_UNIT),   /* CCNE */
  MODE_MASK (4*BITS_PER_UNIT),   /* CCLE */
  MODE_MASK (4*BITS_PER_UNIT),   /* CCGE */
  MODE_MASK (4*BITS_PER_UNIT),   /* CCLT */
  MODE_MASK (4*BITS_PER_UNIT),   /* CCGT */
  MODE_MASK (4*BITS_PER_UNIT),   /* CCLEU */
  MODE_MASK (4*BITS_PER_UNIT),   /* CCGEU */
  MODE_MASK (4*BITS_PER_UNIT),   /* CCLTU */
  MODE_MASK (4*BITS_PER_UNIT),   /* CCGTU */
