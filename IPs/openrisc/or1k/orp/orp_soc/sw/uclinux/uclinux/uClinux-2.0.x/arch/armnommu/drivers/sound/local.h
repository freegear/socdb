...
#	define CONFIG_UART401
  ...
  defined(CONFIG_SSCAPE) || defined(CONFIG_TRIX) || \
  defined(CONFIG_MAD16) || defined(CONFIG_CS4232) || \
  defined(CONFIG_MAUI) || defined(CONFIG_VIDC) || \
  defined(CONFIG_MIDI)
#	define CONFIG_SEQUENCER
#endif

#define SOUND_CONFIG_DATE "Sat Jan 9 10:54:00 GMT 1999"
#define SOUND_CONFIG_BY "src"
#define SOUND_UNAME_A "Linux raistlin 2.0.35 #6 Sun Nov 22 09:51:39 GMT 1998 sa110 unknown"
