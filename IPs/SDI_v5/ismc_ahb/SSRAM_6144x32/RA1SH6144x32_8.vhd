...
--
--      Instance:       RA1SH6144x32_8
--      Address Length: 6144
--      Word Width:     32
--      Pipeline:       No
--
--      Creation Date:  2006-02-22 01:44:59Z
--      Version:        2002Q2V0
--
...
Package RA1SH6144x32_8_pkgs is
  component rdwr_RA1SH6144x32_8
    generic(
...
use WORK.RA1SH6144x32_8_pkgs.all;

  entity rdwr_RA1SH6144x32_8 is
    generic(
	TimingChecksOn: BOOLEAN := TRUE;
	tperiod_CLK  : VitalDelayType;
	tpw_CLK_negedge: VitalDelayType;
    ...
    attribute VITAL_LEVEL1 of rdwr_RA1SH6144x32_8 : entity is TRUE;
end rdwr_RA1SH6144x32_8;

-------------- -------------- -------------- -------------- --------------
architecture BEHAVIORAL of rdwr_RA1SH6144x32_8 is
  constant ClkPort	: string:=cat("CLK",PortName);
  constant InstPort	: string:="RA1SH6144x32_8";
...
use WORK.RA1SH6144x32_8_pkgs.all;
  ...
  entity RA1SH6144x32_8 is
    ...
    attribute VITAL_LEVEL1 of RA1SH6144x32_8 : entity is TRUE;
end RA1SH6144x32_8;

-----------------------------------------------------------------------------
architecture Structural of RA1SH6144x32_8 is
  signal MEM: MEM_TYPE(6143 downto 0, 31 downto 0);
