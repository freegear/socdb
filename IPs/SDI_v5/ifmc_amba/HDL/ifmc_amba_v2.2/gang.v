...
`endif      
   ...
   task addr_phase;
	  ...
	  begin
		 ...
		 if(rd_wr == 1 ) begin
			...
			// start signal
			#(`SRD_HCLK/2) sda_in = 0;
			#(`SRD_HCLK*100/2) scl = 1'b1;
			#(`SRD_HCLK*100/2) sda_in = 1;
			#(`SRD_HCLK*100/2) scl = 1'b0;
			
			// reg/mem
			#(`SRD_HCLK*100/2) sda_in = mode[2]; // reg/mem
			#(`SRD_HCLK*100/2) scl = 1'b1;
			#(`SRD_HCLK)   scl = 1'b0;
   ...
   task chip_erase;
	  begin
			// start signal
			#(`SWR_HCLK*100/2) sda_in =        0;
			#(`SWR_HCLK*100/2) scl = 1'b1;
			#(`SWR_HCLK*100/2) sda_in =        1;
			#(`SWR_HCLK*100/2) scl = 1'b0;
			
			// reg/mem
			#(`SWR_HCLK*100/2) sda_in =        1; // reg/mem
			#(`SWR_HCLK*100/2) scl = 1'b1;
			#(`SWR_HCLK)   scl = 1'b0;
