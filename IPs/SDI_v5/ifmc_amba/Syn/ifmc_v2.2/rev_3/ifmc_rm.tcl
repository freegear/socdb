...
if {[cmp get_assignment_value "fpga_fmc" "" "" DEVICE] !=  ""} {
  cmp remove_assignment "fpga_fmc" "" "" DEVICE ""
}
if {[project get_assignment_value "" "clk_setting" "" "" "DUTY_CYCLE"] != ""} {
  project remove_assignment "" "clk_setting" "" "" "DUTY_CYCLE" ""
}
if {[project get_assignment_value "fpga_fmc" "" "" "clk" "GLOBAL_SIGNAL"] !=  ""} {
  project remove_assignment "fpga_fmc" "" "" "clk" "GLOBAL_SIGNAL" ""
}
if {[project get_assignment_value "fpga_fmc" "" "" "clk" "USE_CLOCK_SETTINGS"] != ""} {
  project remove_assignment "fpga_fmc" "" "" "clk" "USE_CLOCK_SETTINGS" ""
}
