...
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/ifmc_serial/ifmc_ptsm/cnt0
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/ifmc_serial/ifmc_ptsm/cnt1
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/ifmc_serial/ifmc_ptsm/cnt2
...
WaveRestoreCursors {{Cursor 1} {706334620 ps} 0} {{Cursor 2} {850903160 ps} 0}
...
update
WaveRestoreZoom {1565391760 ps} {1775338430 ps}
