...
quietly virtual signal -install /Atb_fmc/Top/fmcore { /Atb_fmc/Top/fmcore/XADR[9:2]} PageNum
...
add wave -noupdate -divider {FM Reader}
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/clk
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/rstb
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/ahb_sel
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/ahb_readyin
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/ahb_trans
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/ahb_addr
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/ahb_write
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/ahb_size
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/ahb_rdata
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/ahb_ready
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/ahb_resp
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/fmr_rd
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/fmr_rdata
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/fmb_ready_1cb
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/ahb_start
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/dphase
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/t_addr
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/t_write
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/fmb_ready
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/cs
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/ns
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/sm_idle
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/sm_wait_ed_wr
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/sm_fmr_rd
add wave -noupdate -format Logic -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_rd/sm_end_rd
...
add wave -noupdate -format Literal /Atb_fmc/Top/ifmc_bus/fmr_adr
...
add wave -noupdate -format Logic -radix binary /Atb_fmc/Top/ifmc_bus/fm_rdmode
add wave -noupdate -format Logic -radix binary /Atb_fmc/Top/ifmc_bus/fm_wrmode
...
add wave -noupdate -format Literal -radix hexadecimal /Atb_fmc/Top/fmcore/PageNum
...
add wave -noupdate -color Orange -format Literal -itemcolor Orange -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_wr/fmw_adr
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_wr/fmw_xe
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_wr/fmw_ye
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_wr/fmw_se
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_wr/fmw_erase
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_wr/fmw_mas1
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_wr/fmw_prog
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_wr/fmw_nvstr
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_fmc/Top/ifmc_bus/ifmc_wr/fmw_ifren
...
add wave -noupdate -format Literal -radix decimal /Atb_fmc/Top/ifmc_bus/ifmc_wr/cnt_num
...
WaveRestoreCursors {{Cursor 1} {90209600 ps} 0}
...
update
WaveRestoreZoom {22190671040 ps} {22191143630 ps}
