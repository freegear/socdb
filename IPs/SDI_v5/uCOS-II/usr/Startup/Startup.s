...
$HandlerLabel
    ...
    IMPORT  IRQHandler  ; uCOS-II IRQ handler address
...
;****************************************************
    ...
    ; uCOS-II is... 2006/04/04
    ldr          r1,=IRQHandler           ; H/W vectored interrupt
    str	    r1,[r0]
...
;   uCOS-II -> Start Supervisor mode by djkim mind. ^^; 2006/04/04
;   The current mode is supervisor mode (after reset)
;   So, don't need to mode change and user stack initialize.
