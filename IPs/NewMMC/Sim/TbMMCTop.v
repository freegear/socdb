...
initial
	...
	#200 APB_WRITE(5'h0a , 32'h000001ff); 
	#200 APB_WRITE(5'h09 , 32'h001fffff); 
	#200 APB_WRITE(5'h0b , 32'h03000000); 
	#200 APB_WRITE(5'h0e , 32'hffffffff); 
	#200 APB_WRITE(5'h0b , 32'h03560000); 
	#200 APB_WRITE(5'h02 , 32'h00000000); 
	#200 APB_WRITE(5'h03 , 32'h00000351); 
	#200 APB_READ(5'h04); 
	#200 APB_WRITE(5'h04 , 32'h0000ffff); 
	#200 APB_READ(5'h0e); 
	#200 APB_READ(5'h11);//fifo size 만큼 반복 
	#200 APB_READ(5'h0e); 
	#200 APB_READ(5'h11);//fifo size 만큼 반복 
	#200 APB_READ(5'h0e); 


	$display ("MMC One Block Write Data Test");
