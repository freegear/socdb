...
/*
    // instantiate and connect generic ram 
    camera_tpram #(FIFO_AW, 32) fifo_storage
    (
...
assign FIFOHalfFull = DatCnt[AW-1];
assign FIFOHalfEmpty = ~DatCnt [AW-1] ;
//assign FIFOHalfFull = DatCnt>=8;
