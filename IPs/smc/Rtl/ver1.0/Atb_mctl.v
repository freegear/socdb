...
//   wire [15:0] 		  ext_rdata;
   ...
   always #`CKP1      clk  = ~clk;
   always @(ahb_ready) ahb_readyin = ahb_ready;
/*
   mem_ctrl           mem_ctrl
	 ( 
	   .clk                ( clk ),
...
*/
   ...
   initial begin
	  ...
	  // bank 2
	  reg_write(2'h2,{11'h000,3'h5,3'h0,4'ha,3'h1,3'h7,2'h0,2'h2});
	  // bank 3
	  ...
	  // 32bit
	  mem_write(4,20'h00108,2,32'h12345678);
