...
reg_write(1  ,{12'd0    ,3'b101    ,3'b101  ,4'b0110  ,3'b001 ,3'b001   ,2'b01    ,    2'b01});  
reg_write(2  ,{12'd0    ,3'b010    ,3'b001  ,4'b0010  ,3'b001 ,3'b001   ,2'b10    ,    2'b10});  
...
//*******addr,reserved  ,addr_setup,cs_setup,acc_cycle,cs_hold,addr_hold,bus_width,addr_shift)*****
reg_write(0  ,{12'd0    ,3'b010    ,3'b101  ,4'b0010  ,3'b001 ,3'b001   ,2'b00    ,    2'b00});  
