# SimVision Command Script (Thu Nov 09 19:02:49 KST 2006)

#
# databases
#
if {[database find -match exact -name "Atb_ga_axi"] == {}} {
    database open /home/eastbrt2/Project/MyGPU/Sim/ga/Atb_ga_axi.shm/Atb_ga_axi.trn -name "Atb_ga_axi"
}
...
if {[window find -match exact -name "Design Browser 1"] == {}} {
    window new DesignBrowser -name "Design Browser 1" -geometry 905x558+80+137
} else {
    window geometry "Design Browser 1" 905x558+80+137
}
window target "Design Browser 1" on
browser using "Design Browser 1"
browser set \
    -scope {Atb_ga_axi::Atb_ga_axi}
browser yview see {Atb_ga_axi::Atb_ga_axi}

#
# Waveform windows
#
if {[window find -match exact -name "Waveform 1"] == {}} {
    window new WaveWindow -name "Waveform 1" -geometry 1102x716+38+78
} else {
    window geometry "Waveform 1" 1102x716+38+78
}
...
waveform set \
    ...
    -units ns \
    -valuewidth 126
cursor set -using "TimeA" -time 1408.1ns
waveform baseline set -time 0

set id [waveform add -signals {{Atb_ga_axi::Atb_ga_axi.ARADDR[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{Atb_ga_axi::Atb_ga_axi.ARBURST[1:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{Atb_ga_axi::Atb_ga_axi.ARID[3:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{Atb_ga_axi::Atb_ga_axi.ARLEN[3:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {Atb_ga_axi::Atb_ga_axi.ARREADY}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{Atb_ga_axi::Atb_ga_axi.ARSIZE[2:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {Atb_ga_axi::Atb_ga_axi.ARVALID}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{Atb_ga_axi::Atb_ga_axi.RDATA[63:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{Atb_ga_axi::Atb_ga_axi.RID[3:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {Atb_ga_axi::Atb_ga_axi.RLAST}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {Atb_ga_axi::Atb_ga_axi.RREADY}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{Atb_ga_axi::Atb_ga_axi.RRESP[1:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{Atb_ga_axi::Atb_ga_axi.graddr[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {Atb_ga_axi::Atb_ga_axi.grd}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{Atb_ga_axi::Atb_ga_axi.grsize[4:0]}}]
waveform format $id -radix %d -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {Atb_ga_axi::Atb_ga_axi.grbusy}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{Atb_ga_axi::Atb_ga_axi.grbe[7:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{Atb_ga_axi::Atb_ga_axi.grdata[63:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {Atb_ga_axi::Atb_ga_axi.grvalid}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}

waveform xview limits 278.02ns 2919.23ns
