...
void get_estimation(bline_info *src_bl, circle_info *src_cl, 
					int *hrangep, int *eff_hr);
...
extern int pre_hrange(bline_info *src_bl, circle_info *src_cl,
			   bl_param *dst_bl, cl_param *dst_cl, int anti_alias);
extern int pre_bl(bline_info *src_bl, bl_param *dst_bl, int anti_alias, int side);
extern int pre_cl(circle_info *src_cl, cl_param *dst_cl, int anti_alias, int side);
extern void next_bline(int new, bl_param *bl_est);
extern int circle_est(int new, cl_param *circle, int anti_alias);
extern void next_circle(int new, cl_param *cl_est);
extern void get_hrange(bl_param *bline, cl_param *circle, int *eff_hr);
extern void get_estimation(bline_info *src_bl, circle_info *src_cl, 
					int *hrangep, int *eff_hr);
