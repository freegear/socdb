...
add wave -noupdate -format Logic -radix hexadecimal /Atb_ga_axi/grlast
...
add wave -noupdate -format Logic -radix hexadecimal /Atb_ga_axi/gwlast
add wave -noupdate -format Literal -radix hexadecimal /Atb_ga_axi/rdata
...
add wave -noupdate -format Logic -radix hexadecimal /Atb_ga_axi/ga_axim/ga_axir/grlast
...
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_ga_axi/ga_axim/ga_axir/sm_await
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_ga_axi/ga_axim/ga_axir/sm_aidle
...
add wave -noupdate -format Literal /Atb_ga_axi/ga_axim/ga_axir/now_len
...
add wave -noupdate -format Literal -radix binary /Atb_ga_axi/ga_axim/ga_axir/pre_be
add wave -noupdate -format Literal -radix binary /Atb_ga_axi/ga_axim/ga_axir/part_be
...
add wave -noupdate -format Logic -radix hexadecimal /Atb_ga_axi/ga_axim/ga_axiw/gwlast
...
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_ga_axi/ga_axim/ga_axiw/sm_idle
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_ga_axi/ga_axim/ga_axiw/sm_calc_len
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_ga_axi/ga_axim/ga_axiw/sm_wr_cmd
add wave -noupdate -color Orange -format Logic -itemcolor Orange -radix hexadecimal /Atb_ga_axi/ga_axim/ga_axiw/sm_wr_resp
add wave -noupdate -format Logic -radix binary /Atb_ga_axi/ga_axim/ga_axiw/sm_didle
add wave -noupdate -format Logic -radix binary /Atb_ga_axi/ga_axim/ga_axiw/sm_dpre
add wave -noupdate -format Logic -radix binary /Atb_ga_axi/ga_axim/ga_axiw/sm_dprd
add wave -noupdate -format Logic -radix binary /Atb_ga_axi/ga_axim/ga_axiw/sm_dsend
add wave -noupdate -format Logic -radix binary /Atb_ga_axi/ga_axim/ga_axiw/sm_dpost
...
WaveRestoreCursors {{Cursor 1} {534810 ps} 0}
...
update
WaveRestoreZoom {418920 ps} {703830 ps}
