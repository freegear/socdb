...
begin
 #100
    ...
    rvalue = ((`tRC &4'b1000)<<28)|    	// READ cycle timing setting
             ((`tAA &4'b1000)<<24)|		// READ access timing setting
             ((`tPRC&3'b111)<<21)|		// PAGE READ cycle timing setting
             ((`tPA &3'b110)<<18)|		// PAGE READ access timing setting
