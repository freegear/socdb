...
//       SMT926 hardware is 12687500 Hz (prescaler register set to 1)
...
protected:
    ...
    volatile SMT926A_SDI_REG    *vm_pSDIReg;                // pointer to the SDI special registers
    volatile SMT926A_IOPORT_REG *vm_pIOPreg;                // pointer to the GPIO control registers
    volatile SMT926A_CLKPWR_REG *vm_pCLKPWR;                // pointer to the clock control register
    volatile SMT926A_DMA_REG    *vm_pDMAreg;                // pointer to the DMA special registers
