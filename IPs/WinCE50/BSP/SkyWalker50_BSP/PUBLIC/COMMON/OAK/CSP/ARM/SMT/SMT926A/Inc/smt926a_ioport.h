...
//------------------------------------------------------------------------------
//
//  Header:  smt926a_ioport.h
//
//  Defines the Input/Output Ports (IOPORT) control registers and associated
//  types and constants.
//
#ifndef __SMT926A_IOPORT_H
#define __SMT926A_IOPORT_H
...
typedef struct {
	...
	UINT32	 GPIO_6;
	UINT32	 GPIO_7;
} SMT926A_IOPORT_REG, *PSMT926A_IOPORT_REG;  
