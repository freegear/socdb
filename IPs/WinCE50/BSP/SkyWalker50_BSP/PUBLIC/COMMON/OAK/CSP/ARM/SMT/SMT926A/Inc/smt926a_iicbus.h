...
//------------------------------------------------------------------------------
//
//  Header: smt926a_iicbus.h
//
//  Defines the I2C bus controller CPU register layout and definitions.
//
#ifndef __SMT926A_IICBUS_H
#define __SMT926A_IICBUS_H
...
typedef struct 
{
	...
	UINT32	 IDSR1;
	UINT32	 ICCR1_1;    
} SMT926A_IICBUS_REG, *PSMT926A_IICBUS_REG;        
