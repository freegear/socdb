...
#define UART_Kitl SMT926A_BASE_REG_PA_UART0
#elif KITL_SERIAL_UART1
//UART 1 use for serial kitl
#define KITL_SERIAL 1
#define UART_Kitl SMT926A_BASE_REG_PA_UART1
#else
#define UART_Kitl 0
#endif

// Need to be modified by DJKIM 2006/10/10
...
#define BSP_UART_UBRDIV        (SMT926A_PCLK/(115200*16) - 1)
...
//------------------------------------------------------------------------------
// Kitl ethernet lan91c111 
//------------------------------------------------------------------------------

//#define LAN91C111_KITL_POLLMODE
//#define LAN91C111_KITL_DHCP

#define LAN91C111_MAC				L"0:0:0:0:0:1"
#define LAN91C111_IP_ADDRESS		L"192.168.1.202"
#define LAN91C111_IP_MASK			L"255.255.255.0"
#define LAN91C111_IP_ROUTER		L"192.168.1.254"
