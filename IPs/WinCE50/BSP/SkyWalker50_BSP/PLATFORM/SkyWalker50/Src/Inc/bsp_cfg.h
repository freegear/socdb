...
#define SYSINTR_OHCI            (SYSINTR_FIRMWARE+1) // SYSINTR_FIRMWARE : Specifies the base value for custo, OAL-defined intr identifiers
// Refer to public/common/oak/inc/nkintr.h
