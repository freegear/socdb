...
//------------------------------------------------------------------------------
//
//  Define:  BSP_BASE_REG_PA_LAN91C111
//
//  Locates LAN91C111 Ethernet chip. On SKYWALKER memory bank 3 is used
//  to connect this device. Note that there must exist memory mapping in
//  memory_cfg.h for this memory area.
//
#define BSP_BASE_REG_PA_LAN91C111_IOBASE         0x19000300
#define BSP_BASE_REG_PA_LAN91C111_MEMBASE        0x18000000
