...
VOID OEMInitDebugSerial() 
{
    ...
    //
    pIOPortReg = (SMT926A_IOPORT_REG*)OALPAtoVA(SMT926A_BASE_REG_PA_IOPORT, FALSE);
    ...
    //
    g_pUARTReg = (SMT926A_UART_REG *)OALPAtoVA(SMT926A_BASE_REG_PA_UART1, FALSE);
