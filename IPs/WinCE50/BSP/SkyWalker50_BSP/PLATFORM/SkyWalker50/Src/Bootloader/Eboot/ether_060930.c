...
BOOL	Smsc100FdInit(PBYTE iobase, DWORD membase, USHORT MacAddr[3]);
UINT16  Smsc100FdGetFrame(PBYTE pbData, UINT16 *pwLength);
UINT16  Smsc100FdSendFrame(PBYTE pbData, DWORD dwLength);
...
static BOOL OEMGetRealTime(LPSYSTEMTIME lpst) 
{
	...
	// RTC register mapping 후 아래 코드 수정 필요 by DJKIM 2006/09/28
    do
    {
