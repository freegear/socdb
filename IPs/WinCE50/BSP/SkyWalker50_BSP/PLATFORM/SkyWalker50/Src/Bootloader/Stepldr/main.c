...
// Constants.
//
#define LED_ON	                0xa // Need to be modified by DJKIM 2006/10/09
#define LED_OFF	                0x0 // Need to be modified by DJKIM 2006/10/09

#define NAND_BLOCK_SIZE_BYTES   0x00004000 // Need to be modified by DJKIM 2006/10/09
...
#define NAND_COPY_PAGE_OFFSET   2*NAND_PAGES_PER_BLOCK // Need to be modified by DJKIM 2006/10/09
// ??? Nand block0-> stepstone loader, block1-> TOC, block2-> Ebootloader¿Ãπ«∑Œ??? Â((Refer to loader.h)

#define LOAD_ADDRESS_PHYSICAL   0x30038000 // Ebootloader phy start addr // Need to be modified by DJKIM 2006/10/09
#define LOAD_SIZE_BYTES         0x00040000 // Ebootloader size // Need to be modified by DJKIM 2006/10/09
