...
// Refer to Src/inc/Oemaddrtab_cfg.inc
// Image addresses (note that these addresses may need to match .BIB file values).
/*
		--------- ac026000
		|		|			BINFS_RAM
		--------- ac021000
		...
		|		|
		--------- 82000000
		|		|			NK.bin - RAM area (32MB)
		--------- 80000000
*/
#define CACHED_TO_UNCACHED_OFFSET   0x20000000

// NAND flash booting area - Need to modify by DJKIM 2006/09/30
...
#define EBOOT_RAM_IMAGE_SIZE        0x00040000 // 262KB
...
//
#define ROM_RAMIMAGE_START          0x80000000 // WinCE Cached area addr
#define ROM_RAMIMAGE_SIZE           0x02000000 // RAM 32MB


#define FILE_CACHE_START            (0x8c200000 | CACHED_TO_UNCACHED_OFFSET)
                                                        // Start of file cache (temporary store for flash images).
...
//
#define PLATFORM_STRING         "SkyWalker"
