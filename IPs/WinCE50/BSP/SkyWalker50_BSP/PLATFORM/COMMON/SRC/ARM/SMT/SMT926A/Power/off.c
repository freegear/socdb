...
void OEMPowerOff()
{
    ...
    SMT926A_INTR_REG *pIntr = (SMT926A_INTR_REG*)OALPAtoVA(SMT926A_BASE_REG_PA_INTR, FALSE);
    SMT926A_IOPORT_REG *pIOPort = (SMT926A_IOPORT_REG*)OALPAtoVA(SMT926A_BASE_REG_PA_IOPORT, FALSE);
    SMT926A_LCD_REG *pLCD = (SMT926A_LCD_REG*)OALPAtoVA(SMT926A_BASE_REG_PA_LCD, FALSE);
