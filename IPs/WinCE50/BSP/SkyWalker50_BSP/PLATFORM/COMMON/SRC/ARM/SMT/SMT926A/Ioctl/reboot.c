...
//  File: interrupt.c
//
//  This file implement SMT SMT926A SoC specific OALIoCtlxxxx functions.
//
#include <windows.h>
#include <smt926a.h>
#include <oal.h>
                       ...
                       UINT32 outSize, UINT32 *pOutSize)
{
    ...
    // used.  Because this routine is specific to the SMT926A CPU, it only uses the watchdog
    ...
    volatile SMT926A_WATCHDOG_REG *pWDRegs = (volatile SMT926A_WATCHDOG_REG *) 
                                              OALPAtoVA(SMT926A_BASE_REG_PA_WATCHDOG, FALSE);
