...
#/*--========================================================================--*/
set CLK_SKEW 0.30
set CLK_UNCERTAINTY1 [expr [expr $PERIOD1 * 0.10] + $CLK_SKEW]
...
create_clock -name ACLK -period $PERIOD1 -w [list 0 $HALF_PERIOD1] [get_ports ACLK]

#/*--========================================================================--*/
#/*    Set clock uncertainties.                                                */
#/*--========================================================================--*/
set_clock_uncertainty -setup $CLK_UNCERTAINTY1 [get_clocks ACLK]
...
set_input_delay 2.00 -clock ACLK $all_inputs_no_clocks
...
#/*--========================================================================--*/
set_output_delay 3.00 -clock ACLK [all_outputs]
