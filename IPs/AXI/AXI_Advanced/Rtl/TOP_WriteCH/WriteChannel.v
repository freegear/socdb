...
//Lock access
    ...
    input    [MASTER_NUM-1:0]LockPort2wrmi0;
    input    [MASTER_NUM-1:0]LockPort2wrmi1;
    input    [MASTER_NUM-1:0]LockPort2wrmi2;
    input    [MASTER_NUM-1:0]LockPort2wrmi3;
    input    [MASTER_NUM-1:0]LockPort2wrmi4;
    input    [MASTER_NUM-1:0]LockPort2wrmi5;
    ...
    output   [MASTER_WID-1:0]CtlDataWrite2Lock0;
    output   [MASTER_WID-1:0]CtlDataWrite2Lock1;
    output   [MASTER_WID-1:0]CtlDataWrite2Lock2;
    output   [MASTER_WID-1:0]CtlDataWrite2Lock3;
    output   [MASTER_WID-1:0]CtlDataWrite2Lock4;
    output   [MASTER_WID-1:0]CtlDataWrite2Lock5;
