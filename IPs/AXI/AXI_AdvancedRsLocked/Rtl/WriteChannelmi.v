...
`include "Def.v"
    ...
    // Syn 309 :: modify ELAB-292(senstivelist)
    always @(AWVALIDsi2mi or CtlData2WrchMux or
             AWLOCKsi02mi or
             AWLOCKsi12mi or
             AWLOCKsi22mi or
             AWLOCKsi32mi 
    ...
    begin
        ...
        else if(WVALIDmi2s & WLASTmi2s & WREADYs2mi)
        begin
            rWENn <= 1'b1;
        end
        else if(BVALIDs2mi & BREADYmi2s)
        begin
            rWENn <= 1'b0;
        end
    ...
    //wire    AWREADY2ReqInter = (!EnAWREADYMUXn & !ReqFull) ? AWREADYs2mi:1'b0;
