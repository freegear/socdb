...
#define STATE051_START   "//STATE051_START\n"
#define STATE051_END     "//STATE051_END\n"
...
unsigned int genBusTop(char *OutFileName, char *Name);
unsigned int genTestbench(char *OutFileName, char *Name);
unsigned int genTestMaster(DefMaster *VAL_MASTER, char *OutFileName, int BusWidth);
unsigned int genIntSRAMController(char *OutFileName, DefSlave *VAL_SLAVE, int BusWidth);
unsigned int genTOPBlock(char *OutFileName, char *Name);
