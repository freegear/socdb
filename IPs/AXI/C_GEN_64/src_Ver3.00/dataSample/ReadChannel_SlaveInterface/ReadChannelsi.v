...
begin
    ...
    else if(!RVALIDmi2si[CtlData2readch])
    begin
        if(RVALIDmi2si[0])
            CtlData2readch <= 4'd0;
        else if(RVALIDmi2si[1])
            CtlData2readch <= 4'd1;
        else if(RVALIDmi2si[2])
            CtlData2readch <= 4'd2;
        else if(RVALIDmi2si[3])
            CtlData2readch <= 4'd3;
        else if(RVALIDmi2si[4])
            CtlData2readch <= 4'd4;
        else if(RVALIDmi2si[5])
            CtlData2readch <= 4'd5;
    end
end
