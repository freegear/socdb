...
//STATE00_START
`define SLAVE??_S    ?MAXADDR?
`define SLAVE??_E    ?MINADDR?
//STATE_END

module ?NAME?_TestSlave 
(
//	AXI Interface
		ACLK     , 
		ARESETn  , 
...
// module parameter
//
parameter DATA_WIDTH = 64;	// 64bit/32bit support
...
output [MADDR_WIDTH-1:0] MEMADDR;	// discard lower 2 or 3 line
output                  MEMCEn;
...
// SRAM Interface
//
assign MEMADDR  = (StateIsWRITE || FirstREADCycle || RREADY == 1'b1) ? Addr[ADDR_WIDTH-1:ADDR_MIN] : PrevAddr[ADDR_WIDTH-1:ADDR_MIN];
