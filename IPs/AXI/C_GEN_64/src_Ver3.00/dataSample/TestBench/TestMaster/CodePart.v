...
begin
    ...
    */
    ...
    $display("Test Starting.... MsterNumber [%h]", MasterNumber());
...
function [31:0] SlaveAreaAddr;
    input [19:0] haddr;
	input [31:0] addr;
	SlaveAreaAddr = {{REMAIN_BITS{1'b0}}, haddr[19:0], MasterNumber(), addr[TADDR_AWIDTH-1:0]};
endfunction

function [DATA_WIDTH-1:0] SlaveAreaData;
	input [19:0] haddr;
	input [31:0] addr;
	SlaveAreaData = {{REMAIN_BITS{1'b0}}, haddr[19:0], MasterNumber(), addr[TADDR_AWIDTH-1:0]};
endfunction
