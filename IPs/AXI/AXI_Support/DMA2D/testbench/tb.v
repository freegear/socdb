...
always @(posedge ACLK)
begin
	if(ARESETn && AWVALIDM1 == 1)
	begin
		if(AWADDRM1[31:2] < WADDR_START[31:2] ||(AWADDRM1[31:2]+AWLENM1) > WADDR_END)
			$display("Wrong write address !!!");
	end
end

always @(posedge ACLK)
begin
	if(ARESETn && WVALIDM1 == 1 && WSTRBM1[0] == 1 && WDATAM1[7:0] === 8'hxx)
		$display("DMA2D Attempt to write xx !!!");
	if(ARESETn && WVALIDM1 == 1 && WSTRBM1[1] == 1 && WDATAM1[15:8] === 8'hxx)
		$display("DMA2D Attempt to write xx !!!");
	if(ARESETn && WVALIDM1 == 1 && WSTRBM1[2] == 1 && WDATAM1[23:16] === 8'hxx)
		$display("DMA2D Attempt to write xx !!!");
	if(ARESETn && WVALIDM1 == 1 && WSTRBM1[3] == 1 && WDATAM1[31:24] === 8'hxx)
		$display("DMA2D Attempt to write xx !!!");
end
