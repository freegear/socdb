...
action vlog +incdir+../rtl ../rtl/DmacRegFile4Ch.v
action vlog +incdir+../rtl ../rtl/DmacReqAck4Ch.v
action vlog +incdir+../rtl ../rtl/Dmac4Ch.v
...
action vlog ../testbench/TestMaster4Ch.v
action vlog +incdir+../testbench/BUS_AdvRs/Rtl/Def ../testbench/tb4Ch.v
