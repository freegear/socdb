...
create_clock -name mainclk -period $PERIOD1 -w [list 0 $HALF_PERIOD1] [get_ports ACLK]

#/*--========================================================================--*/
#/*    Set clock uncertainties.                                                */
#/*--========================================================================--*/
#set_clock_uncertainty -setup $CLK_UNCERTAINTY1 [get_clocks mainclk]
...
#set_input_delay 2.00 -clock mainclk $all_inputs_no_clocks
...
#/*--========================================================================--*/
#set_output_delay 3.00 -clock mainclk [all_outputs]
...
#remove_attribute [get_ports clk_i] max_fanout
