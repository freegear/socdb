...
// Slave 5 : interconnection signals : specially 1 more ID width(BUS bug ?)
wire [SID_WIDTH:0]  AWIDS5;
wire [31:0]           AWADDRS5;
wire [3:0]            AWLENS5;
wire [2:0]            AWSIZES5;
wire [1:0]            AWBURSTS5;
...
wire [SID_WIDTH:0]  BIDS5;
wire [1:0]            BRESPS5;
wire                  BVALIDS5;
wire                  BREADYS5;

wire [SID_WIDTH:0]  ARIDS5;
wire [31:0]           ARADDRS5;
wire [3:0]            ARLENS5;
wire [2:0]            ARSIZES5;
wire [1:0]            ARBURSTS5;
...
wire [3:0]  DMACINTR;         // DMA combined interrupt request
...
assign PREADYDMAC = 1;
// unused AXI Signal
assign AWIDM1[ID_WIDTH-1:1] = 0;
assign AWLOCKM1 = 0;
assign AWCACHEM1 = 0;
assign AWPROTM1 = 0;
assign ARIDM1[ID_WIDTH-1:1] = 0;
assign WIDM1[ID_WIDTH-1:1] = 0;
//assign AWIDM2 = 0;
//assign ARIDM2 = 0;
//assign WIDM2 = 0;
...
DefaultSlave #(.RID_WIDTH(SID_WIDTH+1), .WID_WIDTH(SID_WIDTH+1)) DefaultSlave5
(
		.ACLK     , 
		.ARESETn  , 
