...
`include "Def.v"
    ...
    wire   [MASTER_WID-1:0]CtlDataWrite2Lock0;
    wire   [MASTER_WID-1:0]CtlDataWrite2Lock1;
    wire   [MASTER_WID-1:0]CtlDataWrite2Lock2;
    wire   [MASTER_WID-1:0]CtlDataWrite2Lock3;
    wire   [MASTER_WID-1:0]CtlDataWrite2Lock4;
    wire   [MASTER_WID-1:0]CtlDataWrite2Lock5;

    wire   [MASTER_WID-1:0]CtlDataRead2Lock0;     
    wire   [MASTER_WID-1:0]CtlDataRead2Lock1;     
    wire   [MASTER_WID-1:0]CtlDataRead2Lock2;     
    wire   [MASTER_WID-1:0]CtlDataRead2Lock3;     
    wire   [MASTER_WID-1:0]CtlDataRead2Lock4;     
    wire   [MASTER_WID-1:0]CtlDataRead2Lock5;     
    ...
    wire    [MASTER_NUM-1:0]LockPort2wrmi0;
    wire    [MASTER_NUM-1:0]LockPort2wrmi1;
    wire    [MASTER_NUM-1:0]LockPort2wrmi2;
    wire    [MASTER_NUM-1:0]LockPort2wrmi3;
    wire    [MASTER_NUM-1:0]LockPort2wrmi4;
    wire    [MASTER_NUM-1:0]LockPort2wrmi5;

    wire    [MASTER_NUM-1:0]LockPort2rdmi0;
    wire    [MASTER_NUM-1:0]LockPort2rdmi1;
    wire    [MASTER_NUM-1:0]LockPort2rdmi2;
    wire    [MASTER_NUM-1:0]LockPort2rdmi3;
    wire    [MASTER_NUM-1:0]LockPort2rdmi4;
    wire    [MASTER_NUM-1:0]LockPort2rdmi5;
