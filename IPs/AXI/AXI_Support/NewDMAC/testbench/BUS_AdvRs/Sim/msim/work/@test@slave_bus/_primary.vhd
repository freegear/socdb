...
entity TestSlave_bus is
    ...
    port(
        ACLK            : in     vl_logic;
        ARESETn         : in     vl_logic;
        AWID            : in     vl_logic_vector(7 downto 0);
        ...
        WID             : in     vl_logic_vector(7 downto 0);
        WDATA           : in     vl_logic_vector;
        WSTRB           : in     vl_logic_vector;
        WLAST           : in     vl_logic;
        WVALID          : in     vl_logic;
        WREADY          : out    vl_logic;
        BID             : out    vl_logic_vector(7 downto 0);
        BRESP           : out    vl_logic_vector(1 downto 0);
        BVALID          : out    vl_logic;
        BREADY          : in     vl_logic;
        ARID            : in     vl_logic_vector(7 downto 0);
        ...
        RID             : out    vl_logic_vector(7 downto 0);
