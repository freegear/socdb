# SimVision Command Script (Thu Jun 21 16:30:44 KST 2007)

#
# databases
#
if {[database find -match exact -name "shm"] == {}} {
    database open /LDisk/HomeM4P1/kwoly/Project/AXI/TestSlave/ChMerge64bit_V/Sim/shm.shm/shm.trn -name "shm"
}
...
if {[window find -match exact -name "Design Browser 1"] == {}} {
    window new DesignBrowser -name "Design Browser 1" -geometry 700x500+242+148
} else {
    window geometry "Design Browser 1" 700x500+242+148
}
...
if {[window find -match exact -name "Waveform 1"] == {}} {
    window new WaveWindow -name "Waveform 1" -geometry 1010x600+150+130
} else {
    window geometry "Waveform 1" 1010x600+150+130
}
...
set id [waveform add -signals {shm::tb.TestSlave.SSRAM64.CEn}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {shm::tb.TestSlave.SSRAM64.CLK}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{shm::tb.TestSlave.SSRAM64.ADDR1[23:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{shm::tb.TestSlave.SSRAM64.ADDR0[23:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{shm::tb.TestSlave.SSRAM64.WDATA[63:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{shm::tb.TestSlave.SSRAM64.WEn[7:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{shm::tb.TestSlave.SSRAM64.RDATA[63:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{shm::tb.TestSlave.SSRAM32.ADDR0[23:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{shm::tb.TestSlave.SSRAM32.ADDR1[23:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {shm::tb.TestSlave.SSRAM32.CEn}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {shm::tb.TestSlave.SSRAM32.CLK}]
waveform format $id -radix %b -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{shm::tb.TestSlave.SSRAM32.WEn[3:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{shm::tb.TestSlave.SSRAM32.WDATA[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}
set id [waveform add -signals {{shm::tb.TestSlave.SSRAM32.RDATA[31:0]}}]
waveform format $id -trace digital -color #00ff00 -symbol {}

waveform xview limits 0 10722310ns
