...
--
--      Instance:       RA1SH512x32
--      Address Length: 512
--      Word Width:     32
--      Pipeline:       No
--
--      Creation Date:  2006-12-19 02:14:57Z
--      Version:        2003Q4V1
--
...
Package RA1SH512x32_pkgs is
  component rdwr_RA1SH512x32
    generic(
...
use WORK.RA1SH512x32_pkgs.all;

  entity rdwr_RA1SH512x32 is
    generic(
	TimingChecksOn: BOOLEAN := TRUE;
	tperiod_CLK  : VitalDelayType;
	tpw_CLK_negedge: VitalDelayType;
    ...
    attribute VITAL_LEVEL1 of rdwr_RA1SH512x32 : entity is TRUE;
end rdwr_RA1SH512x32;

-------------- -------------- -------------- -------------- --------------
architecture BEHAVIORAL of rdwr_RA1SH512x32 is
  constant ClkPort	: string:=cat("CLK",PortName);
  constant InstPort	: string:="RA1SH512x32";
...
use WORK.RA1SH512x32_pkgs.all;
  ...
  entity RA1SH512x32 is
    ...
    attribute VITAL_LEVEL1 of RA1SH512x32 : entity is TRUE;
end RA1SH512x32;

-----------------------------------------------------------------------------
architecture Structural of RA1SH512x32 is
