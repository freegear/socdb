...
--
--      Instance:       RA1SH512x32_on
--      Address Length: 512
--      Word Width:     32
--      Pipeline:       No
--
--      Creation Date:  2006-12-19 02:08:30Z
--      Version:        2004Q2V1
--
...
Package RA1SH512x32_on_pkgs is
  component rdwr_RA1SH512x32_on
    generic(
	...
	tpd_CLK_Q	: VitalDelayArrayType01(31 downto 0) := (others => (1.0 ns, 1.0 ns));
	PortName	: string
    );
    port ( 
	CLK: in std_logic;
...
use WORK.RA1SH512x32_on_pkgs.all;

  entity rdwr_RA1SH512x32_on is
    generic(
	TimingChecksOn: BOOLEAN := TRUE;
	tperiod_CLK  : VitalDelayType;
	tpw_CLK_negedge: VitalDelayType;
    ...
    attribute VITAL_LEVEL1 of rdwr_RA1SH512x32_on : entity is TRUE;
end rdwr_RA1SH512x32_on;

-------------- -------------- -------------- -------------- --------------
architecture BEHAVIORAL of rdwr_RA1SH512x32_on is
  constant ClkPort	: string:=cat("CLK",PortName);
  constant InstPort	: string:="RA1SH512x32_on";
...
use WORK.RA1SH512x32_on_pkgs.all;
  ...
  entity RA1SH512x32_on is
    ...
    attribute VITAL_LEVEL1 of RA1SH512x32_on : entity is TRUE;
end RA1SH512x32_on;

-----------------------------------------------------------------------------
architecture Structural of RA1SH512x32_on is
