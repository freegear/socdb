...
--      Pipeline:       No
--
--      Creation Date:  2006-12-19 09:01:06Z
--      Version:        2003Q4V1
--
...
Package RF1SH32x26_pkgs is
  component rdwr_RF1SH32x26
    generic(
	...
	tipd_D: VitalDelayArrayType01(25 downto 0):=(others=>(0.000 ns, 0.000 ns));
	...
	tsetup_D_CLK_posedge_posedge: VitalDelayArrayType(25 downto 0):=(others=>(1.000 ns));
	tsetup_D_CLK_negedge_posedge: VitalDelayArrayType(25 downto 0):=(others=>(1.000 ns));
	...
	thold_D_CLK_posedge_posedge: VitalDelayArrayType(25 downto 0):=(others=>(0.500 ns));
	thold_D_CLK_negedge_posedge: VitalDelayArrayType(25 downto 0):=(others=>(0.500 ns));
	tpd_CLK_Q	: VitalDelayArrayType01(25 downto 0) := (others => (1.0 ns, 1.0 ns));
	PortName	: string
    );
    port ( 
	CLK: in std_logic;
...
use WORK.RF1SH32x26_pkgs.all;

  entity rdwr_RF1SH32x26 is
    generic(
	TimingChecksOn: BOOLEAN := TRUE;
	tperiod_CLK  : VitalDelayType;
	tpw_CLK_negedge: VitalDelayType;
    ...
    attribute VITAL_LEVEL1 of rdwr_RF1SH32x26 : entity is TRUE;
end rdwr_RF1SH32x26;

-------------- -------------- -------------- -------------- --------------
architecture BEHAVIORAL of rdwr_RF1SH32x26 is
  constant ClkPort	: string:=cat("CLK",PortName);
  constant InstPort	: string:="RF1SH32x26";
...
--------------
D_UTI: for i in 0 to 25 generate
...
use WORK.RF1SH32x26_pkgs.all;
  ...
  entity RF1SH32x26 is
    ...
    attribute VITAL_LEVEL1 of RF1SH32x26 : entity is TRUE;
end RF1SH32x26;

-----------------------------------------------------------------------------
architecture Structural of RF1SH32x26 is
  signal MEM: MEM_TYPE(31 downto 0, 25 downto 0);
  signal gnd: std_logic:='0';
  signal gndA: std_logic_vector(4 downto 0):=(others=>'0');
  signal gndD: std_logic_vector(25 downto 0):=(others=>'0');
  signal Read, Write: std_logic;
  signal GtpRst, BusyWr, BusyRd: std_logic:='0';
  signal Am: std_logic_vector(4 downto 0);
  signal Dm, Qi: std_logic_vector(25 downto 0);
