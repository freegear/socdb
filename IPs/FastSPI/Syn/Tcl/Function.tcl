...
proc pCreateClock { clock_name clock_period pos_period neg_period clock_uncertainty } {
  ...
  #-- clock
  create_clock -p $clock_period -w [list $pos_period $neg_period] [find port $clock_name]
...
proc pGenerateClockCondition { clock_name clock_uncertainty } {
  ...
  set_clock_uncertainty -setup $clock_uncertainty $clock_name
  #set_clock_skew -ideal -plus_uncertainty $clock_tpskew [find clock $clock_name]
  ...
  #-- Set no driving cell on clock 
  #remove_driving_cell $clock_name
  
  #-- Zero resistance for zero net delay(interconnect delay) on ideal clock net
  set_resistance 0 $clock_name
