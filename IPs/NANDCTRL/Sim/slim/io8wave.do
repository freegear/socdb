...
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/uNFCtrl/tARCnt
add wave -noupdate -format Logic /Tb_NFTop/uNFTop/uNFCtrl/tAREn
...
add wave -noupdate -divider {New Divider}
add wave -noupdate -format Literal /Tb_NFTop/uNFTop/uNFAPBIF/NFFIFOSTAT
...
WaveRestoreCursors {{Cursor 1} {12771408478 ps} 0} {{Cursor 2} {1077610000 ps} 0} {{Cursor 3} {335340 ps} 0} {{Cursor 4} {5909610673 ps} 0}
...
update
WaveRestoreZoom {1077484944 ps} {1078052682 ps}
