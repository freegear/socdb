...
procedure Page_Program_Confirm_Code  is
begin
        I_O <= (others => 'Z');
	E_N<='0';
	CL<='1';                        --t_CLHWL=0 
...
--     Page Program       
       ...
       Page_Program_Setup_Code;                              --80h
       wait for 100 ns;
       four_Address_cycles (X"ABC54010");   
...
---    Copy Back
       ...
       Copy_Back_Code;                             -- 8Ah
       four_Address_cycles (X"ABC55003");        --standard logic ve
       Data_Cycle ("10100100");                               -- A4h
       wait for 50 ns;
       Data_Cycle ("00000010");                               -- 02h
       wait for 50 ns ;
       Data_Cycle ("11110011");                                -- F3h
       wait for 50 ns ;
...
---    READ   ----
       ...
       four_Address_cycles (X"ABC55010");  
...
---    READ   ----
       ...
       four_Address_cycles (X"ABC55000");  
...
---    READ   ----
       ...
       four_Address_cycles (X"ABC55013");  
