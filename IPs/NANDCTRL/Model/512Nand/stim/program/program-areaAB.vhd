...
-- 
---------------------------------------------------------------------------------
--	> Commands:  double page program  area A, page program area B and read -- 
...
--    double Page Program       
       ...
       Page_Program_Setup_Code;
       wait for 100 ns;
       four_Address_cycles (X"04201110");                      --

       
       Data_Cycle ("00010001");                                -- 11h
       wait for 50 ns ;
       Data_Cycle ("00100010");                                --22h 
       wait for 50 ns ;
       Data_Cycle ("00110011");                                -- 33
       wait for 50 ns ;
...
--     Page Program area B     
       ...
       Page_Program_Setup_Code;
       wait for 100 ns;
       four_Address_cycles (X"05201110");                      --

       
       Data_Cycle ("00101000");                                -- 28h
       wait for 50 ns ;
       Data_Cycle ("00110011");                                -- 33h 
       wait for 50 ns ;
       Data_Cycle ("10101010");                                -- 55h
       wait for 50 ns ;
