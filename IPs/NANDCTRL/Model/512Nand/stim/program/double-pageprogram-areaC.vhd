...
-- 
------------------------------------------------------------------------------
--	> Commands:  double page program in area C and read                 -- 
...
--     Page Program  area C     
       Page_Program_Setup_Code;
       wait for 100 ns;
       four_Address_cycles (X"04210000");                 --

       
       Data_Cycle ("00010001");                                -- 11h
       wait for 50 ns ;
       Data_Cycle ("10000000");                                -- 80h
       wait for 50 ns ;
...
---    READ   ----
       ...
       four_Address_cycles (X"03201010");                   -- area C
       ...
       Read_Code_C;                                           -- 00h
       four_Address_cycles (X"04210000");                 -- area C
