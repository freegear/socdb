...
-- 
------------------------------------------------------------------------------
--	> Commands:  Read Signature                                         -- 
--      >            command 90h, address 00h, read cycles                  -- 
--      >            address insertion x8   x16  devices                    --     
--      >            AddrBusCycle =4                                        --  
------------------------------------------------------------------------------
...
procedure Read_Signature  is
begin
        I_O <= (others => 'Z');
	E_N<='0';
	CL<='1';                        --t_CLHWL=0 
	W_N<='0';                         --t_ELWL=0
        I_O <=  "10010000" ;        --t_DVWH>20
        wait for 30 ns;                   --t_ELTV
	W_N<='1';                         --t_WLWH>25
        wait for 15 ns;                   --t_ELWl
	CL<='0';                        --t_WHCLL>10
...
--------------------------------------------------------------------        
       ...
       Read_Signature;                             -- 90h
       wait for 100 ns;
       four_Address_cycles (X"00000000");                 -- 00h
