...
--------------------------------------------------------------------------------------------------
--							                                        --
--	> Commands:  erase and program 2 page neighboring in 2 different blocks in area C       -- 
--      >            read pages, sequential read area C                                         -- 
...
-----   ERASE  block 0---
       ...
       block_Address_cycles (X"0000000D");                 -- block 0
...
--   ERASE  block 1---
       ...
       block_Address_cycles (X"00004000");                   -- block 1
...
--     read area C
       ...
       four_Address_cycles (X"0000000D");                 --
       ...
       four_Address_cycles (X"00004000");                 --
...
--     Page Program 1st page      
       ...
       Data_Cycle ("10101011");                                -- ABh
       wait for 50 ns ;
       Data_Cycle ("11001101");                                -- CDh
       wait for 50 ns ;
       Data_Cycle ("00010010");                                -- 12h
       wait for 50 ns ;
...
--     Page Program 2nd page      
       ...
       Data_Cycle ("00000110");                                -- 06h
       wait for 50 ns ;
       Data_Cycle ("00000111");                                -- 07h
       wait for 50 ns ;
       Data_Cycle ("00001000");                                -- 08h
       wait for 50 ns ;
