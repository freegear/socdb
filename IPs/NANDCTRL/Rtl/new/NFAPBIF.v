...
begin
    if(!PRESETn) begin
//        NFDATA<=32'd0;
        Timing_conf<={4'd15,3'd3,3'd3,3'd3};//TADLTWB,TACLS,TRWLP,TRWHP;
...
begin
    if(!PRESETn) begin
        Timing<={4'd15,3'd3,3'd3,3'd3};//TADLTWB,TACLS,TRWLP,TRWHP
    ...
    if(!PRESETn) begin
        ...
        if(APBReadEn)begin
            case(PADDR[6:2]) // synopsys parallel_case
                ...
                5'd6 :PRDATA<={8'd0,ECCSECTOR0 };  
                5'd7 :PRDATA<={8'd0,ECCSECTOR1 };
                5'd8 :PRDATA<={8'd0,ECCSECTOR2 };
                5'd9 :PRDATA<={8'd0,ECCSECTOR3 };
                5'd10:PRDATA<={8'd0,ECCSECTOR4 };
                5'd11:PRDATA<={8'd0,ECCSECTOR5 };
                5'd12:PRDATA<={8'd0,ECCSECTOR6 };
                5'd13:PRDATA<={8'd0,ECCSECTOR7 };
                5'd14:PRDATA<={8'd0,ECCSECTOR8 }; 
                5'd15:PRDATA<={8'd0,ECCSECTOR9 };
                5'd16:PRDATA<={8'd0,ECCSECTOR10};
                5'd17:PRDATA<={8'd0,ECCSECTOR11};
                5'd18:PRDATA<={8'd0,ECCSECTOR12};
                5'd19:PRDATA<={8'd0,ECCSECTOR13};
                5'd20:PRDATA<={8'd0,ECCSECTOR14};
                5'd21:PRDATA<={8'd0,ECCSECTOR15};
