...
parameter   FIFOLEVEL   =3'd7; //FIFOLEVEL+1 => ½ÇÁ¦ level
...
`else
    // READ ID
                    //CE/Option   /DataSize/OpMode/TransferSize/TransferByte/CmdAddrFlag
    reg_write(4'd0,{1'd0,NoOption ,12'h004 ,3'b010,byte        ,4'b0010     ,8'b10001001});
    reg_write(4'd0,{8'h90,8'h00,8'h00,8'h90});
    Read_ID(byte,cycle4);
`endif
...
$display("\n/////  NAND FLASH RESET /////\n");
    ...
    // nand flash reset
                    //CE/Option    /DataSize/OpMode/TransferSize/TransferByte/CmdAddrFlag
    reg_write(4'd0,{1'd0,AutoRdStat,12'h000 ,3'b111,2'b10       ,4'b0010     ,8'b00000011});
...
$display("\n/////  NAND FLASH BLOCK ERASE /////\n");
    ...
    // Block Erase
                    //CE/Option    /DataSize/OpMode/TransferSize/TransferByte/CmdAddrFlag
    reg_write(4'd0,{1'd0,AutoRdStat,12'h000 ,3'b111,2'b10       ,4'b0110     ,8'b10010001});
...
`ifndef Page512 // 2048 page!!!!!!!!!!!!!
    ...
    //    reg_write(4'd0,{1'd0,NoOption,12'h800 ,3'b101,2'b10       ,4'b0100     ,8'b10010001});
        reg_write(4'd0,{1'd0,Continue,12'h000 ,3'b111,2'b10       ,4'b0100     ,8'b10010001});
        reg_write(4'd0,{8'h00,8'h00,8'h00,8'h60});
                        //CE/Option    /DataSize/OpMode/TransferSize/TransferByte/CmdAddrFlag
        reg_write(4'd0,{1'd0,AutoRdStat,12'h000 ,3'b111,2'b10       ,4'b0110     ,8'b10010001});
    ...
    $display("\n/////  NAND FLASH copy back /////\n");
                        //CE/Option /DataSize/OpMode/TransferSize/TransferByte/CmdAddrFlag
        reg_write(4'd0,{1'd0,RnBWait,12'h000 ,3'b101,2'b10       ,4'b0111     ,8'b01000001});
        reg_write(4'd0,{8'h00,8'h00,8'h00,8'h00});
        reg_write(4'd0,{8'h00,8'h35,8'h00,8'h00});    
                        //CE/Option    /DataSize/OpMode/TransferSize/TransferByte/CmdAddrFlag
        reg_write(4'd0,{1'd0,AutoRdStat,12'h000 ,3'b111,2'b10       ,4'b1000     ,8'b01000001});
